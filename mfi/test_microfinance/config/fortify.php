...
return [
    ...
    */
    ...
    |
    | SECURITY: Registration, password reset, 2FA, and password confirmation
    | are disabled. This system uses centralized SSO authentication only via
    | http://saccos-uat.intra.nbc.co.tz/ - All users must authenticate through
