...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n";
echo "  MFI Management System - EXCEL REPORTS GENERATOR\n";
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n";
...
$dailyFile = generateExcelFile($dailyReports, 'NBC_MFI_Daily_Reports_' . date('Y-m-d') . '.xlsx', $outputDir);
...
$weeklyFile = generateExcelFile($weeklyReports, 'NBC_MFI_Weekly_Reports_' . date('Y-m-d') . '.xlsx', $outputDir);
...
$monthlyCreditFile = generateExcelFile($monthlyCreditReports, 'NBC_MFI_Monthly_Credit_Reports_' . date('Y-m') . '.xlsx', $outputDir);
...
$monthlyFinanceFile = generateExcelFile($monthlyFinanceReports, 'NBC_MFI_Monthly_Finance_Reports_' . date('Y-m') . '.xlsx', $outputDir);
...
$monthlyMembershipFile = generateExcelFile($monthlyMembershipRiskReports, 'NBC_MFI_Monthly_Membership_Risk_Reports_' . date('Y-m') . '.xlsx', $outputDir);
...
$quarterlyFile = generateExcelFile($quarterlyReports, 'NBC_MFI_Quarterly_Reports_Q' . ceil(date('n')/3) . '_' . date('Y') . '.xlsx', $outputDir);
...
$annualFile = generateExcelFile($annualReports, 'NBC_MFI_Annual_Reports_' . date('Y') . '.xlsx', $outputDir);
            ...
            $message->html('
                ...
                <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                    <div style="max-width: 700px; margin: 0 auto; padding: 20px;">
                        ...
                        <p>Please find attached the following Excel reports generated from the MFI Management System Core Banking System:</p>
                        ...
                        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd; color: #666; font-size: 0.9em;">
                            <p>
                                ...
                                <strong>System:</strong> MFI Management System Core Banking Application
                            </p>
                        </div>
                    </div>
                </body>
