...
echo "\033[1;36m";
echo "╔════════════════════════════════════════════════════════════════╗\n";
echo "║          Claude Code Bridge - MFI Core System              ║\n";
echo "╚════════════════════════════════════════════════════════════════╝\n";
echo "\033[0m\n";
...
while (true) {
    ...
    foreach ($requests as $request) {
        ...
        echo "You have:\n";
        echo "1. Full access to the MFI Core System codebase at: \033[1;32m" . base_path() . "\033[0m\n";
...
function gatherDatabaseContext($message) {
    ...
    try {
        ...
        $context .= "\n**System Information:**\n";
        $context .= "• System Name: MFI Core System Template\n";
        $context .= "• Version: 6.0\n";
