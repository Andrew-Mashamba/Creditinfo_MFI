# MFI Management System UAT Test Execution Guide - Part 2
...
### LM-14: Apply Loan via MFI Management System Portal
**Tester**: Loan Officer  
...
### LM-31: MFI Management System Butua Rules
**Tester**: Loan Officer  
**Expected Result**: Proper rules configuration with savings limits and arrears checks

**Test Journey:**
1. Login as loan officer
2. Navigate to **Products** → **Loan Products** → **MFI Management System Butua**
