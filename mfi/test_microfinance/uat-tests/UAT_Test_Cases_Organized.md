# MFI Management System UAT TEST CASES 2025

## Test Execution Information
- **Project**: MFI Management System Core System
- **Version**: 2025
...
| Test Case ID | Tester | Test Case Description | Expected Result | Actual Results | Status | Comments |
|--------------|--------|----------------------|-----------------|----------------|---------|----------|
| LM-01 | Member | Member access to MFI Management System Portal | Member can log in using correct credentials | | | |
...
| LM-14 | Loan Officer | Apply loan via MFI Management System Portal | Loan officer can apply loan through internal portal | | | |
...
| LM-31 | Loan Officer | MFI Management System Butua rules | Proper rules configuration with savings limits and arrears checks | | | |
