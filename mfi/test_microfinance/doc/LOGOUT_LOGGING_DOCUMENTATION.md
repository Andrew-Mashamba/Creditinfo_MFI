...
The MFI Management System system now includes comprehensive logout event logging that captures detailed information about who logged out, when, why, and from where.
