...
The MFI Management System application now follows security best practices for credential management. All hardcoded secrets have been removed from source code and migrated to secure environment-based configuration.
