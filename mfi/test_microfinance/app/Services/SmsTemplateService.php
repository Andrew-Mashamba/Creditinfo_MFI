...
class SmsTemplateService
{
     ...
     */
    public function generateLoanDisbursementMemberSMS($memberName, $loanAmount, $monthlyInstallment, $controlNumber = null, $paymentLink = null, $firstPaymentDate = null, $saccoName = 'MFI Management System', $saccoPhone = '0800110022')
    {
    ...
    public function generateLoanDisbursementGuarantorSMS($guarantorName, $memberName, $loanAmount)
    {
        ...
        $message .= "Contact: +255 22 219 7000. MFI Management System";
    ...
    {
        $message = "Dear {$memberName}, welcome to MFI Management System! ";
    ...
    {
        $message = "Dear {$guarantorName}, you are guarantor for {$memberName} at MFI Management System. ";
    ...
    public function generatePaymentReminderSMS($memberName, $controlNumber, $amount, $dueDate)
    {
        ...
        $message .= "Pay via NBC Kiganjani, Wakala or branches. MFI Management System";
    ...
    public function generatePaymentConfirmationSMS($memberName, $controlNumber, $amount, $transactionId)
    {
        ...
        $message .= "Thank you. MFI Management System";
    ...
    public function generateEmergencyNotificationSMS($memberName, $message)
    {
        ...
        $emergencyMessage .= "Contact: +255 22 219 7000. MFI Management System";
