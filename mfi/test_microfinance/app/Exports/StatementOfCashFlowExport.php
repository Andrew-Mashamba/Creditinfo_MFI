...
class StatementOfCashFlowExport implements FromArray, WithHeadings, WithStyles, WithColumnWidths, WithTitle, WithEvents
{
    ...
    public function array(): array
    {
        ...
        // Header information
        $data[] = [$this->institution->name ?? 'MFI Management System'];
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $sheet->getHeaderFooter()->setOddHeader('&C&B&16' . ($this->institution->name ?? 'MFI Management System') . ' - Statement of Cash Flow');
