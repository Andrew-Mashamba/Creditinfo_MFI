...
class SendEmployeeCredentials implements ShouldQueue
{
    ...
    protected function sendCredentialsEmail()
    {
        ...
        $subject = 'Welcome to MFI System - Your Login Credentials';
        
        $body = "
            <h2>Welcome {$this->employee->first_name} {$this->employee->last_name}!</h2>
            <p>Your account has been created in the MFI System.</p>
            ...
            <br>
            <p>Best regards,<br>MFI System Administration</p>
        ";
    ...
    protected function sendCredentialsSms()
    {
        ...
        $message = "Welcome to MFI! Your login: Email: {$this->employee->email}, Password: {$this->password}. Please change password on first login. Login at: " . url('/login');
