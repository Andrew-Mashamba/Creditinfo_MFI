...
class SendOtpNotification implements ShouldQueue
{
        ...
        try {
            ...
            if ($this->user->phone_number) {
                try {
                    ...
                    $message = "MFI Management System OTP: {$this->otp}\n\nValid for 5 minutes. Do not share this code with anyone.";
    ...
    private function sendOtpViaSmtp($to, $otp)
    {
        ...
        $from_name = config('mail.from.name', 'MFI Management System');
        ...
        $subject = "Your MFI Management System Login OTP";
        $message = "Dear " . ($this->user->name ?? 'User') . ",\r\n\r\n";
        $message .= "Your One-Time Password (OTP) for MFI Management System login is:\r\n\r\n";
        $message .= "    $otp\r\n\r\n";
        $message .= "This code is valid for 5 minutes.\r\n\r\n";
        $message .= "If you did not request this code, please ignore this email.\r\n\r\n";
        $message .= "Best regards,\r\n";
        $message .= "MFI Management System Team\r\n";
