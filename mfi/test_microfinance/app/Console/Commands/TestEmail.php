...
class TestEmail extends Command
{
    ...
    public function handle()
    {
        ...
        $subject = 'MFI Management System - Test Email from System';
        $message = "This is a test email from MFI Management System system.\n\nSent at: " . now()->toString();
        ...
        try {
            ...
            // Send the message
            $headers = "From: MFI Management System <$from>\r\n";
            $headers .= "To: $to\r\n";
