...
class NewMemberWelcomeNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        $message = (new MailMessage)
            ->subject('Welcome to MFI Management System!')
            ->greeting('Dear ' . $this->member->first_name . ' ' . $this->member->last_name)
            ->line('Welcome to MFI Management System! We are delighted to have you as a member.');
        ...
        $message->line('For any assistance, please contact our support team.')
            ->line('Thank you for choosing MFI Management System!');
    ...
    public function toArray($notifiable)
    {
        ...
        return [
            ...
            'message' => 'Welcome to MFI Management System! Your control number is: ' . $controlNumberText
        ];
    }
} 