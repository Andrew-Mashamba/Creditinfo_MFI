       ...
       return [
           ...
           Column::callback(['id','status'],function($id,$status){
               return '<div class="flex items-center space-x-4 flex-lg-row">
                     ...
                     <span class="hidden text-red-800 m-1">Download</span>
                     </button>
                     </div>';
