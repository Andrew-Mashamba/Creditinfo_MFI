...
class SSOAuthController extends Controller
{
    ...
    public function logout(Request $request)
    {
        ...
        if ($user && $user->email) {
            try {
                // Connect to authentication database to get user ID with timeout
                $authDb = new \PDO(
                ...
                Log::warning('Authentication database connection failed - proceeding with logout', [
                    'error' => $e->getMessage(),
