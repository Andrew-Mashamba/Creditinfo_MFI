        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="bg-gray-50 p-2 rounded-xl mb-4">
                ...
                <div class="bg-white p-4 rounded-xl">
                    ...
                    <div class="text-lighter-shade">ENTER ISSUE DETAILS</div>
                    <div class="h-4"></div>
                ...
                @endif
                    ...
                    <div class="w-full mb-4">
                            <div class="form-group col-span-6 sm:col-span-4 mt-4">
                                ...
                                <div class="col-span-6 sm:col-span-4 mt-4">
                                    <x-jet-label for="issue_title" value="{{ __('Issue Title') }}" />
                                    <x-jet-input id="issue_title" type="text" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 mt-1 block w-full text-sm text-gray-900 bg-gray-50 rounded-2xl" wire:model.defer="issue_title" autocomplete="issue_title" />
                                    <x-jet-input-error for="issue_title" class="mt-2" />
                                </div>
                                <div class="col-span-6 sm:col-span-4 mt-4">
                                <x-jet-label for="issue_desc" value="{{ __('Issue Description') }}" />
                                <textarea wire:model.defer="issue_desc" autocomplete="issue_desc" id="issue_desc" rows="5" class="mt-1 block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-2xl border border-gray-300
                             focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                             dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Write your issue description here..."></textarea>


                                <x-jet-input-error for="issue_desc" class="mt-2" />
                            </div>
                        ...
                        dark:focus:ring-green-800" style="color: white">
                                ...
                                <button wire:click="store" type="button" class="flex items-center justify-center w-1/3 p-4 lighter-shade text-white  hover:bg-red-300 focus:outline-none focus:ring-4
                        focus:ring-green-300 rounded-full text-lg font-semibold px-5 py-2.5 text-center mr-2 mb-2 dark:bg-green-600 bg-red-400
                        dark:focus:ring-green-800" style="color: white">
