                ...
                @endif
                    ...
                    <div class="w-full mb-4">
                            <div class="form-group col-span-6 sm:col-span-4 mt-4">
                                ...
                                <div class="col-span-6 sm:col-span-4 mt-4">
                                    <x-jet-label for="task_name" value="{{ __('Task Name') }}" />
                                    <x-jet-input id="task_name" type="text" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 mt-1 block w-full text-sm text-gray-900 bg-gray-50 rounded-2xl" wire:model.defer="task_name" autocomplete="task_name" />
                                    <x-jet-input-error for="task_name" class="mt-2" />
                                </div>
                                <div class="col-span-6 sm:col-span-4 mt-4">
                                <x-jet-label for="task_desc" value="{{ __('Task Description') }}" />
                                <textarea wire:model.defer="task_desc" autocomplete="task_desc" id="task_desc" rows="5" class="mt-1 block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-2xl border border-gray-300
                             focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                             dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Write your task description here..."></textarea>


                                <x-jet-input-error for="task_desc" class="mt-2" />
                            </div>
                        ...
                        focus:ring-red-300 rounded-full text-lg font-semibold px-5 py-2.5 text-center mr-2 mb-2 bg-red-400 dark:hover:bg-green-700
                        dark:focus:ring-green-800" style="color: white">
