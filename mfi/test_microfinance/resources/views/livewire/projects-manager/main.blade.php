<div>
	<div class="p-4">
		...
		<div class="flex w-full mb-4 gap-2">
			<!-- Left: Avatars -->
{{--			<div class="bg-white w-full  flex  items-center " >--}}
				<div class="flex w-1/3 gap-2">


					@php
						$menuItems = [
                            ['id' => 2, 'label' => 'Project List'],
            ...
            @if ($this->selected == $menuItem['id']) bg-red-600 @else bg-gray-100 @endif
								@if ($this->selected == $menuItem['id']) text-white font-bold @else text-gray-400 font-semibold @endif
...
{{--			</div>--}}
		...
		<div class="bg-white">
			<div class="tab-pane fade " id="tabs-homeJustify" role="tabpanel" aria-labelledby="tabs-home-tabJustify">
				...
				<div wire:loading.remove wire:target="setView" class="tssssst">

					@switch($this->selected)

						@case('1')
					<livewire:projects-manager.create-an-project/>

						@break
					@case('2')

					<livewire:projects-manager.project-list/>
