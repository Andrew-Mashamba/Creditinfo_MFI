<div class="file-uploader {{ $customClass }}">
    <div class="relative">
        <input 
            ...
            class="file-upload-input w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
        ...
        @if($showProgress)
            <div wire:loading wire:target="uploadedFiles" class="mt-2">
                <div class="w-full bg-gray-200 rounded-full h-2.5">
                    <div class="bg-red-600 h-2.5 rounded-full animate-pulse" style="width: 45%"></div>
                </div>
