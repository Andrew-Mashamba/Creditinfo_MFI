                ...
                <div class="p-4 border-b border-gray-100">
                    <div class="relative">
                        ...
                        <input type="text" wire:model.debounce.300ms="search" placeholder="Search transactions..."
                            class="block w-full pl-9 pr-3 py-2 border border-gray-200 rounded-lg text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent bg-gray-50 hover:bg-white focus:bg-white"/>
                    </div>
                </div>
                <div class="p-3">
                            ...
                            @if($hasPermission)
                                ...
                                <button wire:click="selectedMenu({{ $section['id'] }})" class="relative w-full group transition-all duration-200">
                                    <div class="flex items-center p-2.5 rounded-lg transition-all duration-200
                                        @if ($isActive) bg-red-600 text-white shadow-lg @else bg-gray-50 hover:bg-gray-100 text-gray-700 @endif">
                        ...
                        <div class="grid grid-cols-7 gap-2">
                            ...
                            <div class="text-center">
                                ...
                                <div class="bg-red-100 rounded-lg p-2">
                                    <div class="text-lg font-bold text-red-900">{{ $day['count'] }}</div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50 cursor-pointer" wire:click="viewTransaction({{ $txn['id'] }})">
                                        <td class="px-4 py-2 text-sm text-red-600">{{ Str::limit($txn['reference'], 20) }}</td>
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-200">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <button wire:click="clearFilters" class="text-sm text-red-600 hover:text-red-800">Clear All</button>
                        </div>
                        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                            <div>
                                <label class="block text-xs font-medium text-gray-700 mb-1">Status</label>
                                <select wire:model="status" class="w-full rounded-md border-gray-300 text-sm focus:border-red-500 focus:ring-red-500">
                            ...
                            <div>
                                ...
                                <select wire:model="category" class="w-full rounded-md border-gray-300 text-sm focus:border-red-500 focus:ring-red-500">
                                    <option value="">All</option>
                            ...
                            <div>
                                ...
                                <select wire:model="source" class="w-full rounded-md border-gray-300 text-sm focus:border-red-500 focus:ring-red-500">
                                    <option value="">All</option>
                            ...
                            <div>
                                ...
                                <select wire:model="serviceName" class="w-full rounded-md border-gray-300 text-sm focus:border-red-500 focus:ring-red-500">
                                    <option value="">All</option>
                            ...
                            <div>
                                ...
                                <select wire:model="channelCode" class="w-full rounded-md border-gray-300 text-sm focus:border-red-500 focus:ring-red-500">
                                    <option value="">All</option>
                            ...
                            <div>
                                ...
                                <select wire:model="reconciliationStatus" class="w-full rounded-md border-gray-300 text-sm focus:border-red-500 focus:ring-red-500">
                                    <option value="">All</option>
                            ...
                            <div>
                                ...
                                <input type="date" wire:model="dateFrom" class="w-full rounded-md border-gray-300 text-sm focus:border-red-500 focus:ring-red-500">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-700 mb-1">Date To</label>
                                <input type="date" wire:model="dateTo" class="w-full rounded-md border-gray-300 text-sm focus:border-red-500 focus:ring-red-500">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-700 mb-1">Amount From</label>
                                <input type="number" wire:model="amountFrom" placeholder="0" class="w-full rounded-md border-gray-300 text-sm focus:border-red-500 focus:ring-red-500">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-700 mb-1">Amount To</label>
                                <input type="number" wire:model="amountTo" placeholder="0" class="w-full rounded-md border-gray-300 text-sm focus:border-red-500 focus:ring-red-500">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-700 mb-1">External System</label>
                                <select wire:model="externalSystem" class="w-full rounded-md border-gray-300 text-sm focus:border-red-500 focus:ring-red-500">
                                    <option value="">All</option>
                            ...
                            <div>
                                ...
                                <select wire:model="perPage" class="w-full rounded-md border-gray-300 text-sm focus:border-red-500 focus:ring-red-500">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-2 py-2">
                                        ...
                                        @else
                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-800" title="Outgoing Transfer">
                                    ...
                                    <td class="px-2 py-2">
                                        <div class="text-sm font-medium text-red-600">{{ Str::limit($transaction->reference, 16) }}</div>
                                    ...
                                    <td class="px-2 py-2">
                                        ...
                                        @elseif($isIFT)
                                            ...
                                            <div class="text-xs text-gray-500 font-mono">{{ Str::limit($destAccount, 14) }}</div>
                                        @elseif($isIncoming)
                                            <div class="text-sm text-gray-900">MFI Account</div>
                                            <div class="text-xs text-gray-500 font-mono">{{ Str::limit($destAccount, 14) }}</div>
                                        @else
                                    ...
                                    <td class="px-2 py-2">
                                        <button wire:click="viewTransaction({{ $transaction->id }})" class="text-red-600 hover:text-red-900 text-xs font-medium">View</button>
                                    </td>
                                </tr>
                                @empty
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-2">
                                        <button wire:click="viewTransaction({{ $txn->id }})" class="text-red-600 hover:text-red-900 text-xs">View</button>
                                    </td>
                                </tr>
                                @empty
                                ...
                                <div>
                                    ...
                                    <dd class="mt-1">
                                        ...
                                        @elseif($modalIsIncoming)
                                            <div class="text-sm font-medium text-gray-900">MFI Account</div>
                                            <div class="text-xs text-gray-500 font-mono">{{ $selectedTransaction->credit_account ?? '-' }}</div>
                                        @else
                                            <div class="text-sm text-gray-500">-</div>
                                        @endif
            ...
            <div class="inline-block bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea wire:model="reconciliationNotes" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500" placeholder="Enter reconciliation notes..."></textarea>
                    </div>
                </div>
