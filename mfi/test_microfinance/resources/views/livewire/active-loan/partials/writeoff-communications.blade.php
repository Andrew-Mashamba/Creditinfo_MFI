    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-6">
            <div class="bg-red-50 rounded-lg p-4">
                <p class="text-sm text-red-600 font-medium">Total Sent</p>
                <p class="text-2xl font-bold text-red-800">
                    {{ \App\Models\WriteoffMemberCommunication::count() }}
                </p>
                <p class="text-xs text-red-600 mt-1">All channels</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="mt-2 flex gap-2">
                        <span class="text-xs bg-red-100 text-red-800 px-2 py-1 rounded">SMS</span>
