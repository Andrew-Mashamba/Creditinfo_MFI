<div>
    ...
    <div>{{-- In work, do what you enjoy. --}}
        <div>
            <nav class="bg-red-100   rounded-lg pl-2 pr-2 ">
                <div class="relative flex h-16 items-center justify-between">
                    <div class="flex flex-1 items-center justify-between">
                        <div class="flex flex-shrink-0 items-start">
                            <div class="">
                                ...
                                <div class="text-red-400 ml-4 mr-5 ">
                                    <div class="text-red-900 font-bold">
                        ...
                        <div class="flex">
                            ...
                            <button type="button"  class="rounded-full bg-white p-1 text-gray-400 hover:text-red-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
            ...
            @foreach ($loan_general_info as $info )
                <div
                class="grid grid-cols-1 sm:grid-cols-2 p-4 border-red-800 border-2 md:grid-cols-3 gap-6 pb-4 bg-gray-50 rounded-xl p-4 mt-4">
    ...
    <div class="grid grid-cols-2 border-red-900 border-2 sm:grid-cols-2 md:grid-cols-2 gap-6 pb-4 bg-white rounded-xl p-4 mt-4">

        <div>
            <span class="bg-red-600 text-white rounded-full px-3 py-1 text-center">
                {{ $loop->iteration }}
              </span>
    ...
    <div class="flex justify-end gap-2">
        ...
        <button type="button" wire:click="calculateArrearsAndPenalties()" class="flex items-center gap-2 rounded-full bg-white p-1 text-gray-400 hover:text-red-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
    ...
    <table class="min-w-full border-collapse border-2 border-red-900 bg-white rounded-xl mt-4">
        <thead class="bg-gray-50">
        <tr>
            <th class="px-4 py-2 text-sm font-medium text-gray-700 border-b border-red-900">Installment Date</th>
            <th class="px-4 py-2 text-sm font-medium text-gray-700 border-b border-red-900">Opening Balance</th>
            <th class="px-4 py-2 text-sm font-medium text-gray-700 border-b border-red-900">Installment</th>
            <th class="px-4 py-2 text-sm font-medium text-gray-700 border-b border-red-900">Interest</th>
            <th class="px-4 py-2 text-sm font-medium text-gray-700 border-b border-red-900">Principle</th>
            <th class="px-4 py-2 text-sm font-medium text-gray-700 border-b border-red-900">Closing Balance</th>
            <th class="px-4 py-2 text-sm font-medium text-gray-700 border-b border-red-900">Payment</th>
            <th class="px-4 py-2 text-sm font-medium text-gray-700 border-b border-red-900">Completion Status</th>
            <th class="px-4 py-2 text-sm font-medium text-gray-700 border-b border-red-900">Penalties</th>
            <th class="px-4 py-2 text-sm font-medium text-gray-700 border-b border-red-900">Amount in Arrears</th>
            <th class="px-4 py-2 text-sm font-medium text-gray-700 border-b border-red-900">Days in Arrears</th>
        </tr>
        </thead>
        <tbody>
        @foreach ($loan_schedules as $data)
            <tr>
                <td class="px-4 py-2 text-sm font-medium text-gray-500 border-b border-red-900">{{ $data->installment_date }}</td>
                <td class="px-4 py-2 text-sm font-medium text-gray-500 border-b border-red-900">{{ number_format($data->opening_balance, 2) }}</td>
                <td class="px-4 py-2 text-sm font-medium text-gray-500 border-b border-red-900">{{ number_format($data->installment, 2) }}</td>
                <td class="px-4 py-2 text-sm font-medium text-gray-500 border-b border-red-900">{{ number_format($data->interest, 2) }}</td>
                <td class="px-4 py-2 text-sm font-medium text-gray-500 border-b border-red-900">{{ number_format($data->principle, 2) }}</td>
                <td class="px-4 py-2 text-sm font-medium text-gray-500 border-b border-red-900">{{ number_format($data->closing_balance, 2) }}</td>
                <td class="px-4 py-2 text-sm font-medium text-gray-500 border-b border-red-900">{{ number_format($data->payment, 2) }}</td>
                <td class="px-4 py-2 text-sm font-medium text-gray-500 border-b border-red-900">{{ $data->completion_status }}</td>
                <td class="px-4 py-2 text-sm font-medium text-gray-500 border-b border-red-900">{{ number_format($data->penalties, 2) }}</td>
                <td class="px-4 py-2 text-sm font-medium text-gray-500 border-b border-red-900">{{ number_format($data->amount_in_arrears, 2) }}</td>
                <td class="px-4 py-2 text-sm font-medium text-gray-500 border-b border-red-900">{{ $data->days_in_arrears }}</td>
            </tr>
        @endforeach
        </tbody>
    </table>
