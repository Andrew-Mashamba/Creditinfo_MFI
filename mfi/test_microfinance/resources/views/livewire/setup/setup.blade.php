    ...
    <div class="row-span-1 col-span-1 bg-slate-50 border-r flex flex-col">
        ...
        <div class="h-full">
            ...
            <div wire:click="menuItemClicked(1)"
                 class="@if( $tab_id == 1 ) border-l-red-400 border-t border-b  bg-white @else border-l-transparent @endif
            ...
            <div wire:click="menuItemClicked(2)"
                 class="@if( $tab_id == 2 ) border-l-red-400 border-t border-b  bg-white @else border-l-transparent @endif
                        px-5 py-4   flex items-center cursor-pointer border-l-4 hover:bg-slate-100">
                <div class="">
