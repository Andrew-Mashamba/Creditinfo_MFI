                            ...
                            @foreach($budgets as $budget)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        ...
                                        <button wire:click="openTransferModal({{ $budget->id }})" class="text-red-600 hover:text-red-900 mr-2">Transfer</button>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($commitments as $commitment)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-{{ $commitment->status === 'COMMITTED' ? 'red' : ($commitment->status === 'PARTIALLY_UTILIZED' ? 'yellow' : 'green') }}-100">
                                            {{ $commitment->status }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
