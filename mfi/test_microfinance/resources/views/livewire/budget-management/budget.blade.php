                ...
                <div class="p-6 border-b border-gray-100">
                    ...
                    <div class="relative">
                        <select wire:model="selectYear" wire:change="refreshComponent"
                                class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 bg-gray-50 hover:bg-white focus:bg-white">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                                        ...
                                        <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border border-red-200">
                                            <div class="flex items-center justify-between mb-4">
                                                <h3 class="text-lg font-semibold text-red-900">Budget Summary</h3>
                                            ...
                                            <div class="space-y-3">
                                                <div class="flex justify-between">
                                                    <span class="text-sm text-red-700">Total Budget:</span>
                                                    @php
                                                        $totalBudget2 = App\Models\BudgetManagement::selectRaw("COALESCE(SUM(CAST(revenue as numeric)),0) as total")->value('total');
                                                    @endphp
                                                    <span class="font-semibold text-red-900">{{ number_format($totalBudget2, 2) }} TZS</span>
                                                </div>
                                                <div class="flex justify-between">
                                                    <span class="text-sm text-red-700">Budget Items:</span>
                                                    <span class="font-semibold text-red-900">{{App\Models\BudgetManagement::count()}}</span>
                                                </div>
                                                <div class="flex justify-between">
                                                    <span class="text-sm text-red-700">Avg. per Item:</span>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                            ...
                                            <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl p-6 border border-indigo-200">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <p class="text-sm text-red-900">Variance</p>
                                                </div>
                                            </div>
