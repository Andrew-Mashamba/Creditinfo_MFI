...
<div class="max-w-7xl mx-auto">
    <div class="bg-gradient-to-r from-red-600 to-indigo-700 rounded-lg shadow-lg p-8 mb-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="#getting-started" class="flex items-center p-3 bg-red-50 rounded-lg hover:bg-red-100 transition">
    ...
    <div id="getting-started" class="bg-white rounded-lg shadow-md p-8 mb-8">
        <h2 class="text-2xl font-bold mb-6 text-gray-800 flex items-center">
            <span class="bg-red-100 text-red-600 rounded-full w-10 h-10 flex items-center justify-center mr-3">1</span>
            Getting Started
        </h2>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-red-50 border-l-4 border-red-600 p-4 rounded">
                <h4 class="font-semibold text-red-900 mb-2">Quick Start Steps:</h4>
    ...
    <div id="faq" class="bg-white rounded-lg shadow-md p-8 mb-8">
        ...
        <div class="space-y-4">
            <details class="border-b pb-4">
                <summary class="font-semibold cursor-pointer hover:text-red-600">Q: What happens to unused budget at month end?</summary>
            ...
            <details class="border-b pb-4">
                <summary class="font-semibold cursor-pointer hover:text-red-600">Q: Can I borrow from multiple future periods?</summary>
            ...
            <details class="border-b pb-4">
                <summary class="font-semibold cursor-pointer hover:text-red-600">Q: How long does supplementary approval take?</summary>
            ...
            <details class="border-b pb-4">
                <summary class="font-semibold cursor-pointer hover:text-red-600">Q: Can I cancel an advance request?</summary>
            ...
            <details class="border-b pb-4">
                <summary class="font-semibold cursor-pointer hover:text-red-600">Q: What triggers an OVERSPENT alert?</summary>
...
<div class="fixed bottom-6 right-6">
    <button onclick="window.scrollTo({top: 0, behavior: 'smooth'})" class="bg-red-600 text-white rounded-full p-4 shadow-lg hover:bg-red-700 transition">
