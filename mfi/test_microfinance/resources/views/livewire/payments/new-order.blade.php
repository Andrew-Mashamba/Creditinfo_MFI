                            ...
                            <ul class="w-full nav nav-tabs flex flex-wrap -mb-px justify-between text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                                <li class="mr-2 nav-item" role="presentation" >
                                    <a href="#tabs-homeJustify"
                                       ...
                                       class="
                                        {{$this->oneIsSetClicked  ? "text-red-600 border-red-600 active dark:text-red-500  dark:border-red-500 " : "border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 "}}
                                                   inline-flex p-4
                                                    rounded-t-lg
                                                    border-b-2
                                                    group"
                                ...
                                <li class="mr-2 nav-item" role="presentation" >
                                    <a href="#tabs-profileJustify"
                                       ...
                                       class="
                   {{$this->twoIsSetClicked  ? "text-red-600 border-red-600 active dark:text-red-500  dark:border-red-500 " : "border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 "}}
                                                   inline-flex p-4
                                                    rounded-t-lg
                                                    border-b-2
                                                    group"
                                ...
                                <li class="mr-2 nav-item" role="presentation" wire:click="changeTab(3)">
                                    <a href="#tabs-messagesJustify"
                                       ...
                                       class="
                   {{$this->threeIsSetClicked  ? "text-red-600 border-red-600 active dark:text-red-500  dark:border-red-500 " : "border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 "}}
                                                   inline-flex p-4
                                                    rounded-t-lg
                                                    border-b-2
                                                    group"
                        ...
                        <div class="w-full tab-content" id="tabs-tabContentJustify">
                            <div class="tab-pane fade {{$this->oneIsSetClicked  ? "show active" : "" }}" id="tabs-homeJustify" role="tabpanel"
                                ...
                                @endif
                                 ...
                                 @if($this->twoIsSetClicked)

                                <div class="mt-4 text-l font-bold strong mx-4 " >
                                     {{ $this->title }}
                                </div>
                                ...
                                <div class="bg-gray-200 bg-opacity-25 my-4 pb-px">
                                    <div class="p-3">
                                        <div class="col-span-6 sm:col-span-4">
                                            <x-jet-label for="unCommitedOrderNumber" value="{{ __('Reference  number') }}" />
                                            <x-jet-input wire:keydown="start" id="unCommitedOrderNumber" type="text" class="mt-1 block w-full" value="{{ $this->reference_number }}" wire:model.defer="unCommitedOrderNumber" autocomplete="unCommitedOrderNumber" />
                                ...
                                @if ($amountOfTransactions=="Single Transaction")

                                <div class="p-3">
                                    <div class="form-group row">

                                        <x-jet-label for="sourceaccount" value="{{ __('Select Source  Account') }}" />
                                        ...
                                        <x-jet-input-error for="sourceAccount" class="mt-2" />
                                ...
                                <div class="p-3">
                                    <div class="form-group row">
                                        ...
                                        <x-jet-label for="destination_account" value="{{ __('Select Destination  Account') }}" />
                                        <select id="destination_account" wire:model="destination_account" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm sm:px-3 sm:text-sm h-10" required>
                                            <option value="" selected>Select</option>
                                        ...
                                        <x-jet-input-error for="destination_account" class="mt-2" />
                                ...
                                <div class="p-3">
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <x-jet-input id="amount" type="number" class="mt-1 block w-full" wire:model.defer="amount" autocomplete="amount"></x-jet-input>
                                        ...
                                        <div class="p-3">
                                            ...
                                            <div class="col-span-6 sm:col-span-4">
                                                ...
                                                <form wire:submit.prevent="importData">
                                                    ...
                                                    <input wire:model="excelFile" class="form-control block mt-1 block w-full px-2 py-1 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-red-600 focus:outline-none" id="formFileSm" type="file">
                                                    ...
                                                    <div class=""  align="right">
                                                        ...
                                                        <button type="submit" wire:loading.attr="disabled" type="button" class="inline-block px-4 py-1.5 bg-gray-400  mt-4 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-gray-400 hover:shadow-lg focus:bg-red-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg transition duration-150 ease-in-out">
                                ...
                                @if($this->amountOfTransactions =='Batch')
                                    ...
                                    <div class="bg-gray-200 bg-opacity-25 my-4 pb-px">
                                        <div class="p-3">
                                            ...
                                            <div class="flex justify-between">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-red-600 checked:border-red-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
