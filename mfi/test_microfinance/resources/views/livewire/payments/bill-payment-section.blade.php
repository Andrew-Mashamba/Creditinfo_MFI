    ...
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between">
            ...
            @if($selectedSpCode || $billDetails || $paymentResponse)
                <button wire:click="resetBillPayment" class="text-sm text-red-600 hover:text-red-700 font-medium">
                    Start New Payment
                </button>
            @endif
        </div>
                    ...
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px flex space-x-8 overflow-x-auto" aria-label="Categories">
                            <button wire:click="$set('selectedCategory', null)"
                                    class="{{ !$selectedCategory ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm">
                                All Billers
                            </button>
                            @foreach($billersGrouped as $category => $categoryBillers)
                                <button wire:click="$set('selectedCategory', '{{ $category }}')"
                                        class="{{ $selectedCategory === $category ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm capitalize">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        ...
                        @forelse($displayBillers as $biller)
                            <button wire:click="selectBiller('{{ $biller['spCode'] }}')"
                                    ...
                                    class="p-4 border-2 border-gray-200 rounded-lg hover:border-red-500 hover:bg-red-50 transition-all duration-200 text-left group disabled:opacity-50 disabled:cursor-not-allowed">
                                <div class="flex items-start space-x-3">
                                    ...
                                    @endif
                                    <div class="flex-1">
                                        <div class="font-medium text-gray-900 group-hover:text-red-600">
        ...
        @elseif(!$billDetails)
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="flex items-center">
                        <div class="w-8 h-8 bg-red-500 text-white rounded-full flex items-center justify-center text-sm font-medium">2</div>
                ...
                <form wire:submit.prevent="inquireBill" class="space-y-4">
                    ...
                    <div class="flex justify-between">
                        ...
                        <button type="submit" 
                                wire:loading.attr="disabled"
                                class="inline-flex items-center px-6 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed">
        ...
        @elseif(!$paymentResponse)
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="flex-1 h-0.5 bg-gray-200"></div>
                    <div class="flex items-center">
                        <div class="w-8 h-8 bg-red-500 text-white rounded-full flex items-center justify-center text-sm font-medium">3</div>
                        <span class="ml-2 text-sm font-medium text-gray-900">Payment</span>
                    </div>
                </div>

                {{-- Bill Details Card --}}
                <div class="bg-gradient-to-r from-green-50 to-red-50 border border-green-200 rounded-lg p-6">
