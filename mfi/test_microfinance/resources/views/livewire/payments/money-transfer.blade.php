            ...
            <div class="flex items-center space-x-8">
                ...
                <div class="flex items-center space-x-2">
                    <div class="w-10 h-10 rounded-full flex items-center justify-center text-sm font-medium
                        @if($currentPhase === 'form') border-2 border-red-500 bg-red-500 text-white
                    ...
                    <span class="text-sm font-medium @if($currentPhase === 'form') text-red-600 @elseif(in_array($currentPhase, ['verify', 'processing', 'complete'])) text-green-600 @else text-gray-500 @endif">
                        Details
                    </span>
                </div>
                ...
                <div class="flex items-center space-x-2">
                    <div class="w-10 h-10 rounded-full flex items-center justify-center text-sm font-medium
                        @if($currentPhase === 'verify') border-2 border-red-500 bg-red-500 text-white
                    ...
                    <span class="text-sm font-medium @if($currentPhase === 'verify') text-red-600 @elseif(in_array($currentPhase, ['processing', 'complete'])) text-green-600 @else text-gray-500 @endif">
                        Verify
                    </span>
                </div>
            ...
            @switch($currentPhase)
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <button wire:click="$set('transferCategory', 'internal')"
                                    class="relative p-6 border-2 rounded-lg transition-all duration-200 hover:shadow-md
                                        @if($transferCategory === 'internal') border-red-500 bg-red-50 @else border-gray-200 hover:border-gray-300 @endif">
                                    <div class="flex flex-col items-center space-y-3">
                                        <svg class="w-12 h-12 @if($transferCategory === 'internal') text-red-600 @else text-gray-400 @endif" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path>
                                        </svg>
                                        <div class="text-center">
                                            <div class="font-semibold text-lg @if($transferCategory === 'internal') text-red-900 @else text-gray-900 @endif">Internal Transfer</div>
                                ...
                                <button wire:click="$set('transferCategory', 'external')"
                                    class="relative p-6 border-2 rounded-lg transition-all duration-200 hover:shadow-md
                                        @if($transferCategory === 'external') border-red-500 bg-red-50 @else border-gray-200 hover:border-gray-300 @endif">
                                    <div class="flex flex-col items-center space-y-3">
                                        <svg class="w-12 h-12 @if($transferCategory === 'external') text-red-600 @else text-gray-400 @endif" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                                        </svg>
                                        <div class="text-center">
                                            <div class="font-semibold text-lg @if($transferCategory === 'external') text-red-900 @else text-gray-900 @endif">External Transfer</div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <button wire:click="$set('transferType', 'bank')"
                                        class="relative p-4 border-2 rounded-lg transition-all duration-200 hover:shadow-md
                                            @if($transferType === 'bank') border-red-500 bg-red-50 @else border-gray-200 hover:border-gray-300 @endif">
                                        <div class="flex items-center space-x-3">
                                            <svg class="w-8 h-8 @if($transferType === 'bank') text-red-600 @else text-gray-400 @endif" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                                            </svg>
                                            <div class="text-left">
                                                <div class="font-medium @if($transferType === 'bank') text-red-900 @else text-gray-900 @endif">Bank Account</div>
                                    ...
                                    <button wire:click="$set('transferType', 'wallet')"
                                        class="relative p-4 border-2 rounded-lg transition-all duration-200 hover:shadow-md
                                            @if($transferType === 'wallet') border-red-500 bg-red-50 @else border-gray-200 hover:border-gray-300 @endif">
                                        <div class="flex items-center space-x-3">
                                            <svg class="w-8 h-8 @if($transferType === 'wallet') text-red-600 @else text-gray-400 @endif" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                                            </svg>
                                            <div class="text-left">
                                                <div class="font-medium @if($transferType === 'wallet') text-red-900 @else text-gray-900 @endif">Mobile Wallet</div>
                            ...
                            <div class="bg-green-50 border border-green-200 rounded-lg p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    @elseif($verificationData['type'] === 'bank')
                                        <div>
                                            <p class="text-sm text-gray-600">Account Name</p>
                                            <p class="font-semibold text-green-700">{{ $verificationData['account_name'] ?? 'N/A' }}</p>
                                        </div>
                                        <div>
                                            <p class="text-sm text-gray-600">Account Number</p>
                                            <p class="font-medium">{{ $verificationData['account_number'] ?? 'N/A' }}</p>
                                        ...
                                        @if($verificationData['engine_ref'] ?? false)
                                        <div>
                                            <p class="text-sm text-gray-600">Reference ID</p>
                                            <p class="font-mono text-xs">{{ $verificationData['engine_ref'] }}</p>
                                        </div>
                                        @endif
                ...
                @case('complete')
                    ...
                    <div class="text-center py-8">
                        ...
                        <div class="bg-gradient-to-r from-green-50 to-red-50 rounded-lg p-6 text-left max-w-lg mx-auto border border-green-200 shadow-inner">
                        ...
                        <div class="mt-8 flex justify-center space-x-4">
                            <button wire:click="resetForm" 
                                class="inline-flex items-center px-6 py-3 border border-transparent rounded-lg shadow-lg text-sm font-semibold text-white bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 transform transition hover:scale-105">
                                <svg class="mr-2 -ml-1 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
