                                                ...
                                                <div class="flex items-center justify-center" >
                                                    <div class="inline-flex " role="group" >
                                                        ...
                                                        <button wire:click="getOrderDetails({{$order->id}})"
                                                                type="button" class="rounded-l rounded-r inline-block inline-flex items-center px-4 py-2 bg-white border font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:text-gray-500 focus:outline-none focus:border-red-300 focus:ring focus:ring-red-200 active:text-gray-800 active:bg-gray-50 disabled:opacity-25 transition">
                                                            View
                                                        </button>
                                                    </div>
                                                </div>
        ...
        <x-slot name="content">
            <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer">
                ...
                <button type="button" class="relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10
                    focus:outline-none focus:border-red-300 focus:ring focus:ring-red-200 "
