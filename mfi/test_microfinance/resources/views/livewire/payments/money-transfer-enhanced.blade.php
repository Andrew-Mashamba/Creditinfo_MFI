        ...
        <div class="flex items-center justify-center">
            <div class="flex items-center space-x-8">
                    ...
                    <div class="relative">
                        <div class="w-12 h-12 rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-300
                            @if($currentPhase === 'form') 
                                border-2 border-red-500 bg-red-500 text-white shadow-lg ring-4 ring-red-100
                        ...
                        @if($currentPhase === 'form')
                            <div class="absolute -bottom-1 -right-1 w-3 h-3 bg-red-500 rounded-full animate-ping"></div>
                        @endif
                    </div>
                    <div>
                        <span class="text-sm font-semibold @if($currentPhase === 'form') text-red-600 @elseif(in_array($currentPhase, ['verify', 'processing', 'complete'])) text-green-600 @else text-gray-500 @endif">
                            Enter Details
                        </span>
                ...
                <div class="flex items-center space-x-3 group">
                    ...
                    <div>
                        <span class="text-sm font-semibold @if($currentPhase === 'verify') text-red-600 @elseif(in_array($currentPhase, ['processing', 'complete'])) text-green-600 @else text-gray-500 @endif">
                            Verify & Confirm
                        </span>
        ...
        <div class="bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden">
            ...
            <div class="p-8">
                <div class="text-center">
                    ...
                    <div class="bg-gradient-to-br from-green-50 via-red-50 to-purple-50 rounded-xl p-6 text-left max-w-2xl mx-auto border border-green-200 shadow-inner">
