            ...
            <div class="px-6 py-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
                    ...
                    <div class="bg-red-50 p-4 rounded-lg">
                        <div class="text-sm font-medium text-red-600">Number of Disbursements</div>
                        <div class="text-2xl font-bold text-red-900">{{ number_format($reportData['disbursement_summary']['number_of_disbursements']) }}</div>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-3">
                        <button wire:click="exportToPDF" 
                            ...
                            <span wire:loading wire:target="exportToPDF">Exporting...</span>
                        </button>
