    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            <div class="bg-red-50 p-4 rounded-lg">
                <h4 class="font-medium text-red-900">Deposits</h4>
                <p class="text-2xl font-bold text-red-600">{{ $transactionSummary['deposits']['count'] ?? 0 }}</p>
                <p class="text-sm text-red-700">{{ number_format($transactionSummary['deposits']['total_amount'] ?? 0, 2) }} TZS</p>
            </div>
            <div class="bg-red-50 p-4 rounded-lg">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    {{ $loan['status'] === 'Approved' ? 'bg-green-100 text-green-800' : 
                                       ($loan['status'] === 'Under Review' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800') }}">
                                    {{ $loan['status'] }}
                                </span>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    {{ $staff['efficiency_rating'] === 'Excellent' ? 'bg-green-100 text-green-800' : 
                                       ($staff['efficiency_rating'] === 'Good' ? 'bg-red-100 text-red-800' : 'bg-yellow-100 text-yellow-800') }}">
