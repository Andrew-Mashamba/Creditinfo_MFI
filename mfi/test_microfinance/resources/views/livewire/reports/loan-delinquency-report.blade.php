        ...
        <div class="bg-white shadow rounded-lg">
            ...
            <div class="px-6 py-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
                    ...
                    <div class="bg-red-50 p-4 rounded-lg">
                        <div class="text-sm font-medium text-red-600">Total Loan Portfolio</div>
                        <div class="text-2xl font-bold text-red-900">{{ number_format($reportData['delinquency_summary']['total_loan_portfolio'], 2) }}</div>
                    </div>
