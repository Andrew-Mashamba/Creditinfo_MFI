<div class="space-y-6">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="text-center">
                <div class="text-4xl font-bold text-red-600">{{ $overallScore }}</div>
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-red-50 p-4 rounded-lg">
                <h4 class="font-medium text-red-900">Current Ratio</h4>
                <p class="text-2xl font-bold text-red-600">{{ $liquidityRatios['current_ratio']['value'] ?? 0 }}</p>
                <p class="text-sm text-red-700">Benchmark: {{ $liquidityRatios['current_ratio']['benchmark'] ?? 0 }}</p>
                <p class="text-xs text-red-600">{{ $liquidityRatios['current_ratio']['status'] ?? 'N/A' }}</p>
            </div>
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            <div class="bg-red-50 p-4 rounded-lg">
                <h4 class="font-medium text-red-900">Gross Profit Margin</h4>
                <p class="text-2xl font-bold text-red-600">{{ $profitabilityRatios['gross_profit_margin']['value'] ?? 0 }}%</p>
                <p class="text-sm text-red-700">Benchmark: {{ $profitabilityRatios['gross_profit_margin']['benchmark'] ?? 0 }}%</p>
            </div>
            <div class="bg-green-50 p-4 rounded-lg">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div class="bg-red-50 p-4 rounded-lg">
                <h4 class="font-medium text-red-900">Concentration Risk</h4>
                <p class="text-2xl font-bold text-red-600">{{ $riskRatios['concentration_risk']['value'] ?? 0 }}%</p>
                <p class="text-sm text-red-700">Benchmark: {{ $riskRatios['concentration_risk']['benchmark'] ?? 0 }}%</p>
            </div>
        </div>
    </div>
