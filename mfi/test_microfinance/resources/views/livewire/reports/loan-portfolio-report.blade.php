            ...
            <div class="px-6 py-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div class="bg-red-50 p-4 rounded-lg">
                        <div class="text-sm font-medium text-red-600">Total Portfolio</div>
                        <div class="text-2xl font-bold text-red-900">{{ number_format($reportData['portfolio_summary']['total_portfolio'], 2) }}</div>
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-red-50 p-4 rounded-lg">
                            <div class="text-sm font-medium text-red-600">Month-over-Month Growth</div>
