    ...
    <div class="p-6 bg-white rounded-lg shadow-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-1 gap-4 mb-6">
            <div class="bg-red-50 p-4 rounded-lg">
                <h3 class="text-lg font-semibold text-red-800">Total Cash Balance</h3>
                <p class="text-2xl font-bold text-red-600">TZS {{ number_format(array_sum(array_column($cashBalances, 'balance')), 2) }}</p>
            </div>
        </div>
