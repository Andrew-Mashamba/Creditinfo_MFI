    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-4">
                <div>
                    ...
                    <input type="date" wire:model="startDate" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">End Date</label>
                    <input type="date" wire:model="endDate" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
            <div class="bg-red-50 rounded-lg p-4">
                <h3 class="text-lg font-semibold text-red-800">Total Loans Disbursed</h3>
                <p class="text-2xl font-bold text-red-600">{{ number_format($totalLoans) }}</p>
            </div>
