<div>
    ...
    <div class="grid gap-4 grid-cols-1 grid-cols-4 my-2 w-full">
        ...
        <div class="metric-card @if($this->selected==10) rounded-lg p-4  bg-red-600 text-white @else   dark:bg-gray-900 border  bg-white  border-gray-200 dark:border-gray-800  rounded-lg p-4   w-full @endif ">
        ...
        <div class="metric-card  @if($this->selected==30) rounded-lg p-4  bg-red-600 text-white @else   dark:bg-gray-900 border  bg-white  border-gray-200 dark:border-gray-800  rounded-lg p-4  w-full  @endif ">
            <div class="flex justify-between items-center w-full">
                <div class="flex items-center">
        ...
        <div class="metric-card @if($this->selected==40) rounded-lg p-4  bg-red-600 text-white @else   dark:bg-gray-900 border  bg-white  border-gray-200 dark:border-gray-800  rounded-lg p-4   w-full @endif ">
        ...
        <div class="metric-card  @if($this->selected==50) rounded-lg p-4  bg-red-600 text-white @else   dark:bg-gray-900 border  bg-white  border-gray-200 dark:border-gray-800  rounded-lg p-4   w-full @endif ">
