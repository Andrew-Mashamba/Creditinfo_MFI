...
<div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all max-w-4xl ">
            ...
            <div class="bg-gradient-to-r from-red-900 to-red-700 px-6 py-4">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0 w-8 h-8 rounded-full {{ $currentStep >= 1 ? 'bg-white text-red-900' : 'bg-red-800 text-white' }} flex items-center justify-center text-sm font-medium">
                                    1
                                </div>
                            ...
                            <!-- Step 2 -->
                            <div class="flex items-center">
                                <div class="flex-shrink-0 w-8 h-8 rounded-full {{ $currentStep >= 2 ? 'bg-white text-red-900' : 'bg-red-800 text-white' }} flex items-center justify-center text-sm font-medium">
                                    2
                                </div>
                            ...
                            <!-- Step 3 -->
                            <div class="flex items-center">
                                <div class="flex-shrink-0 w-8 h-8 rounded-full {{ $currentStep >= 3 ? 'bg-white text-red-900' : 'bg-red-800 text-white' }} flex items-center justify-center text-sm font-medium">
                                    3
                                </div>
            ...
            <div class="px-6 py-4">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="space-y-4">
                            <!-- Petty Cash Option -->
                            <label class="relative flex cursor-pointer rounded-lg border border-gray-300 p-4 focus:outline-none {{ $fundingSource === 'petty_cash' ? 'ring-2 ring-red-500 border-transparent bg-red-50' : 'hover:bg-gray-50' }}">
                            ...
                            <!-- Bank Account Option -->
                            <label class="relative flex cursor-pointer rounded-lg border border-gray-300 p-4 focus:outline-none {{ $fundingSource === 'bank_account' ? 'ring-2 ring-red-500 border-transparent bg-red-50' : 'hover:bg-gray-50' }}">
                        ...
                        <div class="mt-4">
                            ...
                            <select wire:model="selectedBankAccount" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="space-y-4">
                            <!-- Cash Payment -->
                            <label class="relative flex cursor-pointer rounded-lg border border-gray-300 p-4 focus:outline-none {{ $paymentMethod === 'cash' ? 'ring-2 ring-red-500 border-transparent bg-red-50' : 'hover:bg-gray-50' }}">
                            ...
                            <!-- Bank Transfer -->
                            <label class="relative flex cursor-pointer rounded-lg border border-gray-300 p-4 focus:outline-none {{ $paymentMethod === 'bank_transfer' ? 'ring-2 ring-red-500 border-transparent bg-red-50' : 'hover:bg-gray-50' }}">
                            ...
                            <!-- Mobile Money -->
                            <label class="relative flex cursor-pointer rounded-lg border border-gray-300 p-4 focus:outline-none {{ $paymentMethod === 'mobile_money' ? 'ring-2 ring-red-500 border-transparent bg-red-50' : 'hover:bg-gray-50' }}">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" wire:model="accountHolderName" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500" placeholder="Enter recipient name">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Account Number</label>
                            <input type="text" wire:model="recipientAccountNumber" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500" placeholder="Enter account number">
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Destination Bank</label>
                            <select wire:model="recipientBankCode" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" wire:model="phoneNumber" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500" placeholder="255XXXXXXXXX">
                        ...
                        <div>
                            ...
                            <select wire:model="mnoProvider" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                    ...
                    <div>
                        ...
                        <textarea wire:model="paymentNotes" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500"></textarea>
                    </div>

                    <!-- Payment Summary -->
                    <div class="bg-red-50 rounded-lg p-4">
                        <h5 class="font-medium text-red-900 mb-2">Payment Summary</h5>
