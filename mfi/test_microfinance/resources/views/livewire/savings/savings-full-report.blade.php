<div class="min-h-screen bg-gray-50 p-6">
        ...
        <div class="bg-gradient-to-r from-red-900 to-red-700 rounded-lg shadow-lg p-6 text-white">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-red-100">Comprehensive savings analysis and member deposit tracking</p>
                </div>
                <div class="text-right">
                    <p class="text-sm text-red-100">Report Period</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
            ...
            <div class="lg:col-span-6">
                <label class="block text-sm font-medium text-gray-700 mb-2">
                    <i class="fas fa-search mr-2 text-red-600"></i>Quick Search
                </label>
                <input type="text"
    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6">
        <div class="flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <button wire:click="applyDatePreset('today')" class="px-3 py-1.5 text-xs font-medium rounded-full {{ $datePreset === 'today' ? 'bg-red-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }} transition-colors">
                    Today
                </button>
                <button wire:click="applyDatePreset('yesterday')" class="px-3 py-1.5 text-xs font-medium rounded-full {{ $datePreset === 'yesterday' ? 'bg-red-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }} transition-colors">
                    Yesterday
                </button>
                <button wire:click="applyDatePreset('this_week')" class="px-3 py-1.5 text-xs font-medium rounded-full {{ $datePreset === 'this_week' ? 'bg-red-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }} transition-colors">
                    This Week
                </button>
                <button wire:click="applyDatePreset('this_month')" class="px-3 py-1.5 text-xs font-medium rounded-full {{ $datePreset === 'this_month' ? 'bg-red-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }} transition-colors">
                    This Month
                </button>
                <button wire:click="applyDatePreset('last_month')" class="px-3 py-1.5 text-xs font-medium rounded-full {{ $datePreset === 'last_month' ? 'bg-red-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }} transition-colors">
                    Last Month
                </button>
                <button wire:click="applyDatePreset('this_quarter')" class="px-3 py-1.5 text-xs font-medium rounded-full {{ $datePreset === 'this_quarter' ? 'bg-red-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }} transition-colors">
                    This Quarter
                </button>
                <button wire:click="applyDatePreset('this_year')" class="px-3 py-1.5 text-xs font-medium rounded-full {{ $datePreset === 'this_year' ? 'bg-red-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }} transition-colors">
                    This Year
                </button>
                <button wire:click="applyDatePreset('last_30_days')" class="px-3 py-1.5 text-xs font-medium rounded-full {{ $datePreset === 'last_30_days' ? 'bg-red-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }} transition-colors">
                    Last 30 Days
                </button>
            </div>
    ...
    @if(isset($summaryStatistics) && $summaryStatistics !== null)
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            <div class="bg-gradient-to-br from-red-50 to-red-100 p-6 rounded-lg border-l-4 border-red-600 shadow-md hover:shadow-lg transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-red-700 uppercase">Total Members</p>
        ...
        @if($showAdvancedFilters)
            <div class="border-t border-gray-200 p-6">
                ...
                <div>
                    ...
                    <select wire:model="selectedBranch" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                ...
                <div>
                    ...
                    <select wire:model="selectedMember" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                ...
                <div>
                    ...
                    <select wire:model="selectedProduct" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                ...
                <div>
                    ...
                    <select wire:model="statusFilter" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="date" wire:model="dateFrom" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                </div>
                ...
                <div>
                    ...
                    <input type="date" wire:model="dateTo" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                </div>
                ...
                <div>
                    ...
                    <select wire:model="reportType" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
            ...
            <div class="flex justify-between items-center pt-4 border-t border-gray-200">
                ...
                <div class="text-sm text-gray-600">
                    ...
                    <select wire:model="perPage" class="ml-2 px-3 py-1 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500">
    ...
    @if($isLoading || $isExporting)
        <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 shadow">
            <div class="flex items-center">
                <i class="fas fa-spinner fa-spin text-red-600 text-xl mr-3"></i>
