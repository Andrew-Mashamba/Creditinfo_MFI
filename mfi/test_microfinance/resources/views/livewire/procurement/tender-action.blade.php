<div class="flex space-x-1 justify-around">
    ...
    {{--            }--}}
    {{--        </style>--}}
    {{--        <button wire:click="assign({{$id}})" type="button" class="hoverable text-white bg-gray-100 hover:bg-red-100 hover:text-red focus:ring-4 focus:outline-none focus:ring-red-100 font-medium rounded-lg text-sm p-1 text-center inline-flex items-center mr-2 dark:bg-red-200 dark:hover:bg-red-200 dark:focus:ring-red-200">--}}
    ...
    <button wire:click="edit({{$id}})" class="p-1 text-red-600 hover:bg-red-600 hover:bg-red-200 rounded">
