        ...
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400 w-full">
            <div class=" flex space-x-4 w-1/3">
                <li class="mr-2 gap-2" wire:click="setView(1)">
                    <a href="#" class="inline-flex p-2   text-base  @if($selected == 1) text-red-400   border-b-2 border-red-600
                    active dark:text-red-400 dark:border-red-500 @else border-transparent hover:text-gray-600
                    hover:border-gray-300 dark:hover:text-gray-300 @endif rounded-t-lg
                      group" @if($selected == 1) aria-current="page" @endif>
                        <svg aria-hidden="true" class="w-6 h-6 mr-2 mx-2 @if($selected == 1) text-red-600 dark:text-red-500
...
{{--                             0010 11z" clip-rule="evenodd"></path>--}}
            ...
            <div class=" flex space-x-4 w-1/3">
                <li class="mr-2" wire:click="setView(2)">
                    <a href="#" class="inline-flex p-2 text-base  @if($selected == 2)   text-red-400  border-b-2 border-red-600
                    active dark:text-red-400 dark:border-red-500 @else border-transparent hover:text-gray-600
                    hover:border-gray-300 dark:hover:text-gray-300 @endif rounded-t-lg
                      group" @if($selected == 2) aria-current="page" @endif >
                        <svg aria-hidden="true" class="w-6 h-6 mr-2 @if($selected == 2) text-red-600 dark:text-red-500
                        @else text-gray-400 group-hover:text-gray-500
            ...
            <div class=" flex space-x-4 w-1/3">
                <li class="mr-2" wire:click="setView(3)">
                    <a href="#" class="inline-flex p-2 text-base @if($selected == 3) text-red-400 border-b-2 border-red-600
                    ...
                    hover:border-gray-300 dark:hover:text-gray-300 @endif rounded-t-lg
                      group" @if($selected == 3) aria-current="page" @endif >
                        <svg aria-hidden="true" class="w-6 h-6 mr-2 @if($selected == 3) text-red-600 dark:text-red-500
                        @else text-gray-400 group-hover:text-gray-500
                        dark:text-gray-500 dark:group-hover:text-gray-300 @endif "
                             fill="none" stroke="#60A5FA" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="mt-2">
            ...
            @if($this->viewPoBoolean)
                    <div class="flex justify-between bg-red-100 rounded-lg text-white p-2 ">
                       <div class="float-right flex">
                        <button type="button" class="rounded-full  flex justify-end item-end bg-white p-1 text-gray-400 hover:text-red-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                    ...
                    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" wire:model="vendorId"  value="{{$vendor->id}}"
                                           class="
                                mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500"
                                    >
                        ...
                        @enderror
                            ...
                            <input type="date" wire:model="endDate"
                                   class="
                                w-full mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500"
                            >
                        ...
                        <div class="flex items-center bg-gray-200 justify-end py-2 sm:px-6 sm:rounded-bl-lg sm:rounded-br-lg">
                            ...
                            <button type="submit" wire:click="approve" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-red-400 border border-transparent rounded-md  focus-visible:ring-2 focus-visible:ring-offset-2 ">
                                Proceed
                            </button>
