                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex space-x-4 mt-2">
                            <div class="flex items-center space-x-1">
                                ...
                                <span class="text-xs font-medium text-red-900">{{$currentClient->member_number}}</span>
                            </div>
                            <div class="flex items-center space-x-1">
                                <span class="text-xs text-gray-600">Status:</span>
                                <span class="text-xs font-medium text-red-900">Active</span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        @foreach($loans as $loan)
                                            <tr class="border-b">
                                                ...
                                                <td class="px-2 py-1 text-right font-semibold text-red-900 border-r border-gray-200">
