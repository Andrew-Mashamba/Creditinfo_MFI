                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button wire:click="close" 
                            class="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-gray-800 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
...
<ol class="flex justify-between items-center w-full relative z-10 px-4 mt-4">
    ...
    class="inline-block p-4 border-b-2 transition-all duration-200
        @if($status === 'active') text-red-900 border-red-900
    ...
    {{ $tabConfig['label'] }}
                    ...
                    <li class="me-2" role="presentation">
                        <button wire:click="showTab('creditScore')"
                            class="inline-block p-4 border-b-2 transition-all duration-200
                                @if($activeTab === 'creditScore') text-red-900 border-red-900
                                @else text-gray-500 border-transparent hover:text-gray-600 hover:border-gray-300 @endif"
                            role="tab" 
                    ...
                    <li class="me-2" role="presentation">
                        <button wire:click="showTab('lendingFramework')"
                            class="inline-block p-4 border-b-2 transition-all duration-200
                                @if($activeTab === 'lendingFramework') text-red-900 border-red-900
                                @else text-gray-500 border-transparent hover:text-gray-600 hover:border-gray-300 @endif"
                            role="tab" 
                    ...
                    <li class="me-2" role="presentation">
                        <button wire:click="showTab('approvals')"
                            class="inline-block p-4 border-b-2 transition-all duration-200
                                @if($activeTab === 'approvals') text-red-900 border-red-900
                                @else text-gray-500 border-transparent hover:text-gray-600 hover:border-gray-300 @endif"
                            role="tab" 
