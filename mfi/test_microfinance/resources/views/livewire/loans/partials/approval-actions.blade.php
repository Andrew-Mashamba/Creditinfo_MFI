        ...
        <div class="ml-3 flex-1">
                    ...
                    <div class="mt-4 flex space-x-3">
                        <button wire:click="clearExceptions" 
                            class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed"
                    ...
                    <div class="mt-4 bg-white rounded-lg p-4 border border-gray-200">
                        ...
                        <textarea wire:model.debounce.500ms="approvalComment"
                            rows="3"
                        ...
                        @elseif($currentStage === 'Approver')
                            ...
                            @if($loan->status === 'APPROVED' && $loan->disbursement_status !== 'DISBURSED')
                                ...
                                <div class="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                                    <h4 class="text-sm font-semibold text-red-900 mb-3">Disbursement Information</h4>
                                    
                                    {{-- Disbursement Summary --}}
                                    <div class="grid grid-cols-2 gap-4 mb-3 text-sm">
                                        <div>
                                            <span class="text-red-600">Approved Amount:</span>
                                            <span class="font-semibold text-red-900 ml-2">{{ number_format($loan->approved_loan_value ?? 0, 2) }} TZS</span>
                                        </div>
                                        <div>
                                        ...
                                        <div class="col-span-2 border-t border-red-200 pt-2">
                                            <span class="text-red-700 font-semibold">Net Disbursement:</span>
                                    ...
                                    <div class="mb-3">
                                        <label class="block text-sm font-medium text-red-700 mb-1">Select Disbursement Account</label>
                                ...
                                <button wire:click="disburseLoan" 
                                    class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all
                                           {{ $canDisburse ? 'bg-red-600 hover:bg-red-800 focus:ring-red-500' : 'bg-gray-400 cursor-not-allowed' }}"
