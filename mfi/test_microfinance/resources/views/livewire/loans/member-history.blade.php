...
{{--                        @endif--}}
             ...
             @if($this->selectPaymentSchedule==false)
                 <div class="flex space-x-4">
                     <tr>
                         <td>
                             <button   wire:click="Installment" class="inline-flex @if($this->selectPaymentSchedule==false) bg-customPurple text-white @endif items-center px-4 py-2 text-sm font-medium text-gray-900  border border-gray-900 rounded-l-lg hover:bg-customPurple hover:text-white focus:z-0 focus:ring-2 focus:ring-red-500 focus:bg-red-600 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-red-700 dark:focus:bg-red-700">
                         ...
                         <td>
                             <button  wire:click="LoanRepayment" class="inline-flex @if($this->selectPaymentSchedule) bg-customPurple text-white @endif items-center px-4 py-2 text-sm font-medium text-gray-900 bg-transparent border border-gray-900 rounded-r-md hover:bg-customPurple hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:bg-gray-700">
                                 <svg class="w-3 h-3 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
{{--                             </button>--}}
                        ...
                        <table class="w-full text-xs border border-gray-200">
                            ...
                            <tr>
                                <th scope="col" class="px-2 py-1 text-left border-b border-r border-gray-200">
                                    Installment
                                </th>
                                <th scope="col" class="px-2 py-1 text-right border-b border-r border-gray-200">
                                    Interest
                                </th>
                                <th scope="col" class="px-2 py-1 text-right border-b border-r border-gray-200">
                                    Principle
                            ...
                            <tr class="border-b">
                                <td class="px-2 py-1 border-r border-gray-200 font-semibold text-red-900">
                        ...
                        <!-- Summary Table -->
                        <table class="w-full text-xs border border-gray-200 mt-4">
                            <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="px-2 py-1 text-right border-b border-r border-gray-200"> TOTAL INSTALLMENT </th>
                                <th scope="col" class="px-2 py-1 text-right border-b border-r border-gray-200"> TOTAL INTEREST </th>
                                <th scope="col" class="px-2 py-1 text-right border-b border-r border-gray-200"> TOTAL PRINCIPLE </th>
                                <th scope="col" class="px-2 py-1 text-right border-b border-r border-gray-200"> TOTAL PENALTIES </th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr class="bg-gray-50 font-semibold">
                              <td class="px-2 py-1 text-right border-r border-gray-200 font-semibold text-red-900"> {{round( $this->totalInstallment,2)}} TZS</td>
                              <td class="px-2 py-1 text-right border-r border-gray-200 font-semibold text-red-900"> {{round( $this->totalinterest,2)}} TZS </td>
                              <td class="px-2 py-1 text-right border-r border-gray-200 font-semibold text-red-900"> {{round( $this->totalPrinciple,2)}} TZS  </td>
                              <td class="px-2 py-1 text-right border-gray-200 font-semibold text-red-900"> {{round( $this->totalPenalties,2)}} TZS  </td>
                            </tr>
                            </tbody>
                        </table>
                            </tbody>
             ...
             @else
                 <div class="flex space-x-4">
                     <tr>
                         <td> <button   wire:click="Installment" class="inline-flex @if($this->selectPaymentSchedule==false) bg-customPurple text-white @endif items-center px-4 py-2 text-sm font-medium text-gray-900 bg-transparent border border-gray-900 rounded-l-lg hover:bg-customPurple hover:text-white focus:z-10 focus:ring-2 focus:ring-red-500 focus:bg-red-600 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-red-700 dark:focus:bg-red-700">
                                 <svg class="w-3 h-3 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                     <path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm0 5a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm0 13a8.949 8.949 0 0 1-4.951-1.488A3.987 3.987 0 0 1 9 13h2a3.987 3.987 0 0 1 3.951 3.512A8.949 8.949 0 0 1 10 18Z"/>
                                 </svg>
                                 Installment
                             </button> </td>
                         <td>                 <button  wire:click="LoanRepayment" class="inline-flex @if($this->selectPaymentSchedule) bg-customPurple text-white @endif items-center px-4 py-2 text-sm font-medium text-gray-900  border border-gray-900 rounded-r-md hover:bg-customPurple hover:text-white focus:z-0 focus:ring-2 focus:ring-gray-500 focus:bg-red-600 focus:text-white dark:border-white dark:text-white dark:hover:text-white  dark:focus:bg-gray-700">
                                 <svg class="w-3 h-3 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                     <path d="M14.707 7.793a1 1 0 0 0-1.414 0L11 10.086V1.5a1 1 0 0 0-2 0v8.586L6.707 7.793a1 1 0 1 0-1.414 1.414l4 4a1 1 0 0 0 1.416 0l4-4a1 1 0 0 0-.002-1.414Z"/>
                                     <path d="M18 12h-2.55l-2.975 2.975a3.5 3.5 0 0 1-4.95 0L4.55 12H2a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2Zm-3 5a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"/>
                                 </svg>
