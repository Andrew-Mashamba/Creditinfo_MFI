...
<div class="mt-4">
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4">
        ...
        <div class="bg-red-50 p-3 rounded-lg border border-red-200">
            <div class="space-y-2">
                <div class="flex justify-between items-center">
                    <span class="text-sm text-red-700">New Loan Principle:</span>
                    <span class="font-medium text-red-900">{{ number_format($currentLoan->principle ?? 0, 2) }} TZS</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-red-700">Outstanding Balance:</span>
                ...
                <div class="flex justify-between items-center border-t border-red-200 pt-2">
                    <span class="text-sm font-semibold text-red-800">Net Disbursement:</span>
