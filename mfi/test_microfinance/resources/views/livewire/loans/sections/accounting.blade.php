<div class="space-y-4">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
        ...
        <div class="mb-3 p-3 {{ $isTopUpLoan ? 'bg-gradient-to-r from-red-50 to-purple-50 border-2 border-red-400' : 'bg-gradient-to-r from-gray-50 to-red-50 border border-gray-300' }} rounded-lg">
            @if($isTopUpLoan)
            <div class="mb-2 flex items-center text-red-700 font-semibold text-xs">
            ...
            <div class="grid grid-cols-1 md:grid-cols-{{ $isTopUpLoan && $topUpAmount > 0 ? '5' : '4' }} gap-2 text-xs">
                ...
                <div class="bg-red-100 rounded px-2 py-1">
                    <div class="text-red-800 font-semibold">Top-up Payment (CR)</div>
                    <div class="text-red-900 font-bold text-sm">{{ number_format($topUpAmount, 2) }} TZS</div>
                </div>
                @endif
                <div>
                    <div class="text-gray-600 font-medium">Selected Bank</div>
                    <div class="text-red-900 font-mono text-xs">{{ $selectedBankMirror }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-xs">
                ...
                <tbody>
                    ...
                    <tr class="border-b transition-all {{ isset($entry['issue']) && $entry['issue'] ? 'bg-red-50 hover:bg-red-100 animate-pulse' : (isset($entry['highlight']) && $entry['highlight'] ? 'bg-red-50 hover:bg-red-100 border-l-4 border-red-500' : 'hover:bg-gray-50') }}">
        ...
        <div class="mt-3 flex justify-between items-center">
            ...
            <div class="flex gap-2">
                ...
                <button wire:click="saveAccountConfiguration" 
                        ...
                        class="px-3 py-1 bg-red-600 text-white text-xs rounded hover:bg-red-700 inline-flex items-center">
        ...
        <div class="mt-4 p-3 bg-red-50 border border-red-200 rounded">
            ...
            <div class="text-xs space-y-1">
                ...
                <div class="ml-12 text-red-700 font-semibold">→ Payment to settle/reduce original loan balance</div>
                ...
                <div class="mt-2 pt-2 border-t border-red-300"><strong>Summary:</strong></div>
