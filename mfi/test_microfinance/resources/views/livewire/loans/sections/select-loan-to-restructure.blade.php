    ...
    <div class="w-full bg-white rounded-lg shadow-sm p-4">
        ...
        <div class="space-y-4 mb-6">
            ...
            <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors 
                @if($selectedLoan == $activeLoan['id']) border-red-300 bg-red-50 @endif">
                ...
                <div class="bg-red-50 p-3 rounded border border-red-200">
                    <h5 class="text-xs font-semibold text-red-900 mb-2">Restructuring Benefits:</h5>
                    <div class="grid grid-cols-2 gap-4 text-xs">
                        <div class="flex justify-between">
                            <span class="text-red-700">Interest Savings:</span>
                            <span class="font-semibold text-green-600">{{ number_format($activeLoan['interest_savings'] ?? 0, 2) }} TZS</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-red-700">Penalty Savings:</span>
                            <span class="font-semibold text-green-600">{{ number_format($activeLoan['penalty_savings'] ?? 0, 2) }} TZS</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-red-700">New Monthly Payment:</span>
                            <span class="font-semibold text-red-600">{{ number_format($activeLoan['new_monthly_payment'] ?? 0, 2) }} TZS</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-red-700">Payment Reduction:</span>
