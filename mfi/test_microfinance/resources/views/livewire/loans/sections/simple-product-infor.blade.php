                ...
                <table class="w-full text-xs border border-gray-200">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-2 py-1 font-semibold text-red-900">{{ number_format($productLoanLimits['max_amount'] ?? 0, 2) }} TZS</td>
                        </tr>
                        <tr class="border-b">
                            <td class="px-2 py-1 border-r border-gray-200">Maximum Tenor (months)</td>
                            <td class="px-2 py-1 font-semibold text-red-900">{{ $productLoanLimits['max_term'] ?? 0 }}</td>
                        </tr>
                        <tr class="border-b">
                            <td class="px-2 py-1 border-r border-gray-200">Debt Service Ratio (DSR)</td>
                            <td class="px-2 py-1 font-semibold text-red-900">{{ $productLoanLimits['ltv'] ?? 0 }}%</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
        ...
        <div>
            ...
            <div class="space-y-1">
                ...
                <div class="flex items-center text-xs p-2 border border-gray-200 rounded">
                    <span class="w-1.5 h-1.5 rounded-full mr-2 bg-red-600"></span>
