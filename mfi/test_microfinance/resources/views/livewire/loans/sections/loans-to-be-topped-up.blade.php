...
<div id="topup" class="w-full bg-gray-50 rounded-lg shadow-sm p-1 mb-4">
    ...
    <div class="w-full bg-white rounded-lg shadow-sm p-4">
        ...
        <div class="mb-6 p-4 bg-gradient-to-r from-red-50 to-cyan-50 rounded-lg border border-red-200">
            <div class="flex items-center justify-between mb-3">
                <h3 class="text-lg font-semibold text-red-900">Loan Performance Summary</h3>
            ...
            <div class="grid grid-cols-4 gap-3 text-center">
                <div class="bg-white p-2 rounded-lg border border-red-200">
                    <div class="text-lg font-bold text-red-900">{{ $paidInstallments }}/{{ $totalInstallments }}</div>
                    <div class="text-xs text-red-600">Installments Paid</div>
                </div>
                <div class="bg-white p-2 rounded-lg border border-red-200">
                    <div class="text-lg font-bold text-red-900">{{ $remainingInstallments }}</div>
                    <div class="text-xs text-red-600">Remaining Term</div>
                </div>
                <div class="bg-white p-2 rounded-lg border border-red-200">
                    <div class="text-lg font-bold text-red-900">{{ number_format($monthlyPayment, 2) }}</div>
                    <div class="text-xs text-red-600">Monthly Payment (TZS)</div>
                </div>
                <div class="bg-white p-2 rounded-lg border border-red-200">
                    <div class="text-lg font-bold text-red-900">{{ $topupLoan->tenure ?? 0 }}</div>
                    <div class="text-xs text-red-600">Original Term (Months)</div>
                </div>
            </div>
        </div>
