...
<div id="stability" class="w-full bg-gray-50 rounded rounded-lg shadow-sm p-1 mb-4">
    ...
    <div class="w-full bg-white rounded rounded-lg shadow-sm p-2">
        ...
        <div class="mb-6 p-4 bg-gradient-to-r from-red-50 to-indigo-50 rounded-lg border border-red-200">
            <div class="flex items-center justify-between mb-3">
                <h3 class="text-lg font-semibold text-red-900">Settlement Summary</h3>
                <div class="flex items-center space-x-2">
                    ...
                    <button wire:click="$set('showSettlementForm', true)"
                        class="px-3 py-1 text-xs font-medium text-white bg-red-600 rounded-lg hover:bg-red-600 focus:ring-2 focus:ring-red-500 transition-colors">
                        + Add Settlement
                    </button>
                </div>
            </div>
            ...
            <div class="grid grid-cols-4 gap-4 text-center">
                <div class="bg-white p-3 rounded-lg border border-red-200">
                    <div class="text-2xl font-bold text-red-900">{{ $summary['settlement_count'] }}</div>
                    <div class="text-xs text-red-600">Total Settlements</div>
                </div>
                <div class="bg-white p-3 rounded-lg border border-red-200">
        ...
        <div class="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input wire:model="settlementForm.institution" type="text"
                        class="w-full p-3 text-sm border border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500 transition-colors"
                ...
                <div>
                    ...
                    <input wire:model="settlementForm.amount" type="number" step="0.01" min="0"
                        class="w-full p-3 text-sm border border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500"
                        placeholder="0.00" />
            ...
            <div class="flex justify-end space-x-3 mt-4">
                ...
                <button wire:click="updateSettlement"
                    class="px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-600 focus:ring-2 focus:ring-red-500">
                    Update Settlement
                </button>
                @else
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex-shrink-0">
                                <div class="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center">
                                    <span class="text-red-600 font-semibold">{{ $settlement['id'] }}</span>
                                </div>
                            </div>
                            <div class="flex-1">
                                <div class="flex items-center space-x-4">
        ...
        <div class="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div class="flex space-x-3">
                <button wire:click="addSettlement" 
                    class="px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
        ...
        <div class="text-center py-8">
            ...
            <button wire:click="$set('showSettlementForm', true)" 
                class="mt-4 px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                </svg>
