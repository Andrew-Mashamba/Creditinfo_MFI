        ...
        <div>
            ...
            <div class="grid grid-cols-4 gap-2 text-xs">
                <div class="p-2 border border-gray-200 rounded">
                    ...
                    <div class="font-semibold text-red-900">{{ count($schedule) }}</div>
                </div>
                <div class="p-2 border border-gray-200 rounded">
                ...
                <div class="p-2 border border-gray-200 rounded">
                    ...
                    <div class="font-semibold text-red-900">{{ number_format($footer['total_interest'] ?? 0, 2) }} TZS</div>
                </div>
                <div class="p-2 border border-gray-200 rounded">
                    <div class="text-gray-600">Total Repayment</div>
                    <div class="font-semibold text-red-900">{{ number_format($footer['total_payment'] ?? 0, 2) }} TZS</div>
                </div>
            </div>
        </div>
            ...
            <table class="w-full text-xs border border-gray-200">
                ...
                <tbody>
                    ...
                    <tr class="border-b {{ $isOverdue ? 'bg-red-50' : ($isCurrent ? 'bg-yellow-50' : '') }}">
                        ...
                        <td class="px-2 py-1 text-right border-r border-gray-200 font-semibold text-red-900">{{ number_format((float)($installment['opening_balance'] ?? 0), 2) }}</td>
                        <td class="px-2 py-1 text-right border-r border-gray-200 font-semibold text-red-900">{{ number_format((float)($installment['payment'] ?? 0), 2) }}</td>
                        <td class="px-2 py-1 text-right border-r border-gray-200 font-semibold text-red-900">{{ number_format((float)($installment['principal'] ?? 0), 2) }}</td>
                        <td class="px-2 py-1 text-right border-r border-gray-200 font-semibold text-red-900">{{ number_format((float)($installment['interest'] ?? 0), 2) }}</td>
                        <td class="px-2 py-1 text-right font-semibold text-red-900">{{ number_format((float)($installment['closing_balance'] ?? 0), 2) }}</td>
                    </tr>
                    @empty
                    <tr>
                ...
                <tfoot>
                    <tr class="bg-gray-50 font-semibold border-t-2 border-gray-300">
                        ...
                        <td class="px-2 py-1 text-right border-r border-gray-200 font-semibold text-red-900">{{ number_format((float)($footer['total_payment'] ?? 0), 2) }}</td>
                        <td class="px-2 py-1 text-right border-r border-gray-200 font-semibold text-red-900">{{ number_format((float)($footer['total_principal'] ?? 0), 2) }}</td>
                        <td class="px-2 py-1 text-right border-r border-gray-200 font-semibold text-red-900">{{ number_format((float)($footer['total_interest'] ?? 0), 2) }}</td>
                        <td class="px-2 py-1 text-right font-semibold text-red-900">{{ number_format((float)($footer['final_closing_balance'] ?? 0), 2) }}</td>
                    </tr>
                </tfoot>
                @endif
            </table>
