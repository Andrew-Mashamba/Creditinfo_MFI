    ...
    <div>
        ...
        <div class="grid grid-cols-2 gap-2 text-xs">
            <div class="p-2 border border-gray-200 rounded">
                ...
                <div class="font-semibold text-red-900">{{ $basicInfo['full_name'] ?? 'N/A' }}</div>
            </div>
            <div class="p-2 border border-gray-200 rounded">
                <div class="text-gray-600">Client Number</div>
                <div class="font-semibold text-red-900">{{ $basicInfo['client_number'] ?? 'N/A' }}</div>
            </div>
            <div class="p-2 border border-gray-200 rounded">
    ...
    <div>
        ...
        <div class="grid grid-cols-2 gap-2 text-xs">
            <div class="p-2 border border-gray-200 rounded">
                ...
                <div class="font-semibold text-red-900">{{ $contactInfo['phone_number'] ?? 'N/A' }}</div>
            </div>
            <div class="p-2 border border-gray-200 rounded">
                <div class="text-gray-600">Email</div>
                <div class="font-semibold text-red-900">{{ $contactInfo['email'] ?? 'N/A' }}</div>
            </div>
    ...
    <div>
        ...
        <div class="grid grid-cols-2 gap-2 text-xs">
            <div class="p-2 border border-gray-200 rounded">
                ...
                <div class="font-semibold text-red-900">{{ number_format($financialInfo['savings_balance'] ?? 0, 2) }} TZS</div>
            </div>
            <div class="p-2 border border-gray-200 rounded">
                <div class="text-gray-600">Shares</div>
                <div class="font-semibold text-red-900">{{ number_format($financialInfo['shares'] ?? 0, 2) }} TZS</div>
            </div>
            <div class="p-2 border border-gray-200 rounded">
            ...
            <div class="p-2 border border-gray-200 rounded">
                ...
                <div class="font-semibold text-red-900">{{ number_format($financialInfo['income_available'] ?? 0, 2) }} TZS</div>
            </div>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="grid grid-cols-2 gap-2 text-xs">
            ...
            <div class="p-2 border border-gray-200 rounded">
                ...
                <div class="font-semibold text-red-900">{{ number_format($employmentInfo['basic_salary'] ?? 0, 2) }} TZS</div>
            </div>
            @endif
            @if(($employmentInfo['annual_income'] ?? 0) > 0)
            <div class="p-2 border border-gray-200 rounded">
                <div class="text-gray-600">Annual Income</div>
                <div class="font-semibold text-red-900">{{ number_format($employmentInfo['annual_income'] ?? 0, 2) }} TZS</div>
            </div>
            @endif
        </div>
    </div>
