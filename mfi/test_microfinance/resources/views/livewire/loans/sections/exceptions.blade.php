...
<div id="stability" class="w-fullx bg-gray-50 rounded rounded-lg shadow-sm p-1 mb-4">
    <div class="w-full bg-white rounded rounded-lg shadow-sm p-2">
            ...
            <div class="border border-gray-200 rounded-lg p-3 
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-red-600 mt-1 font-medium">💡 {{ $exceptionData['loan_amount']['recommendation'] }}</p>
                        @endif
                    </div>
            ...
            <div class="border border-gray-200 rounded-lg p-3 
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-red-600 mt-1 font-medium">💡 {{ $exceptionData['term']['recommendation'] }}</p>
                        @endif
                    </div>
                    <div class="text-right">
                        <div class="text-xs text-gray-600">
            ...
            <div class="border border-gray-200 rounded-lg p-3 
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-red-600 mt-1 font-medium">💡 {{ $exceptionData['credit_score']['recommendation'] }}</p>
                        @endif
                    </div>
                    <div class="text-right">
                        <div class="text-xs text-gray-600">
            ...
            <div class="border border-gray-200 rounded-lg p-3 
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-red-600 mt-1 font-medium">💡 {{ $exceptionData['salary_installment']['recommendation'] }}</p>
                        @endif
                    </div>
                    <div class="text-right">
                        <div class="text-xs text-gray-600">
            ...
            <div class="border border-gray-200 rounded-lg p-3 
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-red-600 mt-1 font-medium">💡 {{ $exceptionData['collateral']['recommendation'] }}</p>
                        @endif
                    </div>
                    <div class="text-right">
                        <div class="text-xs text-gray-600">
        ...
        <div class="mt-6 pt-4 border-t border-gray-200">
            <div class="bg-gradient-to-r from-gray-50 to-red-50 p-6 rounded-xl border border-gray-200 shadow-sm">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 w-full">
                            <div class="bg-red-50 border border-red-200 rounded-lg p-4 flex-1">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-semibold text-red-800">⏳ Pending Approval</h4>
                                        <p class="text-xs text-red-600">Loan is awaiting approval from the approval team.</p>
                                    </div>
                                </div>
                            </div>
