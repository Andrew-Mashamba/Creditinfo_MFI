    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0 flex items-center space-x-3">
            ...
            <div class="relative">
                ...
                <input wire:model.debounce.300ms="search" type="text" placeholder="Search by loan ID, client name, amount..." class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm">
                @if($search)
                ...
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            <button wire:click="sortBy('loan_id')" class="flex items-center space-x-1 hover:text-red-600 focus:outline-none">
                                <span>Loan ID</span>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            <button wire:click="sortBy('principle')" class="flex items-center space-x-1 hover:text-red-600 focus:outline-none">
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            <button wire:click="sortBy('updated_at')" class="flex items-center space-x-1 hover:text-red-600 focus:outline-none">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    @if($loan->loan_type_2 == 'New') bg-red-100 text-red-800
