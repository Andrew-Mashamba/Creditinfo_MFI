    ...
    <div class="mb-6">
        <nav class="flex space-x-8 border-b border-gray-200">
            ...
            <button wire:click="setActiveTab('portal-settings')" 
                    ...
                    {{ $activeTab === 'portal-settings' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                Portal Settings
            </button>
            @else
            ...
            <button wire:click="setActiveTab('mobile-app')" 
                    class="py-2 px-1 border-b-2 font-medium text-sm transition-colors duration-200
                    {{ $activeTab === 'mobile-app' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                Mobile App
            </button>
            @else
            <span class="py-2 px-1 border-b-2 font-medium text-sm text-gray-400 cursor-not-allowed opacity-50" title="No permission to access this section">
            ...
            <button wire:click="setActiveTab('user-management')" 
                    class="py-2 px-1 border-b-2 font-medium text-sm transition-colors duration-200
                    {{ $activeTab === 'user-management' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                User Management
            </button>
            @else
            <span class="py-2 px-1 border-b-2 font-medium text-sm text-gray-400 cursor-not-allowed opacity-50" title="No permission to access this section">
            ...
            <button wire:click="setActiveTab('analytics')" 
                    class="py-2 px-1 border-b-2 font-medium text-sm transition-colors duration-200
                    {{ $activeTab === 'analytics' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                Analytics
            </button>
            @else
            <span class="py-2 px-1 border-b-2 font-medium text-sm text-gray-400 cursor-not-allowed opacity-50" title="No permission to access this section">
