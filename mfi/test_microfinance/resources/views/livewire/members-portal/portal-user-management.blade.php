<div class="p-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                ...
                <button wire:click="loadStatistics" 
                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                    <svg class="-ml-1 mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white shadow-sm rounded-lg border border-gray-200 mb-6">
        <div class="p-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input wire:model.debounce.300ms="search" id="search" type="text"
                            class="focus:ring-red-500 focus:border-red-500 block w-full pl-10 pr-3 sm:text-sm border-gray-300 rounded-md"
            ...
            <div class="mt-4 flex items-center justify-between p-3 bg-red-50 rounded-lg">
                <div class="flex items-center">
                ...
                <div class="flex space-x-2">
                    <button wire:click="deselectAllMembers" 
                        class="text-sm text-red-600 hover:text-red-800">Clear Selection</button>
                    <button wire:click="bulkEnablePortalAccess" 
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    <button wire:click="selectAllMembers" 
                        class="text-sm text-red-600 hover:text-red-800">Select All</button>
...
<script nonce="{{ csp_nonce() }}">
    ...
    function showNotification(type, message) {
        ...
        const bgColor = type === 'success' ? 'bg-green-500' : 
                       type === 'error' ? 'bg-red-500' : 'bg-red-500';
