    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Manage your MFI service subscriptions and billing</p>
            </div>
    ...
    <div class="mb-6">
        <nav class="flex space-x-8 border-b border-gray-200">
            ...
            <button wire:click="setActiveTab('usage')" 
                    class="py-2 px-1 border-b-2 font-medium text-sm transition-colors duration-200
                    {{ $activeTab === 'usage' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                Usage
            </button>
            @endif
        </nav>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center">
                                ...
                                @else
                                    <span class="ml-2 px-2 py-1 text-xs font-medium bg-red-100 text-red-800 rounded-full">Optional</span>
                                @endif
                            </div>
                            ...
                            @if($service['status'] === 'active' && $service['usage'])
                                <div class="mt-4">
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-red-600 h-2 rounded-full" style="width: {{ $service['usage']['percentage'] }}%"></div>
                                    </div>
                                    ...
                                    <div class="mt-3 grid grid-cols-2 gap-2 text-xs">
                                        ...
                                        <div class="bg-red-50 p-2 rounded">
                                            <p class="text-red-700 font-medium">Total</p>
                                            <p class="text-red-900 font-bold">{{ number_format($service['usage']['total']) }}</p>
                                        </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-red-50 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm text-red-600 font-medium">SMS Delivered</p>
                                <p class="text-2xl font-bold text-red-900">{{ number_format($usageStats['sms_sent_today']) }}</p>
