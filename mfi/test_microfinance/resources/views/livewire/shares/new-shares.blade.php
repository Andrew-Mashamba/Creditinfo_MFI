            ...
            <div class="flex items-stretch">
                ...
                <div class="w-1/2 mr-2" >
                    ...
                    <select wire:model.bounce="member" name="member" id="member" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                        ...
                        @foreach(App\Models\ClientsModel::where('institution_id',auth()->user()->institution_id)->get() as $members)
                    ...
                    @if($this->member)
                        ...
                        <table class="w-full">
                            ...
                            @foreach(App\Models\AccountsModel::where('member_number',$this->member)->where('category_code','3000')->get() as $account)
                                @php
                                ...
                                <tr>
                                    <td class="text-left">
                                        <p class="block text-sm font-medium text-red-500 dark:text-gray-400 capitalize">
                                            {{strtolower(App\Models\sub_products::where('sub_product_id',$account->sub_product_number)->where('institution_number',auth()->user()->institution_id)->value('sub_product_name')) }}
                                        </p>
                                    </td>
                    ...
                    <x-jet-input id="number_of_shares" type="number" name="number_of_shares" class="mt-1 block w-full" wire:model.bounce="number_of_shares" autofocus />
                    ...
                    @if($this->number_of_shares)
                        <div class="flex justify-between">
                            ...
                            <p class="block mb-2 text-sm font-medium text-red-500 dark:text-gray-400">{{number_format($this->number_of_shares * $this->nominal_price,2)}}</p>
                        </div>
                    ...
                    <select wire:model.bounce="linked_savings_account" name="linked_savings_account" id="linked_savings_account" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                        <option selected value="">Select</option>
            ...
            <div class="flex justify-end w-auto" >
                <div wire:loading.remove wire:target="save" >
                    <button wire:click="save" class="text-white bg-red-400 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-red-400 dark:hover:bg-red-400 dark:focus:ring-red-400">
                        <p class="text-white">Issue Shares</p>
                    </button>
