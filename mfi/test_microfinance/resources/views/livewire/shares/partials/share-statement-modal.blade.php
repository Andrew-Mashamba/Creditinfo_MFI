                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="mb-6">
                            ...
                            {{-- Opening Balance --}}
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3 bg-red-50 p-3 rounded-md">
                                <div>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-3 py-2 whitespace-nowrap text-sm">
                                                ...
                                                @elseif($transaction->type == 'TRANSFER_IN')
                                                    <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-red-100 text-red-800">Transfer In</span>
                            ...
                            <div class="bg-red-50 border-l-4 border-red-400 p-4 rounded">
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm text-red-700">No transactions found for this period.</p>
                                    </div>
                                </div>
                            </div>
                            @endif
