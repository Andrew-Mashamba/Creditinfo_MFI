        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                ...
                <button
                    ...
                    class="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors disabled:opacity-50"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="pt-2 mt-2 border-t border-gray-300">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="text-xs text-red-600">Market Value: TZS {{ number_format($statement['market_value'], 2) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        @foreach($consolidatedData['members'] as $member)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900">
                                    ...
                                    <span class="text-xs text-red-600 block">Market: {{ number_format($member['market_value'], 2) }}</span>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                    <tfoot class="bg-red-50">
                        <tr class="font-bold">
                            ...
                            <td class="px-6 py-4 text-right text-sm text-gray-900">
                                ...
                                <span class="text-xs text-red-600 block font-normal">Market: {{ number_format($consolidatedData['grand_totals']['market_value'], 2) }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
