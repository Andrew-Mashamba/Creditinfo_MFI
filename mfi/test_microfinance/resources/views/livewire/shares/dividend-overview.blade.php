    ...
    <div class="bg-white rounded-lg shadow mb-6">
        <div class="p-4 flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="flex gap-4">
                <select wire:model="yearFilter" class="px-4 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
                ...
                <select wire:model="statusFilter" class="px-4 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500">
            ...
            <div class="flex gap-4">
                <button wire:click="$set('showDeclareModal', true)" 
                    class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                    Declare Dividend
                </button>
