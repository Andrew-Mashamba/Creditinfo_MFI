    ...
    @else
        ...
        <div>
                        ...
                        <div class="flex w-full gap-4">
                            ...
                            <div  class="metric-card  dark:bg-gray-900 border @if($this->item == 0) bg-red-200 border-red-200 dark:border-red-800  @else bg-white  border-gray-200 dark:border-gray-800 @endif rounded-lg p-4 max-w-72 w-full" >
                            ...
                            @foreach(DB::table('sub_products')->where('product_id', '3000')->get() as $product)
                                ...
                                <div class="metric-card  dark:bg-gray-900 border @if($this->item == $product->id) bg-red-200 border-red-200 dark:border-red-800  @else bg-white  border-gray-200 dark:border-gray-800 @endif rounded-lg p-4 max-w-72 w-full" >
