        ...
        <div class="bg-white rounded-2xl shadow-md shadow-gray-200 w-full p-2 flex  items-center">
            ...
            @if (in_array(1, session()->get('permissions')))
                ...
                <div class="bg-white rounded-2xl shadow-md shadow-gray-200 h-20  flex items-center justify-center p-2 whitespace-nowrap lg:p-5">
                    ...
                    <!-- Add view button -->
                    <button wire:click="run" type="button" class="inline-flex items-center py-2 px-3 text-lg font-medium text-center text-white bg-gradient-to-br @if($this->disableProcess) bg-gray-400 @else bg-red-400 @endif  rounded-lg shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform"  >
            ...
            <div class="w-full border-b border-gray-200 dark:border-gray-700">
                <ul
                    ...
                    <li class="mr-2 nav-item grow cursor-pointer" role="presentation">
                        ...
                        {{$this->oneIsSetClicked ? "text-dark-shade border-darker-shade active dark:text-red-500
                        dark:border-red-500 " : "border-transparent hover:text-gray-600 hover:border-gray-300
                        ...
                        >
                            <svg class="w-5 h-5 mr-4 {{$this->oneIsSetClicked  ? " text-dark-shade dark:text-red-500"
                    ...
                    <li class="mr-2 nav-item grow cursor-pointer" role="presentation">
                        <a wire:click="changeTab(2)" id="tabs-profile-tabJustify" data-bs-toggle="pill"
                           ...
                           class="w-full self-center
                        {{$this->twoIsSetClicked ? "text-dark-shade border-darker-shade active dark:text-red-500
                        dark:border-red-500 " : "border-transparent hover:text-gray-600 hover:border-gray-300
                        dark:hover:text-gray-300 "}}
                        inline-flex p-4
                        rounded-t-lg
                        ...
                        group"
                           ...
                           style="display: flex; justify-content: center; align-items: center;"
                        >
                            <svg class="mr-2 w-5 h-5 {{$this->twoIsSetClicked  ? " text-dark-shade dark:text-red-500"
                            : "text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300"
                            }}" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z">
