<div>
    ...
    <div class="mb-4">CREATE A NEW NODE</div>
     ...
     <div>
         <div class="flex w-full gap-4">
             ...
             <div class="w-1/2">
                 <p for="DATASOURCETYPE" class="block mb-1 mt-2 text-sm capitalize text-slate-400 dark:text-white ml-2">DATA SOURCE</p>
                 <div class="flex justify-between w-full gap-4" id="DATASOURCETYPE">

                     <div class="flex items-center w-1/3 pl-4 ">
                         <input wire:model='DATASOURCETYPE' id="bordered-radio-1" type="radio" value="Portal" name="DATASOURCETYPE" class="clearerror w-4 h-4 text-red-600 bg-gray-100 border-gray-300 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" checked>
                         <p for="bordered-radio-1" class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Portal</p>
                     </div>
                     <div class="flex items-center w-1/3 pl-4 ">
                         <input checked wire:model='DATASOURCETYPE' id="bordered-radio-2" type="radio" value="Database" name="DATASOURCETYPE" class="clearerror w-4 h-4 text-red-600 bg-gray-100 border-gray-300 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                         <p for="bordered-radio-2" class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Database</p>
                     </div>
                     <div class="flex items-center w-1/3 pl-4 ">
                         <input wire:model='DATASOURCETYPE' id="bordered-radio-1" type="radio" value="API" name="DATASOURCETYPE" class="clearerror w-4 h-4 text-red-600 bg-gray-100 border-gray-300 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
