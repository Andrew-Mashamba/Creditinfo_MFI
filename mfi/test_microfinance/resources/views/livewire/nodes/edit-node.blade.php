    ...
    @endif
        ...
        <div class="bg-gray-100 rounded-lg shadow-sm p-2">
            ...
            <div class="pr-4 w-1/2 ">
                ...
                <select wire:model="nodeSelected" name="nodeSelected" id="nodeSelected" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
        ...
        @if($this->nodeSelected)
            ...
            <div class="flex w-full gap-4">
                <div class="w-1/2">
                    ...
                    <select wire:model.bounce="nodeType" name="nodeType" id="nodeType" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                        <option selected value="">Select Type</option>
                ...
                <div class="w-1/2">
                    ...
                    <div class="flex justify-between w-full gap-4" id="DATA_SOURCE_TYPE">
                        ...
                        <div class="flex items-center w-1/3 pl-4 ">
                            <input wire:model='DATA_SOURCE_TYPE' id="bordered-radio-1" type="radio" value="Portal" name="DATA_SOURCE_TYPE" class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" checked>
                            <p for="bordered-radio-1" class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Portal</p>
                        </div>
                        <div class="flex items-center w-1/3 pl-4 ">
                            <input checked wire:model='DATA_SOURCE_TYPE' id="bordered-radio-2" type="radio" value="Database" name="DATA_SOURCE_TYPE" class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <p for="bordered-radio-2" class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Database</p>
                        </div>
                        <div class="flex items-center w-1/3 pl-4 ">
                            <input wire:model='DATA_SOURCE_TYPE' id="bordered-radio-1" type="radio" value="API" name="DATA_SOURCE_TYPE" class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="flex w-full gap-4">
                <div class="w-1/2">
                    ...
                    <div class="" id="NODE_NAME">
                        <input id="NODE_NAME" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="NODE_NAME" autocomplete="NODE_NAME" />
                    ...
                    <div class="" id="DB_TABLE_REFERENCE">
                        <input id="DB_TABLE_REFERENCE" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_REFERENCE" autocomplete="DB_TABLE_REFERENCE" />
                    ...
                    <div class="" id="DB_TABLE_SECONDARY_REFERENCE">
                        <input id="DB_TABLE_SECONDARY_REFERENCE" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_SECONDARY_REFERENCE" autocomplete="DB_TABLE_SECONDARY_REFERENCE" />
                    </div>
                    ...
                    <div class="" id="DB_TABLE_DATE">
                        <input id="DB_TABLE_DATE" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_DATE" autocomplete="DB_TABLE_DATE" />
                    ...
                    <div class="" id="DB_TABLE_AMOUNT">
                        <input id="DB_TABLE_AMOUNT" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_AMOUNT" autocomplete="DB_TABLE_AMOUNT" />
                    ...
                    <div class="" id="DB_TABLE_SENDER">
                        <input id="DB_TABLE_SENDER" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_SENDER" autocomplete="DB_TABLE_SENDER" />
                    ...
                    <div class="" id="DB_TABLE_RECEIVER">
                        <input id="DB_TABLE_RECEIVER" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_RECEIVER" autocomplete="DB_TABLE_RECEIVER" />
                    ...
                    <div class="" id="DB_TABLE_DESCRIPTION">
                        <input id="DB_TABLE_DESCRIPTION" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_DESCRIPTION" autocomplete="DB_TABLE_DESCRIPTION" />
                    ...
                    <div class="" id="DB_TABLE_STATUS">
                        <input id="DB_TABLE_STATUS" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_STATUS" autocomplete="DB_TABLE_STATUS" />
                    ...
                    <div class="" id="DB_TABLE_SERVICE_IDENTIFIER">
                        <input id="DB_TABLE_SERVICE_IDENTIFIER" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_SERVICE_IDENTIFIER" autocomplete="DB_TABLE_SERVICE_IDENTIFIER" />
                ...
                <div class="w-1/2">
                    ...
                    <div class="" id="DB_TABLE_CLIENT_IDENTIFIER">
                        <input id="DB_TABLE_CLIENT_IDENTIFIER" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_CLIENT_IDENTIFIER" autocomplete="DB_TABLE_CLIENT_IDENTIFIER" />
                    ...
                    <div class="" id="DB_TABLE_TRANSACTION_TYPE">
                        <input id="DB_TABLE_TRANSACTION_TYPE" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_TRANSACTION_TYPE" autocomplete="DB_TABLE_TRANSACTION_TYPE" />
                    ...
                    @if($this->DATA_SOURCE_TYPE == 'API')
                        ...
                        <div id="DB_TABLE_API_PASSWORD">
                            <input  type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_API_PASSWORD" autocomplete="DB_TABLE_API_PASSWORD" />
                        ...
                        <div id="DB_TABLE_API_PRIVATE_KEY">
                            <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_API_PRIVATE_KEY" autocomplete="DB_TABLE_API_PRIVATE_KEY" />
                    ...
                    @if($this->DATA_SOURCE_TYPE == 'Database')
                        ...
                        <div id="NODE_DB_HOST">
                            <input  type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="NODE_DB_HOST" autocomplete="NODE_DB_HOST" />
                        ...
                        <div id="NODE_DB_PORT">
                            <input  type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="NODE_DB_PORT" autocomplete="NODE_DB_PORT" />
                        ...
                        <div id="NODE_DB_DATABASE">
                            <input  type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="NODE_DB_DATABASE" autocomplete="NODE_DB_DATABASE" />
                        ...
                        <div id="NODE_DB_USERNAME">
                            <input  type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="NODE_DB_USERNAME" autocomplete="NODE_DB_USERNAME" />
                        ...
                        <div id="NODE_DB_PASSWORD">
                            <input  type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="NODE_DB_PASSWORD" autocomplete="NODE_DB_PASSWORD" />
                        ...
                        <div id="DB_TABLE_NAME">
                            <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" wire:model.defer="DB_TABLE_NAME" autocomplete="DB_TABLE_NAME" />
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-end w-auto" >
                            <div wire:loading.remove wire:target="save" >
                                <button wire:click="save" class="px-4 py-2 text-sm font-medium text-white bg-red-400 rounded-lg hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-400 dark:hover:bg-red-400 dark:focus:ring-red-400">
                                    Save
                                </button>
