            ...
            <div class="bg-white rounded-lg shadow-sm p-4">
                <div class="flex w-full">
                    ...
                    <div class="pr-4 w-1/2 ">
                        <div CLASS="mb-4">DELETE A NODE</div>


                        <p for="nodeSelected" class="block mb-1 text-sm capitalize text-slate-400 dark:text-white ">SELECT NODE</p>
                        <select wire:model="nodeSelected" name="nodeSelected" id="nodeSelected" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                        ...
                        @if($this->nodeSelected)
                            ...
                            <p>Node selected: {{ App\Models\NodesList::where('ID', $this->nodeSelected)->value('NODE_NAME') }}</p>

                            </div>


                            <p for="nodeSelected" class="block mb-1 mt-4 text-sm capitalize text-slate-400 dark:text-white ">ENTER PASSWORD TO CONFIRM</p>
                            <input wire:model.defer="password" id="current_password" type="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" autocomplete="current-password" />
