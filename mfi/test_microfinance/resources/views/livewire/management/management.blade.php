<div>
    ...
    <div class="bg-white p-4 sm:p-6 overflow-hidden mb-2 rounded-lg">
        ...
        <div class="tab-pane fade " id="tabs-homeJustify"
            ...
            <div class="grid grid-cols-4 border-red-900 border-2 p-4 sm:grid-cols-4 md:grid-cols-4 gap-6 pb-4 bg-white rounded-xl  mt-4">
                 ...
                 <div>
                    ...
                    <div class="text-sm font-medium  border-b border-red-900  text-gray-500">{{number_format($tr['Payment'],2)}}
                    </div>
                 </div>

                 <div>

                    <div class="text-sm font-medium  border-b border-red-900  text-gray-500">{{number_format($tr['Interest'],2)}}
                    </div>
                 </div>

                 <div>

                    <div class="text-sm font-medium  border-b border-red-900  text-gray-500">{{number_format($tr['Principle'],2)}}
                    </div>
                 </div>

                 <div>
                    <div class="text-sm font-medium  border-b border-red-900  text-gray-500">{{number_format($tr['balance'],2)}}
                    </div>
                 </div>
             ...
             <div>
              <label for="membership_type"
                ...
                @enderror
                    ...
                    <textarea id="message" wire:model="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Write your thoughts here..."></textarea>
                    <button wire:click="Reject({{ $approver->id }}, '{{ session()->get('loan_table_id') }}')" type="button" class="text-white mt-2 bg-gradient-to-br from-red-600 to-red-700 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"> Reject </button>

                    @else
                    <button wire:click="RejectAction()" type="button" class="text-white bg-gradient-to-br from-red-600 to-red-700 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"> Reject </button>
                    <button  wire:click="Approve({{ $approver->id }}, '{{ session()->get('loan_table_id') }}')"  type="button" class="text-white mt-2  bg-gradient-to-r from-red-800 to-red-900 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"> Approve</button>
