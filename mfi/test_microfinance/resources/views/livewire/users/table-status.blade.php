<div class="pt-2">
    ...
    @endif
    @if($status == 'DELETED')
        <span class="bg-red-400 text-red-800 text-sm font-medium mr-2 p-2 rounded dark:bg-red-600 dark:text-red-300">{{$status}}</span>
    @endif
    @if($status == 'BLOCKED')
    ...
    @endif
        ...
        @endif
        @if($status == 'REJECTED')
            <span class="bg-red-100 text-red-800 text-sm font-medium mr-2 p-2 rounded dark:bg-red-600 dark:text-red-300">{{$status}}</span>
        @endif
