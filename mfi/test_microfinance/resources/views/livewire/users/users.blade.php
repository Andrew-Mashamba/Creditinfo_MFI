            ...
            <div class="flex items-center gap-3">
                ...
                @if($selectedUsers && count($selectedUsers) > 0)
                    <div class="flex items-center gap-2 bg-red-50 px-4 py-2 rounded-lg">
                        <span class="text-sm text-red-700">{{ count($selectedUsers) }} selected</span>
                        ...
                        <button wire:click="bulkDelete" class="text-xs bg-red-800 text-white px-3 py-1 rounded hover:bg-red-600">
                            Delete
                        </button>
                ...
                @endif
                <button wire:click="$set('showCreateUser', true)" class="inline-flex items-center px-6 py-3 rounded-xl shadow-lg text-base font-semibold text-white bg-red-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all">
        ...
        <div class="bg-white/90 rounded-2xl shadow-md p-6 mb-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-gray-200">
                <div class="text-center">
                    <div class="text-2xl font-bold text-red-600">{{ $totalUsers }}</div>
                            ...
                            <tr class="{{ $loop->even ? 'bg-slate-50' : 'bg-white' }} hover:bg-indigo-50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <!-- View Details -->
                                        <button wire:click="viewUser({{ $user->id }})" class="text-red-600 hover:text-red-900" title="View Details">
                        ...
                        <div class="flex items-center justify-between mb-6">
                            <div class="flex items-center gap-3 ">
                                ...
                                @for($i = 0; $i < $totalSteps; $i++)
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 flex items-center justify-center rounded-full font-bold text-lg transition-all duration-200 {{ $currentStep == $i ? 'bg-red-600 text-white shadow-lg' : ($currentStep > $i ? 'bg-green-500 text-white' : 'bg-gray-100 text-gray-400') }}">
                                            @if($currentStep > $i)
                    ...
                    <form wire:submit.prevent="saveUser" class="space-y-8">
                        ...
                        <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                            ...
                            <div class="flex gap-3">
                                @if($currentStep < ($userType === 'governance' ? 4 : 7))
                                    <button type="button" wire:click="nextStep" class="px-6 py-3 text-sm font-medium text-white bg-red-600 border border-transparent rounded-xl hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200 shadow-lg hover:shadow-xl">
                                        Next
                        ...
                        <div class="max-w-4xl mx-auto">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                <!-- Governance Card -->
                                <div class="group relative bg-white border-2 border-gray-200 rounded-2xl p-8 cursor-pointer hover:border-red-900 hover:shadow-xl transition-all duration-300 {{ $userType === 'governance' ? 'border-red-900 bg-red-600 shadow-xl' : '' }}" wire:click="$set('userType', 'governance')">
                                    <div class="absolute top-4 right-4">
                                        <div class="w-6 h-6 rounded-full border-2 {{ $userType === 'governance' ? 'border-red-900 bg-red-600' : 'border-gray-300' }} flex items-center justify-center transition-all duration-200">
                                    ...
                                    <div class="text-center">
                                        <div class="w-20 h-20 bg-red-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300">
                                            <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div class="space-y-3 text-left">
                                            <div class="flex items-center text-sm text-gray-600">
                                                <svg class="w-4 h-4 text-red-900 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                                </svg>
                                                Elected positions
                                            </div>
                                ...
                                <!-- Operational Card -->
                                <div class="group relative bg-white border-2 border-gray-200 rounded-2xl p-8 cursor-pointer hover:border-green-500 hover:shadow-xl transition-all duration-300 {{ $userType === 'operational' ? 'border-green-500 bg-red-600 shadow-xl' : '' }}" wire:click="$set('userType', 'operational')">
                                    <div class="absolute top-4 right-4">
                        ...
                        <div class="max-w-4xl mx-auto">
                            ...
                            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" wire:model.defer="firstName" placeholder="Enter first name" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-red-900 focus:border-red-900 transition-all duration-200 placeholder-gray-400">
                                    @error('firstName') 
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" wire:model.defer="middleName" placeholder="Enter middle name (optional)" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-red-900 focus:border-red-900 transition-all duration-200 placeholder-gray-400">
                                    @error('middleName') 
                                        <div class="flex items-center text-red-500 text-sm mt-1">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" wire:model.defer="lastName" placeholder="Enter last name" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-red-900 focus:border-red-900 transition-all duration-200 placeholder-gray-400">
                                    @error('lastName') 
                                        <div class="flex items-center text-red-500 text-sm mt-1">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="date" wire:model.defer="dob" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-red-900 focus:border-red-900 transition-all duration-200">
                                    @error('dob') 
                                        <div class="flex items-center text-red-500 text-sm mt-1">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select wire:model.defer="gender" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-red-900 focus:border-red-900 transition-all duration-200">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select wire:model.defer="maritalStatus" class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-red-900 focus:border-red-900 transition-all duration-200">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select wire:model="department_id" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900">
                                ...
                                <div>
                                    ...
                                    <select wire:model.defer="role_id" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model.defer="job_title" placeholder="e.g., Board Chair, Committee Member" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900">
                                ...
                                <div>
                                    ...
                                    <input type="date" wire:model.defer="start_date" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900">
                        ...
                        <div class="max-w-4xl mx-auto">
                            ...
                            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                                ...
                                <div>
                                    ...
                                    <select wire:model.defer="reporting_manager_id" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900">
                                ...
                                <div>
                                    ...
                                    <select wire:model.defer="employment_type" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model.defer="job_title" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900">
                                    @error('job_title') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Employee ID <span class="text-red-500">*</span></label>
                                    <input type="text" wire:model.defer="employeeId" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900">
                                    @error('employeeId') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Status <span class="text-red-500">*</span></label>
                                    <select wire:model.defer="status" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900">
                                        <option value="1">Active</option>
                                        <option value="0">Inactive</option>
                                    </select>
                        ...
                        <div class="max-w-4xl mx-auto">
                            ...
                            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                                ...
                                <div>
                                    ...
                                    <input type="number" wire:model.defer="basicSalary" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900" placeholder="0.00" step="0.01" min="0">
                                ...
                                <div>
                                    ...
                                    <select wire:model.defer="paymentFrequency" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model.defer="nssfNumber" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900" placeholder="NSSF Number">
                                ...
                                <div>
                                    ...
                                    <input type="number" wire:model.defer="nssfRate" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900" placeholder="0-100" step="0.01" min="0" max="100">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model.defer="nhifNumber" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900" placeholder="NHIF Number">
                                ...
                                <div>
                                    ...
                                    <input type="number" wire:model.defer="nhifRate" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900" placeholder="0-100" step="0.01" min="0" max="100">
                                ...
                                <div>
                                    ...
                                    <input type="number" wire:model.defer="workersCompensation" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900" placeholder="0.00" step="0.01" min="0">
                                ...
                                <div>
                                    ...
                                    <input type="number" wire:model.defer="lifeInsurance" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900" placeholder="0.00" step="0.01" min="0">
                                ...
                                <div>
                                    ...
                                    <select wire:model.defer="taxCategory" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900">
                                ...
                                <div>
                                    ...
                                    <input type="number" wire:model.defer="payeRate" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-900 focus:border-red-900" placeholder="0-100" step="0.01" min="0" max="100">
                        ...
                        <div class="max-w-4xl mx-auto">
                            ...
                            <div class="bg-red-100 border border-red-200 rounded-2xl p-8 shadow-lg">
                                <h4 class="font-semibold text-red-900 mb-2">Review Information</h4>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div>
                                        <div><span class="font-medium">User Type:</span> 
                                            @if($userType === 'governance')
                                                <span class="text-red-600 font-semibold">Board Member & Oversight</span>
