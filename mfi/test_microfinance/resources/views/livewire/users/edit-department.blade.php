    ...
    <div class="col-span-6 sm:col-span-4">
            ...
            <div class="w-full flex gap-4">
                    ...
                    <div class="w-1/2">
                        ...
                        <textarea wire:model="description" id="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Enter description..."></textarea>
                        <div class="mt-4"></div>
