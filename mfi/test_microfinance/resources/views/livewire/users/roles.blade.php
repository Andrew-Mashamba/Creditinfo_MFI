<div class="min-h-screen bg-gradient-to-br from-slate-50 to-red-50 py-8">
    <!-- Toast Notifications -->
    <div
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $role->parent_role_id ? 'bg-purple-100 text-purple-800' : 'bg-red-100 text-red-800' }}">
                    ...
                    <div class="p-4 border-b border-gray-100">
                        ...
                        <div class="space-y-2">
                            @forelse($department->roles()->whereNull('parent_role_id')->get() as $role)
                                <div wire:click="showPermissionsModal({{ $role->id }}, 'role')" class="flex items-center justify-between bg-red-50 rounded-md p-3 hover:bg-red-100 transition-colors duration-150">
                                    <div class="flex-1">
                                        <div class="flex items-center">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <h4 class="font-medium text-red-900">Selected Permissions</h4>
                        </div>
