<div>
    ...
    <div class="flex w-full">
        ...
        <div class="w-1/3 p-4 ">
            ...
            <select wire:model="userSelected" name="userSelected" id="userSelected" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
