    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 tracking-tight">MFI Organizational Structure</h1>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="border-l-4 border-purple-500 pl-4">
                    ...
                    <p class="text-sm text-gray-600">Supreme authority of the MFI</p>
                    <div class="mt-2">
    ...
    <div class="mt-8">
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-indigo-600 to-indigo-700 p-6">
                ...
                <p class="text-indigo-100 text-sm">Visual representation of the MFI structure</p>
            </div>
                    ...
                    <div class="min-w-max">
                        ...
                        <div class="flex justify-center space-x-8 mb-8">
                            <div class="bg-red-100 border-2 border-red-300 rounded-lg px-4 py-2 text-center">
                                <div class="font-semibold text-red-800">Board of Directors</div>
                                <div class="text-xs text-red-600">Governing Body</div>
                            </div>
                            <div class="bg-red-100 border-2 border-red-300 rounded-lg px-4 py-2 text-center">
