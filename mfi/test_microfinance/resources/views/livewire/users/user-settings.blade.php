        ...
        <div>
            ...
            <form wire:submit.prevent="saveAssignments">
                <div class="mb-4">
                    ...
                    <select id="department" wire:model="department_code" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                ...
                <div class="mb-4">
                    ...
                    <select id="committees" wire:model="selectedCommittees" multiple class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                ...
                <div class="mb-4">
                    ...
                    <select id="branch" wire:model="branch" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                ...
                <div class="mb-4">
                    ...
                    <select id="institution" wire:model="institution_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                ...
                <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600">Save Assignments</button>
            </form>
        </div>
