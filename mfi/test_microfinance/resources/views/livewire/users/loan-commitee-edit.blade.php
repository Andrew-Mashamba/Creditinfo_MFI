    ...
    <div class="col-span-6 sm:col-span-4">
        <div class="w-full flex gap-4">
            ...
            <div class="w-1/2">
                ...
                <textarea wire:model="description" id="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500" placeholder="Enter description..."></textarea>
                @error('description')
                <div class="border border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700 mt-1">
    ...
    @if ($this->committee_id)
                            ...
                            <div class="w-1/3 mt-1">
                                <label class="inline-flex items-center">
                                    <input type="checkbox"
                                           ...
                                           class="form-checkbox h-6 w-6 text-red-500">
        ...
        <div class="flex justify-end w-auto">
            <div wire:loading wire:target="save">
                <button class="text-white bg-red-400 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-red-600 dark:hover:bg-red-600 dark:focus:ring-red-800 inline-flex items-center">
            ...
            <div wire:loading.remove wire:target="save">
                <button type="submit" wire:click="save" class="text-white bg-red-500 hover:bg-red-400 focus:ring-4
                focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2
                dark:bg-red-600 dark:hover:bg-red-600 dark:focus:ring-red-800">Save</button>
            </div>
        </div>
        @endif
</div>
