            ...
            <div class="bg-gray-100 rounded-lg shadow-sm ">
                <div class="flex gap-2 pt-2 pl-2 pr-2 pb-2">
                    ...
                    @endphp
                        ...
                        rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 ds:bg-gray-700
                        ds:border-gray-600 ds:placeholder-gray-400 ds:text-white ds:focus:ring-red-500 ds:focus:border-red-500  @if($service['id']==$this->service_id) bg-red-800 text-white @endif ">
                        ...
                        <div class="flex justify-end w-auto" >
                            <div wire:loading wire:target="save" >
                                <button class="text-white bg-red-400 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 ds:bg-red-400 ds:hover:bg-red-400 ds:focus:ring-red-400" disabled>
