<div>
    <div class="p-4">
                ...
                <div>
                    ...
                    <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                        <li class="flex items-center">
                            <svg class="w-3.5 h-3.5 mr-2 text-red-900 dark:text-red-900 flex-shrink-0"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path
                                    d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                            </svg>
                            Total Transactions: {{ App\Models\general_ledger::count() }}
                        </li>
                        <li class="flex items-center">
                            <svg class="w-3.5 h-3.5 mr-2 text-red-900 dark:text-red-900 flex-shrink-0"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            {{--                            {{ App\Models\AccountsModel::count() }} --}}
                        </li>
                        <li class="flex items-center">
                            <svg class="w-3.5 h-3.5 mr-2 text-red-900 dark:text-red-900 flex-shrink-0"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            ...
                            <span>
                                <span
                                    class="ml-2 bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400"></span>
                            </span>
                ...
                <div wire:loading.remove wire:target="setView">
                    @switch($this->selected)
                        ...
                        @case('3')
                            ...
                            @break
                        @case('4')
                            <livewire:services.delete-service/>
                            @break
        ...
        <div class="bg-white p-4 sm:p-6 overflow-hidden mb-2 rounded-lg">
            ...
            {{--            @if (in_array('Perform account reconciliation', session()->get('permission_items'))) --}}
            ...
            @if ($this->tab_id == $menuItem['id']) bg-red-600 @else bg-gray-100 @endif
                        ...
                        <div wire:loading wire:target="menuItemClicked({{ $menuItem['id'] }})">
                            <svg aria-hidden="true"
                                class="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-900 fill-red-600"
                        ...
                        <div wire:loading.remove wire:target="menuItemClicked({{ $menuItem['id'] }})">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="red" class="w-4 h-4 mr-2 fill-current">
            ...
            <div class="tab-pane fade " id="tabs-homeJustify" role="tabpanel"
