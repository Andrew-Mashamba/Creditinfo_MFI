                ...
                <div class="bg-white rounded-lg shadow-sm p-4">
                        ...
                        <div class="flex w-full">
                            ...
                            <div class="w-1/2 p-4 ">
                                ...
                                <p for="nodeSelected" class="block mb-1 text-sm capitalize text-slate-400 dark:text-white ">SELECT A SERVICE</p>
                                <select wire:model="serviceSelected" name="nodeSelected" id="nodeSelected" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                                ...
                                @if($this->serviceSelected)
                                    ...
                                    <div class="flex items-center mb-2 text-sm spacing-sm text-slate-600 mt-4" >
                                        ...
                                        <p>Service selected: {{ App\Models\servicesModel::where('ID', $this->serviceSelected)->value('NAME') }}</p>
