<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-6 border border-red-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-red-700">Daily Volume</p>
                    <p class="text-2xl font-bold text-red-900">TZS {{ number_format($dailyVolume ?? 0) }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
            ...
            <div class="space-y-4">
                <button wire:click="generateDailyReport" class="w-full flex items-center p-4 text-left bg-gradient-to-r from-red-50 to-red-100 hover:from-red-100 hover:to-red-200 rounded-xl transition-all duration-200 shadow-sm hover:shadow-md border border-red-200">
                    <div class="p-2 bg-red-500 rounded-lg mr-4">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        </svg>
                    </div>
                    <div class="flex-1">
                        <h4 class="font-bold text-red-900">Daily Cash Summary</h4>
                        <p class="text-sm text-red-700">Today's cash movements and balances</p>
                    </div>
