    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-6 border border-red-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-red-700">Secured Transfers</p>
                    <p class="text-2xl font-bold text-red-900">{{ count($secureCitTransfers ?? []) }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <button wire:click="refreshCitData" class="text-red-600 hover:text-red-800 text-sm font-medium bg-red-50 hover:bg-red-100 px-4 py-2 rounded-xl transition-all duration-200">
            ...
            <div class="space-y-4 max-h-96 overflow-y-auto">
                @forelse($activeCitTransfers ?? [] as $transfer)
                    <div class="bg-gradient-to-r from-red-50 to-green-50 rounded-2xl p-4 border border-green-200 hover:shadow-md transition-all duration-200">
                        <div class="flex items-center justify-between mb-3">
                            <div class="flex items-center">
                                <div class="p-2 bg-gradient-to-br from-red-500 to-green-500 rounded-xl text-white">
                        ...
                        <div class="flex justify-between items-center text-sm">
                            ...
                            <div class="flex space-x-2">
                                ...
                                <button wire:click="updateTransfer({{ $transfer->id }})" class="text-red-600 hover:text-red-800 font-medium">
                                    Update
                                </button>
                            </div>
                        </div>
                ...
                <div class="bg-gradient-to-br from-gray-50 to-purple-50 rounded-2xl p-6 border border-purple-200 hover:shadow-lg transition-all duration-200">
                    ...
                    <div class="mt-4 pt-4 border-t border-purple-200">
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex space-x-2">
                                <button wire:click="editProvider({{ $provider->id }})" class="text-red-600 hover:text-red-800 text-sm font-medium">
                                    Edit
                                </button>
