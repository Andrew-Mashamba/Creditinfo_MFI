<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-6 border border-red-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-red-700">Total Tills</p>
                    <p class="text-2xl font-bold text-red-900">{{ count($availableTills ?? []) }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
            ...
            <form wire:submit.prevent="assignTillToTeller" class="space-y-6">
                <div>
                    ...
                    <select wire:model="assignTillId" class="w-full rounded-xl border-2 border-red-200 shadow-sm focus:border-red-500 focus:ring-4 focus:ring-red-200 transition-all duration-200 p-4 text-lg">
                ...
                <div>
                    ...
                    <select wire:model="assignTellerId" class="w-full rounded-xl border-2 border-red-200 shadow-sm focus:border-red-500 focus:ring-4 focus:ring-red-200 transition-all duration-200 p-4 text-lg">
                ...
                <button type="submit" class="w-full bg-gradient-to-r from-red-500 to-red-600 text-white py-4 px-6 rounded-xl hover:from-red-600 hover:to-red-700 focus:outline-none focus:ring-4 focus:ring-red-200 transition-all duration-200 font-bold text-lg shadow-lg">
                    Assign Till
                </button>
            </form>
        </div>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-green-50 rounded-2xl p-4 border border-green-200">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-right">
                                ...
                                @endphp
                                <div class="text-sm">
                                    <span class="inline-flex px-2 py-1 text-xs font-bold rounded-full {{ $assignedTillsCount > 0 ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800' }}">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
            ...
            <div class="space-y-4">
                <button wire:click="refreshTillData" class="w-full flex items-center p-4 text-sm text-gray-700 hover:text-gray-900 bg-gradient-to-r from-red-50 to-red-100 hover:from-red-100 hover:to-red-200 rounded-xl transition-all duration-200 shadow-sm hover:shadow-md border border-red-200">
    ...
    <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <button wire:click="refreshTillData" class="text-red-600 hover:text-red-800 text-sm font-medium bg-red-50 hover:bg-red-100 px-4 py-2 rounded-xl transition-all duration-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($tillSummary as $till)
                <div class="bg-gradient-to-br from-gray-50 to-red-50 rounded-2xl p-6 border-l-4 {{ $till['status'] === 'open' ? 'border-green-400' : 'border-gray-400' }} hover:shadow-lg transition-all duration-200">
                    ...
                    <div class="space-y-3 text-sm">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-bold text-red-600">TZS {{ number_format($till['current_balance']) }}</span>
                        </div>
