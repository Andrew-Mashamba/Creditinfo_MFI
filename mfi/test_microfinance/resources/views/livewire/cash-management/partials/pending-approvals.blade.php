    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-6 border border-red-200">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-red-700">Vault Transfers</p>
                    <p class="text-2xl font-bold text-red-900">{{ collect($pendingApprovals ?? [])->whereIn('process_code', ['VAULT_TO_TILL', 'TILL_TO_VAULT'])->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-6">
            @foreach($pendingApprovals as $approval)
                @php
                    ...
                    $cardColors = [
                        'VAULT_TO_TILL' => ['bg' => 'from-red-50 to-red-100', 'border' => 'border-red-200', 'text' => 'text-red-800', 'icon' => 'bg-red-500'],
                                ...
                                <div class="space-y-2 text-sm">
                                    @if(isset($data['till_account']))
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-mono text-xs bg-red-100 px-2 py-1 rounded">{{ $data['till_account'] }}</span>
                                        </div>
                                    @endif
                                    ...
                                    @if(isset($data['current_balance']))
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-bold text-red-600">TZS {{ number_format($data['current_balance']) }}</span>
                                        </div>
                                    @endif
                                    @if(isset($data['notes']))
                                        <div class="mt-3">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-12 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
                <div class="bg-red-50 rounded-2xl p-4 text-center">
                    ...
                    <p class="text-red-800 font-medium text-sm">Auto-refresh every 30s</p>
                </div>
