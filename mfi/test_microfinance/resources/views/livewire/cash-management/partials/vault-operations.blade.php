<div class="space-y-8">
    ...
    <div class="bg-gradient-to-br from-red-500 via-red-600 to-red-700 rounded-3xl p-8 text-white shadow-2xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-6 border border-red-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-red-700">Vault Limit</p>
                        <p class="text-xl font-bold text-red-900">TZS {{ number_format($vaultLimit ?? 0) }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
                ...
                <form wire:submit.prevent="processVaultTransfer" class="space-y-6">
                    <div>
                        ...
                        <select wire:model="vaultTransferType" class="w-full rounded-xl border-2 border-red-200 shadow-sm focus:border-red-500 focus:ring-4 focus:ring-red-200 transition-all duration-200 p-4 text-lg">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-6">
                    <h4 class="text-lg font-bold text-red-900 mb-4">Basic Information</h4>
                    <div class="space-y-3 text-sm">
                        <div class="flex justify-between">
                            <span class="text-red-700 font-medium">Vault Name:</span>
                            <span class="font-bold text-red-900">{{ $vault->name }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-red-700 font-medium">Code:</span>
                            <span class="font-bold text-red-900">{{ $vault->code }}</span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            <span class="text-red-700 font-medium">Warning Threshold:</span>
                            <span class="font-bold text-red-900">{{ $vault->warning_threshold ?? 80 }}%</span>
                        </div>
                    </div>
                </div>
