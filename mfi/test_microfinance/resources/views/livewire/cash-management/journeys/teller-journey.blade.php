...
@switch($activeTab)
    ...
    @case('morning-setup')
        <div class="space-y-6">
            {{-- Progress Timeline --}}
            <div class="bg-gradient-to-r from-red-50 to-green-50 rounded-2xl p-6 border border-red-200">
                        ...
                        @foreach($setupSteps as $index => $step)
                            <div class="flex items-center">
                                <div class="relative z-10 w-8 h-8 rounded-full flex items-center justify-center
                                    ...
                                    @elseif($step['status'] === 'in_progress') bg-red-500 animate-pulse
                                    @else bg-gray-300
                                    @endif">
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    @if($step['status'] === 'in_progress')
                                        <p class="text-sm text-red-600">In Progress...</p>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                    ...
                    <form wire:submit.prevent="requestTillOpening" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select wire:model="selectedTillId" class="w-full rounded-lg border-2 border-gray-300 focus:border-red-500 focus:ring-2 focus:ring-red-200 p-3">
                        ...
                        <div>
                            ...
                            <input type="number" wire:model="tillOpeningBalance" step="1000" min="100000" 
                                   class="w-full rounded-lg border-2 border-gray-300 focus:border-red-500 focus:ring-2 focus:ring-red-200 p-3"
    ...
    @case('customer-transactions')
        <div class="space-y-6">
            {{-- Queue Management --}}
            <div class="bg-gradient-to-r from-red-50 to-indigo-50 rounded-2xl p-6 border border-red-200">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <span class="font-bold text-red-600">{{ $avgWaitTime ?? '3' }} mins</span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-5 gap-3">
                    @for($i = 1; $i <= 5; $i++)
                        <div class="bg-white rounded-lg p-3 text-center border-2 
                            @if($i === 1) border-red-500 shadow-lg @else border-gray-200 @endif">
                            <span class="text-2xl font-bold @if($i === 1) text-red-600 @else text-gray-400 @endif">
                ...
                {{-- Call Next Customer --}}
                <button wire:click="callNextCustomer" class="mt-4 w-full bg-red-600 text-white py-3 rounded-lg hover:bg-red-700 font-semibold">
                    Call Next Customer
                </button>
            </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" wire:model="transactionAmount" step="1000" min="1000"
                                   class="w-full rounded-lg border-2 border-gray-300 focus:border-red-500 p-3 pl-12 text-xl font-bold"
                                   placeholder="0">
                        </div>
    ...
    @case('cash-management')
        <div class="space-y-6">
            {{-- Current Till Status --}}
            <div class="bg-gradient-to-r from-red-50 to-purple-50 rounded-2xl p-6 border border-red-200">
                ...
                <div class="grid grid-cols-4 gap-4">
                    <div class="bg-white rounded-lg p-4 text-center">
                        ...
                        <p class="text-2xl font-bold text-red-600">{{ number_format($tillCurrentBalance) }}</p>
                    </div>
                    <div class="bg-white rounded-lg p-4 text-center">
                    ...
                    <div class="bg-red-50 rounded-lg p-4 border border-red-200">
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-xl font-bold text-red-600">{{ number_format($eodPhysicalCount) }}</p>
                            </div>
                            <div>
                    ...
                    <div>
                        ...
                        <div class="space-y-2 text-sm">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold text-red-600">{{ number_format($todayDeposits - $todayWithdrawals) }}</span>
                            </div>
