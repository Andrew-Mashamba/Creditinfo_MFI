<div>
    ...
    <div class="flex w-full">
        ...
        <div class="w-1/3 p-4 ">
            ...
            <p for="nodeSelected" class="block mb-1 text-sm capitalize text-slate-400 dark:text-white ">SELECT A CHANNEL</p>
            <select wire:model="channelSelected" name="channelSelected" id="channelSelected" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
            ...
            <div class="px-4 py-3 mt-1 text-red-700 bg-red-100 border border-red-400 rounded-b">
                <p>channelSelected is mandatory.</p>
            </div>
            @enderror
            ...
            @if($this->channelSelected)
                ...
                <div class="flex items-center mb-2 text-sm spacing-sm text-slate-600 mt-4" >
                    ...
                    <p>Service selected: {{ App\Models\ChannelsModel::where('ID', $this->channelSelected)->value('NAME') }}</p>

                </div>


                <p for="password" class="block mb-1 mt-4 text-sm capitalize text-slate-400 dark:text-white ">ENTER PASSWORD TO CONFIRM</p>
                <input wire:model.defer="password" id="password" type="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500" autocomplete="password" />
