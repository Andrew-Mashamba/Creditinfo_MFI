<div class="py-2 px-4 bg-gradient-to-br from-slate-50 to-red-50">
    {{-- Quick Stats Row --}}
    <div class="mb-4 grid grid-cols-1 md:grid-cols-3 gap-3">
        <div class="bg-white rounded-lg shadow-sm p-3 flex items-center space-x-3 border border-gray-100">
            <div class="p-1.5 bg-red-100 rounded">
                <svg class="w-4 h-4 text-red-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
                <h2 class="text-sm font-bold text-gray-900 mb-3 flex items-center border-b border-red-100 pb-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <input disabled value="TZS" class="w-full px-2 py-1.5 bg-gray-50 border border-gray-300 rounded text-gray-500 text-sm focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent">
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" wire:model.defer="institution.registration_fees" min="0" step="0.01" class="w-full pl-10 pr-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent">
                            </div>
                        ...
                        <div>
                            ...
                            <input type="number" wire:model.defer="institution.min_shares" min="0" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent">
                        ...
                        <div>
                            ...
                            <input type="number" wire:model.defer="institution.initial_shares" min="0" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-2 text-gray-500 text-xs">TZS</span>
                                <input type="number" wire:model.defer="institution.value_per_share" min="0" step="0.01" class="w-full pl-10 pr-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-2 text-gray-500 text-xs">TZS</span>
                                <input type="number" wire:model.defer="institution.petty_amount_limit" min="0" step="0.01" class="w-full pl-10 pr-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent">
                            </div>
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <input type="text" wire:model.defer="institution.institution_name" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent">
                        ...
                        <div>
                            ...
                            <input type="email" wire:model.defer="institution.manager_email" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent">
                        ...
                        <div>
                            ...
                            <input type="tel" wire:model.defer="institution.phone_number" pattern="[0-9]{10}" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model.defer="institution.region" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model.defer="institution.wilaya" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent">
                            ...
                            <div class="grid grid-cols-2 gap-1">
                                @foreach([6, 12, 18, 24] as $months)
                                    <label class="inline-flex items-center">
                                        <input type="radio" wire:model.defer="institution.inactivity" value="{{ $months }}" class="form-radio h-3 w-3 text-red-900 focus:ring-red-900">
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
                <h2 class="text-sm font-bold text-gray-900 mb-3 flex items-center border-b border-red-100 pb-2">
                    <svg class="w-4 h-4 mr-2 text-red-900" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    Financial Year
                </h2>
                <label for="startDate" class="block text-xs font-medium text-gray-700 mb-1">Financial Year Date</label>
                <input type="date" wire:model.defer="institution.startDate" id="startDate" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
                <div class="flex items-center justify-between mb-3 border-b border-red-100 pb-2">
                    <h2 class="text-sm font-bold text-gray-900 flex items-center">
                        <svg class="w-4 h-4 mr-2 text-red-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <div class="flex items-center">
                            <div class="w-20 bg-gray-200 rounded-full h-1.5">
                                <div class="bg-red-600 h-1.5 rounded-full" style="width: {{ ($uploadedCount / count($docs)) * 100 }}%"></div>
                            </div>
                    ...
                    @foreach($docs as $field => $doc)
                        ...
                        <div class="border {{ $hasFile ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50' }} rounded-lg p-3 transition-all hover:shadow-sm">
                                        ...
                                        <div>
                                            ...
                                            @if($hasFile && $latestFile)
                                                <p class="text-xs text-gray-600 mt-0.5">
                                                    ...
                                                    @if($files->count() > 1)
                                                        <span class="ml-1 text-red-900 font-medium">({{ $files->count() }} versions)</span>
                                                    @endif
                                                </p>
                                            @else
                                ...
                                <div class="flex items-center space-x-1">
                                    @if($hasFile)
                                        ...
                                        <button wire:click="download({{ $latestFile->id }})" 
                                                class="inline-flex items-center px-2 py-1 bg-white border border-gray-300 rounded text-xs font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-red-900"
                                        ...
                                        <label class="inline-flex items-center px-2 py-1 bg-red-600 border border-red-900 rounded text-xs font-medium text-white hover:bg-red-800 cursor-pointer focus:outline-none focus:ring-1 focus:ring-red-900">
                                            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                            </svg>
                                            Add Version
                                        ...
                                        @if($files->count() > 1)
                                            <button type="button" 
                                                    ...
                                                    class="inline-flex items-center px-2 py-1 bg-gray-100 border border-gray-300 rounded text-xs font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-1 focus:ring-red-900"
                                    ...
                                    @else
                                        ...
                                        <label class="inline-flex items-center px-3 py-1 bg-red-600 border border-red-900 rounded text-xs font-medium text-white hover:bg-red-800 cursor-pointer focus:outline-none focus:ring-1 focus:ring-red-900">
                                            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div wire:loading wire:target="{{ $field }}" class="mt-2">
                                <div class="flex items-center space-x-2">
                                    <svg class="animate-spin h-3 w-3 text-red-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                ...
                                <div id="versions-{{ $field }}" class="hidden mt-3 p-2 bg-white rounded-lg border border-gray-200">
                                    ...
                                    <div class="space-y-1">
                                        @foreach($files as $index => $file)
                                            <div class="flex items-center justify-between p-2 {{ $index == 0 ? 'bg-red-50 border border-red-200' : 'bg-gray-50' }} rounded">
                                                <div class="flex items-center space-x-2">
                                                    @if($index == 0)
                                                        <span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-semibold bg-red-600 text-white">Latest</span>
                                                    @else
