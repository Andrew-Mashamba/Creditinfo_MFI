            ...
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                            ...
                            <div class="mb-4">
                                ...
                                <div >
                                    ...
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <textarea id="description" wire:model="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:borde"></textarea>
                    ...
                    <div class="flex items-center bg-gray-200 justify-end py-3 sm:px-6 sm:rounded-bl-lg sm:rounded-br-lg">
                        ...
                        <button type="submit" wire:click="register" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-red-400 border border-transparent rounded-md  focus-visible:ring-2 focus-visible:ring-offset-2 ">
                            Proceed
                        </button>
                    </div>
                </div>
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                ...
                <div class="flex items-center bg-gray-200 justify-end py-3 sm:px-6 sm:rounded-bl-lg sm:rounded-br-lg">
                    ...
                    <button type="submit" wire:click="update" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-red-400 border border-transparent rounded-md  focus-visible:ring-2 focus-visible:ring-offset-2 ">
                        Proceed
                    </button>
                </div>
            </div>
                ...
                <table class="min-w-full bg-white border border-gray-200">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="px-4 py-2 text-left bg-red-100 border border-gray-200"> Description </th>
                            <th class="px-4 py-2 text-left bg-red-100 border border-gray-200"> Per    </th>
                            <th class="px-4 py-2 text-left bg-red-100 border border-gray-200"> Percent  </th>
                            <th class="px-4 py-2 text-right bg-red-100 border border-gray-200"> Action  </th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 border-red-200 border "> {{ $provision->description }} </td>
                            <td class="px-4 py-2 border-red-200 border "> {{ $provision->per }} </td>
                            <td class="px-4 py-2 border-red-200 border ">  {{ $provision->percent }} % </td>
