<div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mt-4">
    <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex gap-2">
            ...
            <button wire:click="$set('editMode', false); $set('committee_id', null); $set('name', ''); $set('type', 'committee'); $set('description', '');" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-800 transition-colors">Add Committee</button>
        </div>
    </div>
    ...
    @if($showFilters)
        <div class="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200 flex flex-col md:flex-row md:items-end gap-4">
            <div>
                ...
                <select wire:model="filterType" class="w-48 px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent">
            ...
            <div>
                ...
                <input type="date" wire:model="filterCreatedFrom" class="w-40 px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent" />
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Created To</label>
                <input type="date" wire:model="filterCreatedTo" class="w-40 px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent" />
            </div>
            <div class="flex gap-2 mt-4 md:mt-0">
                <button wire:click="applyFilters" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-800">Apply Filters</button>
                <button wire:click="resetFilters" class="px-4 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300">Reset</button>
            </div>
        </div>
    @endif
    <div class="flex items-center justify-between mb-4">
        <input type="text" wire:model.debounce.300ms="search" placeholder="Search by name or type..." class="w-64 px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent" />
        <div>
                ...
                @forelse($committees as $committee)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <button wire:click="editCommittee({{ $committee->id }})" class="text-red-600 hover:text-red-900 font-semibold mr-2">Edit</button>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
            ...
            <form wire:submit.prevent="{{ $editMode ? 'updateCommittee' : 'createCommittee' }}">
                <div class="mb-4">
                    ...
                    <input type="text" wire:model.defer="name" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent">
                    @error('name') <span class="text-red-600 text-xs">{{ $message }}</span> @enderror
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Type</label>
                    <select wire:model.defer="type" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent">
                        <option value="committee">Committee</option>
                        <option value="subcommittee">Subcommittee</option>
                        <option value="board">Board</option>
                        <option value="management">Management</option>
                ...
                <div class="mb-4">
                    ...
                    <textarea wire:model.defer="description" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"></textarea>
                ...
                <div class="mb-4">
                    ...
                    <select wire:model.defer="department_id" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent">
                ...
                <div class="flex justify-end">
                    ...
                    <button type="submit" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-800">{{ $editMode ? 'Update' : 'Create' }}</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
                ...
                <form wire:submit.prevent="exportCommittees">
                        ...
                        <div class="flex flex-col gap-2">
                            @foreach($exportFields as $field)
                                <label class="inline-flex items-center">
                                    <input type="checkbox" wire:model="selectedExportFields" value="{{ $field }}" class="form-checkbox h-4 w-4 text-red-600">
                    ...
                    <div class="mb-4">
                        ...
                        <select wire:model="exportFormat" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent">
