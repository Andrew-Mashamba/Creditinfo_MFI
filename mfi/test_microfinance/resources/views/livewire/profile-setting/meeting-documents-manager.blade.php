<div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mt-4">
    ...
    <form wire:submit.prevent="uploadDocument" class="flex flex-col md:flex-row gap-2 items-center mb-6">
        <input type="file" wire:model="file" class="w-64 px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent" />
        <button type="submit" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-800">Upload</button>
                ...
                @forelse($documents as $doc)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="{{ Storage::disk('public')->url($doc->file_path) }}" target="_blank" class="text-red-600 hover:text-red-900 font-semibold mr-2">Download</a>
