<div class="bg-gradient-to-br from-slate-50 to-red-50 p-2">
    <!-- Compact Header with Stats -->
    <div class="mb-3">
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                    <div class="p-1.5 bg-red-600 rounded">
                ...
                <div class="grid grid-cols-4 gap-2">
                    <div class="bg-red-50 rounded px-3 py-1.5 border border-red-100">
                        <div class="flex items-center space-x-1">
                            <svg class="w-3 h-3 text-red-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                            </svg>
                            <div>
                                <p class="text-xs font-semibold text-red-900">{{ \App\Models\LeaderShipModel::count() ?? 0 }}</p>
    ...
    <div class="flex gap-3">
        ...
        <div class="w-64 bg-white rounded-lg shadow-sm border border-gray-100">
            ...
            <div class="p-3 border-b border-gray-100">
                <div class="relative">
                    ...
                    <input type="text" 
                           ...
                           placeholder="Search..." 
                           class="w-full pl-7 pr-2 py-1.5 text-xs border border-gray-200 rounded focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent bg-gray-50 hover:bg-white"/>
                </div>
            </div>
            ...
            <div class="p-2">
                ...
                @php
                    $sections = [
                        ['id' => 'leadership', 'label' => 'Leadership', 'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', 'color' => 'red'],
            ...
            <div class="p-2 border-t border-gray-100 bg-gray-50">
                ...
                <div class="space-y-1">
                    <button wire:click="openNewLeaderModal" 
                        ...
                        <svg class="w-3 h-3 mr-1.5 text-red-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <h2 class="text-sm font-bold text-gray-900 flex items-center">
                                ...
                                @if($activeSection === 'leadership')
                                    <span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-semibold bg-red-100 text-red-900">
                        ...
                        <div class="flex items-center space-x-2">
                            <div class="relative">
                                <input type="text" 
                                       ...
                                       class="pl-7 pr-2 py-1 text-xs border border-gray-200 rounded focus:outline-none focus:ring-1 focus:ring-red-900 focus:border-transparent"/>
                            ...
                            @if($activeSection === 'leadership')
                                <button wire:click="openNewLeaderModal" 
                                        class="inline-flex items-center px-2 py-1 bg-red-600 text-white text-xs font-medium rounded hover:bg-red-800 focus:outline-none focus:ring-1 focus:ring-red-900">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <button wire:click="$set('activeSection', 'committees')" 
                                        class="mt-2 text-xs text-red-900 hover:text-red-700 font-medium">
                                    Go to Committees →
                                </button>
                            </div>
                        @endif
