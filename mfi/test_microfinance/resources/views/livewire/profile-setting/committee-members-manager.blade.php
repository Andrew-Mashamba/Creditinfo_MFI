<div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mt-4">
    ...
    <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <form wire:submit.prevent="addMember" class="flex flex-col md:flex-row gap-2 items-center">
            ...
            <select wire:model.defer="role" class="w-40 px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent">
            ...
            <button type="submit" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-800">Add</button>
        </form>
        <input type="text" wire:model.debounce.300ms="search" placeholder="Search members..." class="w-64 px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent" />
    </div>
