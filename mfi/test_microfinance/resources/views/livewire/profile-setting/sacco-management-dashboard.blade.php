<div class="bg-gradient-to-br from-slate-50 to-red-50 min-h-screen p-6">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @foreach($committees as $committee)
                            <button wire:click="selectCommittee({{ $committee->id }})" class="px-4 py-2 rounded-lg border border-red-900 text-red-900 bg-white hover:bg-red-50 {{ $selectedCommitteeId === $committee->id ? 'bg-red-600 text-white' : '' }}">
                                {{ $committee->name }}
                            </button>
                        @endforeach
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @foreach($meetings as $meeting)
                            <button wire:click="selectMeeting({{ $meeting->id }})" class="px-4 py-2 rounded-lg border border-red-900 text-red-900 bg-white hover:bg-red-50 {{ $selectedMeetingId === $meeting->id ? 'bg-red-600 text-white' : '' }}">
