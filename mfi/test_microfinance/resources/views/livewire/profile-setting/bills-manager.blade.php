<div class="p-4">
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <button wire:click="$set('show_service_details', true)" 
            class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500">
            Add New Service
        </button>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            @switch($service->paymentMode)
                                @case('1')
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800">Partial</span>
                                    @break
                                @case('2')
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <button wire:click="viewServiceDetails({{ $service->id }})" 
                                class="text-red-600 hover:text-red-900">Edit</button>
                        </td>
                    </tr>
                @empty
                    <tr>
