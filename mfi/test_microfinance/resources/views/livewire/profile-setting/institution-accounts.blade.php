<div class="w-full mt-8 p-4 bg-white rounded-lg shadow">
    ...
    <div class="mt-6">
        <button wire:click="saveInstitutionAccounts" 
                ...
                type="button" 
                class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-600 focus:outline-none dark:focus:ring-red-800">
