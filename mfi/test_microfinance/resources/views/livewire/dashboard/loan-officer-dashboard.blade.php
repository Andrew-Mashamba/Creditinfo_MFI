                                            ...
                                            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                                <div class="p-4">
                                                    ...
                                                    <div class="text-center font-bold">
                                                        <h3 class="text-lg">CREATE PROMISE</h3>
                                                    </div>

                                                    <div class="mt-5">
                                                        <x-jet-label for="max_amount" value="{{ __('Promise Date') }}" />
                                                        <input id="max_amount" name="max_amount" type="date" class="mt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5" wire:model="promise_date" autofocus />
                                                        @error('promise_date')
                                                        ...
                                                        <label for="message" class="block mb-2 text-sm font-medium text-gray-900 mt-2">Descriptions</label>
                                                        <textarea wire:model="promise_description" id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500" placeholder="Write your thoughts here..."></textarea>
