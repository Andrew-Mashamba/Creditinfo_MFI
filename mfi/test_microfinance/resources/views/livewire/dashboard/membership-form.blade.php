<div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
    ...
    @else
        ...
        <div class="text-center py-12">
            ...
            @if(!$searchTerm && !$selectedCategory)
                <button wire:click="openUploadModal" 
                        class="px-6 py-3 bg-red-600 text-white font-medium rounded-lg hover:bg-purple-700 focus:ring-4 focus:ring-purple-200 transition-all duration-200">
                    Upload First Form
                </button>
            @endif
        </div>
            ...
            <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
                ...
                <div class="flex items-center justify-between p-6 border-b border-gray-200">
                    ...
                    <button wire:click="closeUploadModal" 
                            class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg bg-red-600">
