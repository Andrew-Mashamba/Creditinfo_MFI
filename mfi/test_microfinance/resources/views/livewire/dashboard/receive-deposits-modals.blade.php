        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <form wire:submit.prevent="submitReceiveDeposits">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <input type="text" wire:model.defer="membershipNumber" id="membershipNumber" class="focus:ring-red-500 focus:border-red-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300" placeholder="Enter membership number, phone, or name">
                    ...
                    @if($verifiedMember)
                        ...
                        <div class="mb-4 p-4 bg-red-50 rounded-md border border-red-200">
                            <h4 class="text-sm font-medium text-red-900">Member Details</h4>
                            <p class="mt-1 text-sm text-red-800 font-medium">{{ $verifiedMember['name'] }}</p>
                            <p class="mt-1 text-sm text-red-700">Membership Type: {{ $verifiedMember['membership_type'] }}</p>
                            <p class="mt-1 text-sm text-red-700">Client Number: {{ $verifiedMember['client_number'] }}</p>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-1 relative">
                                ...
                                <input type="number" step="0.01" wire:model.defer="amount" id="amount" class="focus:ring-red-500 focus:border-red-500 block w-full pl-12 shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="0.00">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-1">
                                <textarea wire:model.defer="narration" id="narration" rows="3" class="focus:ring-red-500 focus:border-red-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Enter transaction narration (optional)"></textarea>
                            </div>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="submit" wire:loading.attr="disabled" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm disabled:opacity-50">
