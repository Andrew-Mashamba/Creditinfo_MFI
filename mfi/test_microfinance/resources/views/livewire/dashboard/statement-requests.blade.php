        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="p-4 bg-red-50 border border-red-200 rounded-lg">
                    <h4 class="font-medium text-red-900 mb-2">Balance Summary</h4>
                    <div class="space-y-1 text-sm">
                        <div class="flex justify-between">
                            <span class="text-red-700">Opening Balance:</span>
                            <span class="font-medium text-red-900">TZS {{ number_format($statementData['opening_balance'], 2) }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-red-700">Total Credits:</span>
                            <span class="font-medium text-red-900">TZS {{ number_format($statementData['total_credits'], 2) }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-red-700">Total Debits:</span>
                            <span class="font-medium text-red-900">TZS {{ number_format($statementData['total_debits'], 2) }}</span>
                        </div>
                        <div class="flex justify-between border-t border-red-200 pt-1">
                            <span class="text-red-700 font-medium">Closing Balance:</span>
                            <span class="font-bold text-red-900">TZS {{ number_format($statementData['closing_balance'], 2) }}</span>
                        </div>
                    </div>
                </div>
