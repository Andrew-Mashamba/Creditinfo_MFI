...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-red-900 mb-2">Accountant / Finance Officer Dashboard</h1>
            <p class="text-slate-600">Financial overview and transaction management</p>
        </div>
        <div class="flex space-x-3 mt-4 md:mt-0">
            <button wire:click="refreshData" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-800 transition-colors duration-200 flex items-center space-x-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="group bg-white rounded-2xl shadow-lg border border-slate-200 p-6 hover:shadow-xl transition-all duration-300">
            ...
            <p class="text-2xl font-bold text-red-900 mb-1">TZS {{ number_format($totalReceiptsToday) }}</p>
        ...
        <div class="group bg-white rounded-2xl shadow-lg border border-slate-200 p-6 hover:shadow-xl transition-all duration-300">
            ...
            <p class="text-2xl font-bold text-red-900 mb-1">TZS {{ number_format($cashbookBalance) }}</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
            <h4 class="text-lg font-bold text-red-900 mb-4">Recent Payments</h4>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
            <h4 class="text-lg font-bold text-red-900 mb-4">Unreconciled Entries</h4>
            <ul class="divide-y divide-slate-100">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
            <h4 class="text-lg font-bold text-red-900 mb-4">Pending Expense Claims</h4>
            <ul class="divide-y divide-slate-100">
                @foreach($pendingExpenseClaims as $claim)
                    <li class="py-2 flex flex-col">
                        <div class="flex items-center justify-between">
                            <span class="font-semibold text-slate-800">TZS {{ number_format($claim['amount']) }}</span>
                            <button wire:click="approveExpenseClaim({{ $claim['id'] }})" class="text-xs bg-red-100 text-red-700 px-2 py-1 rounded hover:bg-red-200 transition-colors">
                                Approve
                            </button>
                        </div>
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-2xl p-6 w-full max-w-md">
                ...
                <div class="flex space-x-3 mt-6">
                    <button wire:click="generateExport" class="flex-1 bg-red-600 text-white py-2 px-4 rounded-lg hover:bg-red-800 transition-colors">
                        Generate Export
                    </button>
