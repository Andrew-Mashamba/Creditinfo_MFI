            ...
            <div class="mb-4">
                ...
                <div class="flex gap-2">
                    ...
                    <button wire:click="verifyMembership" 
                            wire:loading.attr="disabled"
                            class="px-4 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 disabled:opacity-50">
            ...
            <div class="space-y-4">
                ...
                <div class="p-4 bg-red-50 border border-red-200 rounded-lg">
                    <div class="flex justify-between items-center">
                        <span class="text-red-800 font-medium">Current Balance</span>
                        <span class="text-2xl font-bold text-red-900">TZS {{ number_format($currentBalance, 2) }}</span>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="p-4 bg-red-50 border border-red-200 rounded-lg">
                <div class="text-center">
                    <p class="text-2xl font-bold text-red-900">{{ $todayTransactions }}</p>
                    <p class="text-red-800 text-sm font-medium">Today's Transactions</p>
                </div>
            </div>
