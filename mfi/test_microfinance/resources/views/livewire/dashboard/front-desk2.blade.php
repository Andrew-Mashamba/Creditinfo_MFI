<div class="w-full">
    ...
    <div class="w-full">
        ...
        <div class="w-full  metric-card   border bg-white  border-gray-200   rounded-lg p-4 shadow-lg">
            ...
            <div class="flex justify-between items-center w-full">
                ...
                <div class="inline-flex rounded-md shadow-sm" role="group">
                    ...
                    <button   wire:click="downloadPDFFile"  type="button" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-r-md hover:bg-gray-100 hover:text-red-700 focus:z-10 focus:ring-2 focus:ring-red-700 focus:text-red-700     ">
                        <svg class="w-3 h-3 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M14.707 7.793a1 1 0 0 0-1.414 0L11 10.086V1.5a1 1 0 0 0-2 0v8.586L6.707 7.793a1 1 0 1 0-1.414 1.414l4 4a1 1 0 0 0 1.416 0l4-4a1 1 0 0 0-.002-1.414Z"></path>
                            <path d="M18 12h-2.55l-2.975 2.975a3.5 3.5 0 0 1-4.95 0L4.55 12H2a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2Zm-3 5a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path>
                        </svg>
                    ...
                    <div class="container mx-auto px-1 py-6">
                        <div class="max-w-lg mx-auto bg-white shadow-md rounded-lg overflow-hidden">
                            <div class="px-1 py-4">
                                ...
                                <button wire:click="$toggle('enableCheque')" type="button" class="text-white justify-end item-end flex mt-4 bg-red-800 hover:bg-red-400 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 "> Close </button>
                    ...
                    @else
                        ...
                        <div class="flex justify-end w-auto">
                            <div wire:loading wire:target="process3">
                                <x-jet-button
                                    class="text-white bg-red-800 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 " disabled>
                        ...
                        <div class="flex justify-end w-auto">
                            <div wire:loading.remove wire:target="process3">
                                <x-jet-button wire:click="process3"
                                              class="text-white bg-red-800 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2  ">
                    ...
                    <div>
                        ...
                        <div class="flex justify-end w-auto">
                            <div wire:loading wire:target="process">
                                <button class="text-white bg-red-800 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 "
                                        disabled>
                                    <div class="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             class="animate-spin  h-5 w-5 mr-2 stroke-white-800"
                        ...
                        @if($this->member_number1 && DB::table('clients')->where('client_number',$this->member_number1)->exists())
                                                ...
                                                @if($this->loan_type_2 == "TopUp")
                                                    <div class="mt-3 p-3 bg-red-50 border border-red-200 rounded-lg">
                                                        <div class="flex items-start">
                                                            ...
                                                            <div>
                                                                <h6 class="text-sm font-semibold text-red-800">Top-Up Requirements</h6>
                                ...
                                @if($this->pay_method && $this->pay_method !== "tips_bank")
                                    <div class="mt-3 p-3 bg-red-50 border border-red-200 rounded-lg">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <h6 class="text-sm font-semibold text-red-800">
                            ...
                            <div class="flex justify-end mt-6">
                                <div wire:loading wire:target="LoanProcess">
                                    <button class="bg-red-800 hover:bg-red-400 text-white font-bold py-2 px-4 rounded-lg">
                                        <div class="flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div wire:loading.remove wire:target="LoanProcess">
                                    <x-jet-button wire:click="LoanProcess"
                                        class="bg-red-800 hover:bg-red-400 text-white font-bold py-2 px-4 rounded-lg">
        ...
        <div class="w-full flex gap-2">    
            ...
            <div class="w-1/3  metric-card   border @if($this->item == 4) bg-red-200 border-red-200   @else bg-white  border-gray-200  @endif rounded-lg p-4 ">
            ...
            <div class="w-1/3  metric-card   border @if($this->item == 5) bg-red-200 border-red-200   @else bg-white  border-gray-200  @endif rounded-lg p-4 ">
