...
<div>
    <div class="p-2">
                ...
                <div>
                    ...
                    <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                        <li class="flex items-center">
                            <svg class="w-3.5 h-3.5 mr-2 text-red-900 dark:text-red-900 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <li class="flex items-center">
                            ...
                            <span>
                                <span class="ml-2 bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400"> {{ $this->inactiveLoansCount }}</span>
                            </span>
        ...
        <div class="bg-white p-4 sm:p-6 overflow-x-auto  mb-2 rounded-lg">

{{--            @if (in_array( "Set loan parameters and interest rates" , session()->get('permission_items')))--}}

            <div class="grid grid-cols-4 gap-2 p-2">
                @php
                    $menuItems = [
                        ['id' => 2, 'label' => 'Loans in progress'],
                        ['id' => 3, 'label' => 'Loans committee'],
                        ['id' => 4, 'label' => 'Loans arrears'],
                        ['id' => 5, 'label' => 'Loans recovery'],
                        ['id' => 6, 'label' => ' Loans writer off'],
            ...
            @if ($this->tab_id == $menuItem['id']) bg-red-600 @else bg-gray-100 @endif
...
{{--            @endif--}}
            ...
            <div class="tab-pane fade " id="tabs-homeJustify"
                ...
                <div class="w-full flex items-center justify-center">
                    ...
                    @if(auth()->user()->branch == DB::table('branches')->where('name','HQ')->value('id') && auth()->user()->department == DB::table('departments')->where('department_name', 'MANAGEMENT')->value('id'))
                   <div class="flex gap-4">
                       <div class=" w-56 mb-6">
                           <label for="sortByBranch" class="block mb-2 dark:text-gray-400 space-x-2 text-sm  spacing-sm text-slate-600">
                               Sort by branch
                           </label>
                           <div class="relative ">
                       ...
                       <div class=" w-56 mb-6">
                           <label for="filterLoanOfficer" class="block mb-2 dark:text-gray-400 space-x-2 text-sm  spacing-sm text-slate-600">
                               Search Loan Officer
                           </label>
                           <div class="relative ">
                               <select wire:model.bounce="filterLoanOfficer" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                                   <option value="">select</option>
                                   @foreach(DB::table('employees')->get() as $employee)
                                       <option value={{ $employee->employee_number }} >{{ $employee->first_name.' '.$employee->last_name }}</option>
...
{{--            @if($this->tab_id == 1 )--}}
{{--                <livewire:loans.loan-application/>--}}
{{--            @endif--}}
                ...
                <div class="w-full bg-white  p-4">
                    ...
                    <div class="w-full">
                        ...
                        <div class="col-span-6 sm:col-span-4 mb-4">
                            ...
                            <select wire:model.bounce="parentLoansAccount" name="parentLoansAccount" id="parentLoansAccount" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                        ...
                        <div class="bg-gray-100 rounded px-6 rounded-lg shadow-sm  pt-4 pb-4 ">
                            ...
                            <div class="flex items-stretch">
                                ...
                                <div class="w-1/2 mr-2" >
                                    ...
                                    <select wire:model.bounce="member" name="member" id="member" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                                        <option tab_id value="">Select</option>
                                    ...
                                    <select wire:model.bounce="product" name="product" id="product" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                                        <option tab_id value="">Select</option>
                    ...
                    <div class="w-1/2 mr-2" >
                        ...
                        @if($this->product)
                            ...
                            <div class="flex justify-between">
                                ...
                                @php
                                            ...
                                            $institution_total_loans = App\Models\issured_loans::where('institution_id',Session::get('institution_id'))->sum('number_of_loans');
                                            $user_number_of_loans = App\Models\issured_loans::where('member',$this->member)->sum('number_of_loans');
                        ...
                        @if($this->number_of_loans)
                            <div class="flex justify-between">
                                ...
                                <p class="block mb-2 text-sm font-medium text-red-500 dark:text-gray-400">{{number_format($this->number_of_loans * $this->nominal_price,2)}}</p>
                            </div>
