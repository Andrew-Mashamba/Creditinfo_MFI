                ...
                <div class="flex flex-1 items-center justify-between">
                        ...
                        <div class="flex ">
                            <div class="flex space-x-4 pr-2">
                                ...
                                @else
                                <a href="#" wire:click="showTab('business')" class=" @if($this->activeTab == 'business') bg-red-500 text-white @endif  text-red-800 hover:bg-red-600 text-green-900  hover:text-white rounded-md px-3 py-2 text-sm font-medium">Business Information</a>
                                <a href="#" wire:click="showTab('collateral')" class=" @if($this->activeTab == 'collateral')bg-red-500 text-white @endif  text-dark-900
                                hover:bg-red-500 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Collateral Information</a>
                                @endif
