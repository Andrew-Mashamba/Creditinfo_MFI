    ...
    <div class="w-full flex gap-4">
        ...
        <div class="w-2/3 mx-auto bg-white p-6 shadow-md">
            ...
            <div class="text-center">
                <h2 class="text-lg font-bold uppercase">MFI Management System LTD</h2>
            ...
            <div class="mt-6">
                <table class="w-full text-left border-collapse text-sm">
                    ...
                    <tr>
                        <td colspan="1" class="bg-red-50 font-bold px-4 py-2 border">ASSETS</td>
                    ...
                    @foreach($asset_accounts as $income_account)
                        ...
                        <tr>
                            <td class="px-4 py-2 border">
                                <a  wire:click="setSubCode({{ $income_account->category_code }},'{{$income_account->category_name}}')" class="cursor-pointer text-red-600 hover:text-red-800 text-sm">
                    ...
                    <tr>
                        <td colspan="1" class="bg-red-50 font-bold px-4 py-2 border">LIABILITIES</td>
                        <td class="bg-red-50 font-bold px-4 py-2 border">DEBIT</td>
                        <td class="bg-red-50 font-bold px-4 py-2 border">CREDIT</td>
                    </tr>
                    @php
                    ...
                    @foreach($liability_accounts as $income_account)
                        ...
                        <tr>
                            <td class="px-4 py-2 border">
                                <a href="javascript:void(0);" onclick="scrollToCategory('{{ $income_account->category_name }}')" class="text-red-600 hover:text-red-800 text-sm">
                                    {{ ucwords(str_replace('_', ' ', $income_account->category_name)) }}
                                </a>
                            </td>
                            <td class="px-4 py-2 border text-right">
                    ...
                    <tr>
                        <td colspan="1" class="bg-red-50 font-bold px-4 py-2 border">EQUITY</td>
                        <td class="bg-red-50 font-bold px-4 py-2 border">DEBIT</td>
                        <td class="bg-red-50 font-bold px-4 py-2 border">CREDIT</td>
                    </tr>
                    @php
