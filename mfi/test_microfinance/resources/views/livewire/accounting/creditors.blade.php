    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div class="bg-red-50 dark:bg-red-600/20 rounded-lg p-4">
                    <div class="text-sm text-red-600 dark:text-red-400">Total Creditors</div>
                    <div class="text-2xl font-bold text-red-700 dark:text-red-300">{{ $statistics['total_creditors'] ?? 0 }}</div>
                </div>
        ...
        <div class="border-b border-gray-200 dark:border-gray-700 mb-6">
            <nav class="-mb-px flex space-x-8">
                <button wire:click="$set('activeTab', 'creditors')"
                    class="py-2 px-1 border-b-2 font-medium text-sm {{ $activeTab === 'creditors' ? 'border-red-500 text-red-600 dark:text-red-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400' }}">
                    Creditors
                </button>
                <button wire:click="$set('activeTab', 'transactions')"
                    class="py-2 px-1 border-b-2 font-medium text-sm {{ $activeTab === 'transactions' ? 'border-red-500 text-red-600 dark:text-red-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400' }}">
                    Transactions
                </button>
                <button wire:click="$set('activeTab', 'payments')"
                    class="py-2 px-1 border-b-2 font-medium text-sm {{ $activeTab === 'payments' ? 'border-red-500 text-red-600 dark:text-red-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400' }}">
                    Payments
                </button>
                <button wire:click="$set('activeTab', 'aging')"
                    class="py-2 px-1 border-b-2 font-medium text-sm {{ $activeTab === 'aging' ? 'border-red-500 text-red-600 dark:text-red-400' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400' }}">
                    Aging Analysis
                </button>
            </nav>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    ...
                                    <button wire:click="generateCreditorStatement({{ $creditor->id }})" 
                                        class="text-red-600 hover:text-red-900 dark:text-red-400">Statement</button>
                                </td>
                            </tr>
                            @empty
                            <tr>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                        {{ $transaction->type === 'invoice' ? 'bg-red-100 text-red-800' : 
