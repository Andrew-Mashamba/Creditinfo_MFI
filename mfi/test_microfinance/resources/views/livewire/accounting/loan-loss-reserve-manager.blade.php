                        ...
                        <table class="min-w-full">
                            ...
                            <tfoot>
                                <tr class="bg-gray-100 font-bold">
                                    ...
                                    <td class="px-4 py-3 text-sm text-center border-t-2 border-gray-300">-</td>
                                    <td class="px-4 py-3 text-sm text-right text-red-600 border-t-2 border-gray-300">{{ number_format($requiredReserve, 2) }}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <button type="button" 
                                        ...
                                        class="px-4 py-2 border {{ $percentage == 5 ? 'border-red-500 bg-red-50 text-red-700' : 'border-gray-300' }} rounded-lg text-sm font-medium">
                        ...
                        <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                            ...
                            <div class="space-y-1 text-sm">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium text-red-900">{{ number_format($reserve_amount, 2) }} TZS</span>
                                </div>
                                <div class="flex justify-between border-t border-red-200 pt-1 mt-1">
                                    ...
                                    <span class="font-bold text-red-900">{{ number_format($currentReserveBalance + $reserve_amount, 2) }} TZS</span>
                                </div>
                            </div>
                        </div>
