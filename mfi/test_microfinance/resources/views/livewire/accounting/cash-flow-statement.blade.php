<div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden text-xs">
    <div class="px-6 py-4">
        <h2 class="font-bold text-center mb-6">MFI Management System LTD</h2>
            ...
            @foreach(['operating', 'investing', 'financing'] as $section)
                ...
                <tr>
                    ...
                    <td class="border border-gray-300 px-6 py-3 text-center">
                        <button class="bg-red-500 text-white px-6 py-2 rounded-lg" wire:click="addRow('{{ $section }}')">Add Account</button>
                    </td>
                </tr>
