    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 mb-4">
        <div class="bg-red-600 text-white px-4 py-2 rounded-t-lg">
            <div class="flex items-center justify-between">
                ...
                <button wire:click="openModal" class="bg-white text-red-900 px-3 py-1 text-sm rounded-md hover:bg-red-50 transition-colors flex items-center space-x-1">
        ...
        <div class="grid grid-cols-4 gap-4 p-4">
            <div class="bg-red-50 rounded-lg p-3">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs text-red-600 font-medium">Active Instructions</p>
                        <p class="text-xl font-bold text-red-900">{{ $activeCount ?? 0 }}</p>
                    </div>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    <input type="text" wire:model.debounce.300ms="searchTerm" placeholder="Search instructions..." 
                           class="px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-red-500">
                    <select wire:model="statusFilter" class="px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-red-500">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-3 py-2 font-medium text-red-600">{{ $instruction->reference_number }}</td>
                        <td class="px-3 py-2">
                            <div>
                        ...
                        <td class="px-3 py-2 text-center">
                            <span class="px-2 py-1 text-xs rounded-full 
                                ...
                                @elseif($instruction->frequency == 'monthly') bg-red-100 text-red-700
                        ...
                        <td class="px-3 py-2">
                            <div class="flex items-center justify-center space-x-1">
                                <button wire:click="viewInstruction({{ $instruction->id }})" 
                                        class="p-1 text-red-600 hover:bg-red-50 rounded" title="View">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-4">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <div class="w-8 h-8 rounded-full {{ $currentStep >= 1 ? 'bg-red-600 text-white' : 'bg-gray-300 text-gray-600' }} flex items-center justify-center text-xs font-bold">1</div>
                                    <span class="ml-2 text-xs {{ $currentStep >= 1 ? 'text-red-900 font-semibold' : 'text-gray-500' }}">Source</span>
                                </div>
                                <div class="flex-1 h-0.5 mx-2 {{ $currentStep >= 2 ? 'bg-red-600' : 'bg-gray-300' }}"></div>
                                <div class="flex items-center">
                                    <div class="w-8 h-8 rounded-full {{ $currentStep >= 2 ? 'bg-red-600 text-white' : 'bg-gray-300 text-gray-600' }} flex items-center justify-center text-xs font-bold">2</div>
                                    <span class="ml-2 text-xs {{ $currentStep >= 2 ? 'text-red-900 font-semibold' : 'text-gray-500' }}">Destination</span>
                                </div>
                                <div class="flex-1 h-0.5 mx-2 {{ $currentStep >= 3 ? 'bg-red-600' : 'bg-gray-300' }}"></div>
                                <div class="flex items-center">
                                    <div class="w-8 h-8 rounded-full {{ $currentStep >= 3 ? 'bg-red-600 text-white' : 'bg-gray-300 text-gray-600' }} flex items-center justify-center text-xs font-bold">3</div>
                                    <span class="ml-2 text-xs {{ $currentStep >= 3 ? 'text-red-900 font-semibold' : 'text-gray-500' }}">Schedule</span>
                                </div>
                                <div class="flex-1 h-0.5 mx-2 {{ $currentStep >= 4 ? 'bg-red-600' : 'bg-gray-300' }}"></div>
                                <div class="flex items-center">
                                    <div class="w-8 h-8 rounded-full {{ $currentStep >= 4 ? 'bg-red-600 text-white' : 'bg-gray-300 text-gray-600' }} flex items-center justify-center text-xs font-bold">4</div>
                                    <span class="ml-2 text-xs {{ $currentStep >= 4 ? 'text-red-900 font-semibold' : 'text-gray-500' }}">Review</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select wire:model="source_account_type" class="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-red-500 focus:border-red-500">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" 
                                               ...
                                               class="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-red-500 focus:border-red-500">
                                ...
                                <div>
                                    ...
                                    <select wire:model="source_account_id" class="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-red-500 focus:border-red-500">
                                ...
                                <div>
                                    ...
                                    <select wire:model="source_bank_id" class="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-red-500 focus:border-red-500">
                            ...
                            <div class="bg-red-50 rounded-lg p-3">
                                <h5 class="text-xs font-semibold text-red-900 mb-2">Selected Account Details</h5>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select wire:model="destination_type" class="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-red-500 focus:border-red-500">
                                        <option value="">Select Type</option>
                                        <option value="member">Member Account</option>
                                        <option value="internal">Internal Account</option>
                                ...
                                <div>
                                    ...
                                    <select wire:model="destination_account_id" class="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-red-500 focus:border-red-500">
                                        <option value="">Select Account</option>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" wire:model="amount" step="0.01"
                                               class="w-full pl-12 pr-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-red-500 focus:border-red-500"
                                               placeholder="0.00">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <select wire:model="frequency" class="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-red-500 focus:border-red-500">
                                ...
                                <div>
                                    ...
                                    <select wire:model="day_of_week" class="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-red-500 focus:border-red-500">
                                ...
                                <div>
                                    ...
                                    <select wire:model="day_of_month" class="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-red-500 focus:border-red-500">
                                        <option value="">Select Day</option>
                                        @for($i = 1; $i <= 28; $i++)
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 space-y-3">
                                <div class="grid grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium text-lg text-red-900">TZS {{ number_format($amount, 2) }}</p>
                                    </div>
                                    <div>
                            ...
                            <div class="bg-red-50 border border-red-200 rounded-lg p-3">
                                <div class="flex items-start">
                                    ...
                                    <div class="text-xs">
                                        <p class="font-semibold text-red-900 mb-1">Important Information</p>
                    ...
                    <div class="bg-gray-50 px-4 py-3 flex items-center justify-between rounded-b-lg">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button type="button" wire:click="nextStep" 
                                    class="px-3 py-1.5 text-sm text-white bg-red-600 rounded-md hover:bg-red-800">
                                Next
                            </button>
                            @else
                            <button type="submit" 
