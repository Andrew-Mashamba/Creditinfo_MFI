                ...
                <div class="bg-red-600 text-white rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xs text-red-200">Period Result</p>
                        </div>
            ...
            <div class="flex items-center">
                @if($accountSummary['metrics']['accounting_equation_check'])
                    <div class="flex items-center text-sm">
                        <svg class="w-5 h-5 text-red-900 mr-2" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <span class="ml-3 px-2 py-1 bg-red-50 text-red-900 text-xs font-medium rounded">BALANCED</span>
                    </div>
                @else
                    <div class="flex items-center text-sm">
        ...
        <div class="flex justify-between items-start mb-4">
            <div>
                ...
                <div class="flex items-center mt-2 text-xs text-gray-500 space-x-4">
                    ...
                    <div class="flex items-center">
                        <span class="inline-block w-2 h-2 bg-red-700 rounded-full mr-1"></span>
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="text-sm">
                    @if($trialBalance['totals']['is_balanced'])
                        <span class="px-3 py-1 bg-red-50 text-red-900 rounded text-xs font-medium">
                        ...
                        <form wire:submit.prevent="createAccount" class="mt-4 space-y-4">
                            ...
                            <div class="flex justify-end space-x-3 pt-4 border-t">
                                ...
                                <button type="submit"
                                    ...
                                    class="px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
