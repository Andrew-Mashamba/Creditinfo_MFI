<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl p-6 border border-gray-200">
        <div class="flex items-center justify-between mb-6">
            ...
            <button wire:click="showForm" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors">
            ...
            <div class="bg-white rounded-xl p-6 mx-4 overflow-y-auto" style="width: 80%; height: 90vh;">
                ...
                <form wire:submit.prevent="submitJournalEntry" class="space-y-4">
                                            ...
                                            <td class="px-4 py-2">
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        value="{{ $displayValue }}"
                                                        class="w-full border border-gray-300 rounded px-2 py-1 text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                                        autocomplete="off">
                                                            ...
                                                            <div class="absolute z-50 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-96 overflow-y-auto">
                                                                @foreach($filteredAccounts as $account)
                                                                    <button type="button"
                                                                            ...
                                                                            class="w-full text-left px-3 py-2 hover:bg-red-50 cursor-pointer border-b border-gray-100 last:border-0 transition-colors disabled:opacity-50">
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t">
                        ...
                        <button type="submit" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @foreach($selectedJournalEntryLines as $line)
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-sm text-right {{ $line->credit > 0 ? 'font-semibold text-red-600' : 'text-gray-400' }}">
                        ...
                        <tfoot class="bg-gray-50">
                            <tr>
                                ...
                                <td class="px-4 py-3 font-bold text-sm text-right text-red-600">{{ number_format($totalCredit, 2) }}</td>
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-xl p-6 w-full max-w-md mx-4">
                ...
                <div class="flex space-x-3">
                    ...
                    <button wire:click="postJournalEntry" class="flex-1 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-2">
                    <input type="date" wire:model="filterDateFrom" class="border border-gray-300 rounded-lg px-3 py-1 text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500">
                    <input type="date" wire:model="filterDateTo" class="border border-gray-300 rounded-lg px-3 py-1 text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500">
                    <input type="text" wire:model.debounce.300ms="searchTerm" placeholder="Search by reference or description..."
                           class="border border-gray-300 rounded-lg px-3 py-1 text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 w-64">
                </div>
            </div>
        </div>
