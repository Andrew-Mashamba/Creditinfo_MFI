    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                            ...
                            <form wire:submit.prevent="saveCreateTill">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model="newTill.name" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500" placeholder="e.g., Main Till, Counter 1">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model="newTill.till_number" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500" placeholder="e.g., TIL001, CT001">
                                        @error('newTill.till_number') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                    </div>
                                    
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Branch *</label>
                                        <select wire:model="newTill.branch_id" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="newTill.institution_id" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" wire:model="newTill.maximum_limit" step="0.01" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500" placeholder="500000.00">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" wire:model="newTill.minimum_limit" step="0.01" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500" placeholder="10000.00">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="newTill.status" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                            ...
                            @error('newTill.parent_account') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                    ...
                                    <div>
                                        <label class="flex items-center">
                                            <input type="checkbox" wire:model="newTill.requires_supervisor_approval" class="rounded border-gray-300 text-red-600 shadow-sm focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <textarea wire:model="newTill.description" rows="3" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500" placeholder="Enter till description, location, or special instructions..."></textarea>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button wire:click="saveCreateTill" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">
                    Create Till
                </button>
...
<div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                            ...
                            <form wire:submit.prevent="saveTillOperation">
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <select wire:model="selectedTillId" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="tillOperationType" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" wire:model="tillOperationAmount" step="0.01" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500" placeholder="0.00">
                                    ...
                                    <div>
                                        ...
                                        <textarea wire:model="tillOperationNotes" rows="3" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500" placeholder="Enter reference or notes..."></textarea>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button wire:click="saveTillOperation" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">
                    Save Operation
                </button>
...
<div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                        ...
                        <div class="mt-4">
                            <form wire:submit.prevent="submitDepositRequest">
                                <div class="space-y-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Till</label>
                                        <select wire:model="depositTillId" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                            <option value="">Select Till</option>
                                            @foreach($userTills as $till)
                                    ...
                                    <div>
                                        ...
                                        <input type="number" wire:model="depositAmount" step="0.01" min="0" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500" placeholder="0.00">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="depositReason" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                            <option value="">Select Reason</option>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Additional Notes</label>
                                        <textarea wire:model="depositNotes" rows="3" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500" placeholder="Provide additional details..."></textarea>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button wire:click="submitDepositRequest" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">
                    Submit Request
                </button>
                        ...
                        <div class="bg-green-50 rounded-lg p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-sm font-medium {{ $selectedVault->requires_dual_approval ? 'text-red-600' : 'text-gray-600' }}">
                                        {{ $selectedVault->requires_dual_approval ? 'Required' : 'Not Required' }}
                                    </span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">Alerts:</span>
                                    <span class="text-sm font-medium {{ $selectedVault->send_alerts ? 'text-red-600' : 'text-gray-600' }}">
                            ...
                            <div class="space-y-2 max-h-48 overflow-y-auto">
                                @forelse($selectedVault->recentActivity ?? [] as $activity)
                                    <div class="flex items-center justify-between p-2 bg-white rounded">
                                        ...
                                        <span class="text-sm font-medium {{ $activity->type === 'deposit' ? 'text-green-600' : 'text-red-600' }}">
...
<div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                        ...
                        <div class="mt-4">
                            <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                                <div class="flex">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-medium text-red-800">Transfer Funds to Vault</h4>
                                        <p class="text-sm text-red-700 mt-1">
                            ...
                            <form wire:submit.prevent="processBankToVaultTransfer">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="bankToVaultTransfer.vault_id" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="bankToVaultTransfer.bank_account_id" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <select wire:model="bankToVaultTransfer.authorizer_id" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                            <option value="">Select Authorizer</option>
                                            @foreach($availableAuthorizers ?? [] as $authorizer)
                                                <option value="{{ $authorizer->id }}">{{ $authorizer->name }} ({{ $authorizer->role }})</option>
                                            @endforeach
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button wire:click="processBankToVaultTransfer" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">
                    Process Transfer
                </button>
