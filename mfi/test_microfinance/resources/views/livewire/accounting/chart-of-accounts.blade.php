    ...
    <div class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-40">
        <div class="px-6 py-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <nav class="hidden md:flex items-center space-x-2 text-sm">
                        ...
                        <button wire:click="resetNavigation" 
                                class="breadcrumb-item text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300">
                            Dashboard
                        </button>
                        @if($showAccountTable)
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               ...
                               class="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg leading-5 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-red-500 focus:border-red-500 transition-colors duration-200">
                        @if($globalSearch)
                    ...
                    <div class="flex items-center space-x-2">
                        <button wire:click="exportAccounts" 
                                class="inline-flex items-center px-3 py-2 border border-gray-300 dark:border-gray-600 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200">
            ...
            @if($globalSearch && $searchResults)
                <div class="mt-4 p-3 bg-red-50 dark:bg-red-600 rounded-lg">
    ...
    @if($loading)
        <div class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white dark:bg-gray-800 rounded-lg p-6 flex items-center space-x-3">
                <svg class="loading-spinner w-6 h-6 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid gap-4 grid-cols-1 sm:grid-cols-3">
            ...
            <div class="metric-card bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer" 
                ...
                <div class="flex justify-between items-start mb-4">
                    ...
                    <div class="p-2 rounded-lg bg-red-100 dark:bg-red-600">
            ...
            <div class="metric-card bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer"
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-lg font-semibold text-red-600 dark:text-red-400">{{ number_format($assetStats['balance'] ?? 0, 2) }} TZS</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Active</span>
                ...
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="px-3 py-1 text-sm font-medium bg-red-100 dark:bg-red-600 text-red-800 dark:text-red-200 rounded-full">
                                {{ count($level2Accounts) }} accounts
                            </span>
                        </div>
                        <div class="flex items-center space-x-3">
                            <button wire:click="showCreateAccountModal" 
                                    class="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-lg text-red-700 bg-red-100 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mt-4 space-y-4">
                        ...
                        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-3 lg:space-y-0">
                            <div class="flex-1 max-w-md">
                                <div class="relative">
                                    ...
                                    <input type="text" 
                                           ...
                                           class="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg leading-5 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500 transition-colors duration-200">
                                </div>
                            </div>
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <select wire:model="statusFilter" 
                                        class="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500 transition-colors duration-200">
                        ...
                        @if($tableSearch || $statusFilter || $balanceFilter)
                            <div class="flex flex-wrap items-center space-x-2">
                                ...
                                @if($tableSearch)
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-red-100 dark:bg-red-600 text-red-800 dark:text-red-200">
                                        Search: "{{ $tableSearch }}"
                                        <button wire:click="$set('tableSearch', '')" class="ml-1 hover:text-red-600">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-8 w-8">
                                                <div class="h-8 w-8 rounded-full bg-red-100 dark:bg-red-600 flex items-center justify-center">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white font-mono">
                                        @if($tableSearch)
                                            ...
                                            {!! str_ireplace(
                                                e($tableSearch),
                                                '<span class="search-highlight">' . e($tableSearch) . '</span>',
                                                e($account->account_number ?? 'No number')
                                            ) !!}
                                        @else
                                                    ...
                                                    <div class="py-1">
                                                        ...
                                                        @if($account->status === 'ACTIVE')
                                                            <button wire:click.stop="deleteOrDeactivateAccount({{ $account->id }})" 
                                                                    class="flex items-center w-full px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-600">
                                                                <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                        ...
                                        @if($tableSearch || $statusFilter || $balanceFilter)
                                            <button wire:click="clearTableFilters" 
                                                    class="mt-3 inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-red-700 bg-red-100 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200">
                                                Clear all filters
                                            </button>
                                        @endif
                                    </td>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <button wire:click="showCreateLevel3Account()" 
                                    class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-600 text-white text-sm font-medium rounded-md transition-colors duration-200">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex items-center justify-center space-x-2">
                                            ...
                                            <button wire:click="downloadAccountStatement({{ $account->id }})" 
                                                    class="text-indigo-500 hover:text-red-900 transition-colors duration-200" 
        ...
        @if($showAccountTable && count($level2Accounts) === 0)
            <div class="bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-8">
                <div class="text-center">
                    ...
                    <div class="mt-6">
                        <button wire:click="showCreateAccountModal" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 mr-3">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                            </svg>
            ...
            <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50" id="createAccountModal">
                <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
                    <div class="mt-3">
                        ...
                        @if($parentAccount)
                            <div class="mb-4 p-3 bg-red-50 dark:bg-red-600 rounded-lg">
                        ...
                        <form wire:submit.prevent="createNewAccount">
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" id="accountName" wire:model="accountName"
                                        class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:text-white"
                                        placeholder="Enter account name">
                                    @error('accountName') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                                </div>
                                
                                <div class="p-3 bg-red-50 dark:bg-red-600 rounded-lg">
                                    <p class="text-sm text-red-800 dark:text-red-200">
                            ...
                            <div class="flex items-center justify-end space-x-3 mt-6">
                                ...
                                <button type="submit"
                                    class="px-4 py-2 text-sm font-medium text-white bg-red-600 border border-transparent rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                    Create Account
                                </button>
                            </div>
                        </form>
                    ...
                    <div class="mt-3">
                        ...
                        @if($statementAccount)
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                                <div class="bg-red-50 dark:bg-red-600 p-4 rounded-lg">
                                    <h4 class="text-sm font-medium text-red-800 dark:text-red-200">Current Balance</h4>
                                    <p class="text-2xl font-bold text-red-900 dark:text-gray-500">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
                                    <div>
                                        ...
                                        <input type="date" wire:model="statementFilters.date_from" 
                                               class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500 dark:bg-gray-600 dark:text-white">
                                    </div>
                                    <div>
                                ...
                                <div class="flex space-x-3 mt-4">
                                    <button wire:click="applyStatementFilters" 
                                            class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500">
                                        Apply Filters
                                    </button>
                ...
                <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
                    <div class="mt-3">
                        ...
                        @if($level2ParentAccount)
                            <div class="mb-4 p-3 bg-red-50 dark:bg-red-600 rounded-md">
                                <p class="text-sm text-red-800 dark:text-red-200">
                        ...
                        <div class="flex items-center justify-end space-x-3">
                            ...
                            <button wire:click="createLevel3Account" 
                                    class="px-4 py-2 text-sm font-medium text-white bg-red-600 border border-transparent rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200">
                                Create Account
                            </button>
                        </div>
                    </div>
