                 ...
                 @if(DB::table('clients')->where('id',session()->get('viewClientId_details'))->value('member_status')=="EXIT MEMBER")
                         @if($this->declineEndClientship)
                             ...
                             <div class="flex justify-end" row="6">
                                 ...
                                 <div class="">
                                     <button wire:click="declineEndClientship({{session()->get('viewClientId_details')}})" class=" p-2 m-4 mt-n2 bg-red-600 hover:bg-red-800 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                         Confirm
                                     </button>
                                 </div>
                             </div>
                   ...
                   <div class="space-x-4 p-4 flex justify-end items-end">
                       ...
                       <livewire:accounting.exit-member-action id="{{session()->get('viewClientId_details')}}" />
                        ...
                        <div class="justify-end  text-right  ">
                            ...
                            <button  wire:click="declineEndClientshipModal" class=" mt-n2 bg-red-600 hover:bg-red-800 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                Decline
                            </button>

                            <button wire:click="exitClient({{session()->get('viewClientId_details')}})" class=" mt-n2 bg-red-600 hover:bg-red-800 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                Confirm
                            </button>
                            @endif
                        </div>
