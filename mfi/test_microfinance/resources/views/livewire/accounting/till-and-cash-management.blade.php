                    ...
                    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-xs text-red-600">Currently Active</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                            {{ $userRole === 'admin' ? 'bg-purple-100 text-purple-800' : 
                               ($userRole === 'supervisor' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800') }}">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="p-8">
                        ...
                        <div wire:loading wire:target="$set('activeTab')" >
                            <div class="text-center min-h-[400px] flex items-center justify-center">
                                <svg class="w-12 h-12 text-red-600 animate-spin mx-auto mb-4" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
