    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 mb-4">
        <div class="bg-red-600 text-white px-4 py-2 rounded-t-lg">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    <button wire:click="exportPDF" class="bg-white text-red-900 px-3 py-1 text-sm rounded-md hover:bg-red-50 transition-colors flex items-center space-x-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <span>Export PDF</span>
                    </button>
                    <button wire:click="exportExcel" class="bg-white text-red-900 px-3 py-1 text-sm rounded-md hover:bg-red-50 transition-colors flex items-center space-x-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-4 border-b border-gray-200">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                <div>
                    ...
                    <select wire:model="selectedAccount" class="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-red-500 focus:border-red-500">
                ...
                <div>
                    ...
                    <select wire:model="transactionType" class="w-full px-2 py-1.5 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-red-500 focus:border-red-500">
            ...
            <div class="flex justify-between items-center mt-3">
                <div class="flex space-x-2">
                    <button wire:click="applyFilters" class="bg-red-600 text-white px-3 py-1 text-sm rounded-md hover:bg-red-800 transition-colors">
                        Apply Filters
                    </button>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 @if($loop->even) bg-gray-50/30 @endif">
                        ...
                        <td class="px-3 py-2">
                            <p class="text-sm font-medium text-red-600">{{ $transaction->reference_number }}</p>
                    ...
                    <tr class="bg-red-100 font-semibold">
                        ...
                        <td class="px-3 py-2 text-sm text-right text-red-900">{{ number_format($closingBalance, 2) }}</td>
                    </tr>
                    @endif
                </tbody>
            </table>
        ...
        <div class="px-4 py-3 bg-gray-50 border-t border-gray-200">
            <div class="grid grid-cols-2 md:grid-cols-5 gap-3 text-sm">
                ...
                <div>
                    ...
                    <p class="font-semibold text-red-900">{{ number_format($closingBalance, 2) }}</p>
                </div>
            </div>
        </div>
        @endif
