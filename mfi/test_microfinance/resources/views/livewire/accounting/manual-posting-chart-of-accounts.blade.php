        ...
        <div class="rounded-md p-4 bg-white w-full">
            ...
            <div class="grid gap-2 mb-2 grid-cols-3 w-full">
                <div>
                    ...
                    <input wire:model="amount" type="number" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-red-500
                            focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500
                            dark:focus:border-red-500" placeholder="" required />
                </div>
                <div>
                    <label class="block mb-2 text-xs font-medium text-gray-900 dark:text-white">Narration</label>
                    <input wire:model="narration" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-red-500
                            focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500
                            dark:focus:border-red-500" placeholder="" required />
                </div>
                <div >
                    ...
                    <div class="flex justify-end mt-4">
                        <div wire:loading wire:target="post">
                            <button class="text-white bg-red-400 hover:bg-red-400 font-medium rounded-lg text-sm px-4 py-2" disabled>
                        ...
                        <button wire:loading.remove wire:click="post" class="text-white bg-red-600 hover:bg-red-800 font-medium rounded-lg text-sm px-4 py-2">
                            Post Transaction
                        </button>
                    </div>
