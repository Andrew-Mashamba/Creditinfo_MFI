                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($payables as $payable)
                                ...
                                @endphp
                                <tr class="{{ $isOverdue ? 'bg-red-50' : ($payable->is_system ?? false ? 'bg-red-50' : '') }}">
                                    @if($batchPaymentMode)
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        ...
                                        @if($payable->system_code ?? false)
                                            <span class="text-xs text-red-600">Service: {{ $payable->system_code }}</span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        @php
                                            ...
                                            $typeColors = [
                                                ...
                                                'installment' => 'bg-red-100 text-red-800',
                                        ...
                                        <div class="flex justify-end gap-2">
                                            @if($payable->is_system ?? false)
                                                ...
                                                @if(!$isMandatory)
                                                    ...
                                                    @else
                                                        <button wire:click="toggleSystemPayable({{ $payable->id }})" 
                                                            class="text-red-600 hover:text-red-900">Enable</button>
                                                    @endif
                                                @else
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse($notifications as $notification)
                                        <tr class="{{ !$notification['is_read'] ? 'bg-red-50' : '' }}">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                        ...
                        <form wire:submit.prevent="save">
                            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    @if($payable_type === 'installment')
                                        <div class="col-span-2 mt-4 p-4 bg-red-50 rounded-lg border border-red-200">
                                            <h4 class="text-sm font-medium text-red-900 mb-3">Installment Configuration</h4>
                                            <div class="grid grid-cols-2 gap-4">
                                                <div>
                            ...
                            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                ...
                                @if($payable)
                                    <div class="mb-4 p-4 bg-red-50 rounded-lg border border-red-200">
                                        <h4 class="text-sm font-semibold text-red-900 mb-2">Vendor Information</h4>
                                        ...
                                        @if($payable->vendor_bank_name || $payable->vendor_bank_account_number)
                                            <h4 class="text-sm font-semibold text-red-900 mt-3 mb-2">Bank Details for Transfer</h4>
                                            <div class="grid grid-cols-1 gap-2 text-sm">
