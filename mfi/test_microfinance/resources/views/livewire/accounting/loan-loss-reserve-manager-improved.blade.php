<div class="bg-white rounded-lg shadow-sm">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="grid grid-cols-2 gap-4 text-right">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-red-600">Stage {{ $this->getECLStage() }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="border-b border-gray-200 px-6">
        <nav class="-mb-px flex space-x-8">
            <button wire:click="changeViewMode('dashboard')" 
                    class="py-2 px-1 border-b-2 {{ $viewMode === 'dashboard' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} font-medium text-sm">
            ...
            <button wire:click="changeViewMode('provision')" 
                    class="py-2 px-1 border-b-2 {{ $viewMode === 'provision' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} font-medium text-sm">
                <div class="flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button wire:click="changeViewMode('writeoff')" 
                    class="py-2 px-1 border-b-2 {{ $viewMode === 'writeoff' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} font-medium text-sm">
                <div class="flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button wire:click="changeViewMode('recovery')" 
                    class="py-2 px-1 border-b-2 {{ $viewMode === 'recovery' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} font-medium text-sm">
                <div class="flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button wire:click="changeViewMode('history')" 
                    class="py-2 px-1 border-b-2 {{ $viewMode === 'history' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} font-medium text-sm">
                <div class="flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button wire:click="changeViewMode('analytics')" 
                    class="py-2 px-1 border-b-2 {{ $viewMode === 'analytics' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} font-medium text-sm">
                <div class="flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                    </svg>
            ...
            <button wire:click="changeViewMode('monitoring')" 
                    class="py-2 px-1 border-b-2 {{ $viewMode === 'monitoring' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} font-medium text-sm">
                <div class="flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button wire:click="changeViewMode('reports')" 
                    class="py-2 px-1 border-b-2 {{ $viewMode === 'reports' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} font-medium text-sm">
                <div class="flex items-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-red-50 rounded-lg p-4">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <p class="text-sm text-red-600 font-medium">Loan Portfolio</p>
                    <p class="text-2xl font-bold text-red-900">{{ number_format($loanPortfolioValue, 2) }}</p>
    ...
    <div class="mt-6">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @php
                        $categories = [
                            'current' => ['name' => 'Standard', 'days' => '0-30 days', 'color' => 'green'],
                            'watch' => ['name' => 'Watch', 'days' => '31-90 days', 'color' => 'yellow'],
                            'substandard' => ['name' => 'Substandard', 'days' => '91-180 days', 'color' => 'orange'],
                            'doubtful' => ['name' => 'Doubtful', 'days' => '181-365 days', 'color' => 'red'],
                            'loss' => ['name' => 'Loss', 'days' => '>365 days', 'color' => 'purple']
                        ];
                        $totalOutstanding = 0;
                        $totalProvision = 0;
                    @endphp
                    ...
                    @foreach($categories as $key => $category)
                        @php
                            ...
                            $portfolioPercentage = $loanPortfolioValue > 0 ? ($data['amount'] / $loanPortfolioValue) * 100 : 0;
                        @endphp
                        <tr class="{{ $data['count'] > 0 ? 'hover:bg-gray-50' : 'bg-gray-50' }} transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center space-x-2">
                                    ...
                                    @if($portfolioPercentage > 0)
                                        <span class="text-xs text-gray-500">({{ number_format($portfolioPercentage, 1) }}%)</span>
                                    @endif
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $category['days'] }}</div>
                                @if($data['amount'] > 0)
                                    <div class="mt-1 w-full bg-gray-200 rounded-full h-1.5">
                                        <div class="bg-{{ $category['color'] }}-500 h-1.5 rounded-full" style="width: {{ min(100, $portfolioPercentage * 2) }}%"></div>
                                    </div>
                                @endif
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-right">
                                <span class="font-semibold {{ $data['count'] > 0 ? 'text-gray-900' : 'text-gray-400' }}">
                                    {{ $data['count'] }}
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-right">
                                <span class="font-semibold {{ $data['amount'] > 0 ? 'text-gray-900' : 'text-gray-400' }}">
                                    {{ number_format($data['amount'], 2) }}
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-right">
                                <span class="inline-flex items-center px-2 py-1 rounded-md bg-{{ $category['color'] }}-50 text-{{ $category['color'] }}-700">
                                    {{ $data['provision_rate'] }}%
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-right">
                                <span class="font-bold {{ $data['required_provision'] > 0 ? 'text-gray-900' : 'text-gray-400' }}">
                    ...
                    <!-- Total Row -->
                    <tr class="bg-red-50 border-t-2 border-red-300 font-bold">
                        <td colspan="2" class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center space-x-2">
                                <svg class="w-4 h-4 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                </svg>
                                <span class="text-sm text-red-900">TOTAL PORTFOLIO</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-red-900 text-right">
                            {{ array_sum(array_column($loanAging, 'count')) }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-red-900 text-right">
                            {{ number_format($totalOutstanding, 2) }} TZS
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-red-900 text-right">
                            <span class="inline-flex items-center px-2 py-1 rounded-md bg-red-100">
                                {{ $totalOutstanding > 0 ? number_format(($totalProvision / $totalOutstanding) * 100, 2) : '0.00' }}%
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-red-900 text-right">
                            <span class="text-base">{{ number_format($totalProvision, 2) }} TZS</span>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="mt-4 bg-red-50 border border-red-200 rounded-lg p-4">
            <h4 class="text-sm font-medium text-red-900 mb-2">IFRS 9 ECL Provision Rates Applied:</h4>
            <div class="grid grid-cols-5 gap-4 text-xs">
                <div class="text-center">
                    <span class="block font-medium text-green-700">Standard (0-30)</span>
                    <span class="text-green-600">1%</span>
                </div>
                <div class="text-center">
                    <span class="block font-medium text-yellow-700">Watch (31-90)</span>
                    <span class="text-yellow-600">5%</span>
                </div>
                <div class="text-center">
                    <span class="block font-medium text-orange-700">Substandard (91-180)</span>
                    <span class="text-orange-600">25%</span>
                </div>
                <div class="text-center">
                    <span class="block font-medium text-red-700">Doubtful (181-365)</span>
                    <span class="text-red-600">50%</span>
                </div>
                <div class="text-center">
                    <span class="block font-medium text-purple-700">Loss (>365)</span>
        ...
        @php
            $performingLoans = ($loanAging['current']['count'] ?? 0);
            $nonPerformingLoans = ($loanAging['watch']['count'] ?? 0) +
                                  ($loanAging['substandard']['count'] ?? 0) +
                                  ($loanAging['doubtful']['count'] ?? 0) +
                                  ($loanAging['loss']['count'] ?? 0);
            $totalLoans = $performingLoans + $nonPerformingLoans;
            $nplRatio = $totalLoans > 0 ? ($nonPerformingLoans / $totalLoans) * 100 : 0;

            $performingAmount = ($loanAging['current']['amount'] ?? 0);
            $nonPerformingAmount = ($loanAging['watch']['amount'] ?? 0) +
                                   ($loanAging['substandard']['amount'] ?? 0) +
                                   ($loanAging['doubtful']['amount'] ?? 0) +
                                   ($loanAging['loss']['amount'] ?? 0);
            $nplRatioAmount = $loanPortfolioValue > 0 ? ($nonPerformingAmount / $loanPortfolioValue) * 100 : 0;
        @endphp
        ...
        <div class="mt-4 grid grid-cols-4 gap-4">
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-xs font-medium text-green-700">Performing Loans</span>
                    <svg class="w-4 h-4 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                    </svg>
                </div>
                <div class="text-2xl font-bold text-green-900">{{ $performingLoans }}</div>
                <div class="text-xs text-green-600 mt-1">{{ number_format($performingAmount, 0) }} TZS</div>
            </div>

            <!-- Non-Performing Loans -->
            <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-xs font-medium text-red-700">Non-Performing</span>
                    <svg class="w-4 h-4 text-red-600" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
                    </svg>
                </div>
                <div class="text-2xl font-bold text-red-900">{{ $nonPerformingLoans }}</div>
                <div class="text-xs text-red-600 mt-1">{{ number_format($nonPerformingAmount, 0) }} TZS</div>
            </div>

            <!-- NPL Ratio (Count) -->
            <div class="bg-orange-50 border border-orange-200 rounded-lg p-4">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-xs font-medium text-orange-700">NPL Ratio (Count)</span>
                    <svg class="w-4 h-4 text-orange-600" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                    </svg>
                </div>
                <div class="text-2xl font-bold {{ $nplRatio > 5 ? 'text-red-900' : ($nplRatio > 3 ? 'text-orange-900' : 'text-green-900') }}">
                    {{ number_format($nplRatio, 1) }}%
                </div>
                <div class="text-xs text-orange-600 mt-1">Target: < 5%</div>
            </div>

            <!-- NPL Ratio (Amount) -->
            <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-xs font-medium text-purple-700">NPL Ratio (Value)</span>
                ...
                <div class="text-2xl font-bold {{ $nplRatioAmount > 5 ? 'text-red-900' : ($nplRatioAmount > 3 ? 'text-orange-900' : 'text-green-900') }}">
                    {{ number_format($nplRatioAmount, 1) }}%
                </div>
                <div class="text-xs text-purple-600 mt-1">of portfolio value</div>
            </div>
        </div>
    </div>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                        <h4 class="text-sm font-medium text-red-900 mb-2">Recommended Provision (Based on Loan Schedules Analysis)</h4>
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                <span class="text-red-700">Overdue Installments Total:</span>
                                <span class="font-medium text-red-900 float-right">{{ number_format($this->getOverdueInstallmentsTotal(), 2) }} TZS</span>
                            </div>
                            <div>
                                <span class="text-red-700">Expected Loss (ECL Model):</span>
                                <span class="font-medium text-red-900 float-right">{{ number_format($requiredReserve, 2) }} TZS</span>
                            </div>
                            <div>
                                <span class="text-red-700">Current Reserve:</span>
                                <span class="font-medium text-red-900 float-right">{{ number_format($currentReserveBalance, 2) }} TZS</span>
                            </div>
                            <div>
                                <span class="text-red-700 font-semibold">Minimum Provision Needed:</span>
                                <span class="font-bold text-red-900 float-right">{{ number_format((float)$provisionGap, 2) }} TZS</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <button type="button" 
                                        ...
                                        class="px-4 py-2 border {{ $provisionMethod == 'ecl' ? 'border-red-500 bg-red-50 text-red-700' : 'border-gray-300' }} rounded-lg text-sm font-medium">
                                    ECL Model (IFRS 9)
                                </button>
                                <button type="button"
                                        wire:click="setProvisionMethod('aging')"
                                        class="px-4 py-2 border {{ $provisionMethod == 'aging' ? 'border-red-500 bg-red-50 text-red-700' : 'border-gray-300' }} rounded-lg text-sm font-medium">
                                    Aging Based
                                </button>
                                <button type="button"
                                        wire:click="setProvisionMethod('manual')"
                                        class="px-4 py-2 border {{ $provisionMethod == 'manual' ? 'border-red-500 bg-red-50 text-red-700' : 'border-gray-300' }} rounded-lg text-sm font-medium">
                                    Manual (% of Profits)
                                </button>
                            </div>
                        </div>
                        ...
                        <!-- Summary Box -->
                        <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                            <h4 class="text-sm font-medium text-red-900 mb-2">Provision Summary</h4>
                            <div class="space-y-1 text-sm">
                                <div class="flex justify-between">
                                    <span class="text-red-700">Current Reserve Balance:</span>
                                    <span class="font-medium text-red-900">{{ number_format($currentReserveBalance, 2) }} TZS</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-red-700">New Provision Amount:</span>
                                    <span class="font-medium text-red-900">{{ number_format((float)$reserve_amount, 2) }} TZS</span>
                                </div>
                                <div class="flex justify-between border-t border-red-200 pt-1 mt-1">
                                    <span class="text-red-700 font-medium">New Reserve Balance:</span>
                                    <span class="font-bold text-red-900">{{ number_format($currentReserveBalance + (float)$reserve_amount, 2) }} TZS</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-red-700">Coverage Ratio After Provision:</span>
                        ...
                        <div class="flex justify-end space-x-3 pt-4">
                            ...
                            <button type="button" 
                                    ...
                                    class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white {{ $this->canMakeProvision() ? 'bg-red-600 hover:bg-red-700' : 'bg-gray-400 cursor-not-allowed' }}">
                                Record Provision
                            </button>
                        </div>
                    </div>
                            ...
                            <div class="space-y-4">
                                ...
                                @if(config('app.debug'))
                                    <div class="mt-2 p-2 bg-gray-100 rounded text-xs">
                                        ...
                                        <button wire:click="debugWriteOffState" type="button" class="mt-2 px-2 py-1 bg-red-500 text-white rounded text-xs hover:bg-red-600">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex items-center space-x-2 pt-5">
                                <button wire:click="filterHistory('all')" 
                                        class="px-3 py-1 text-sm rounded {{ $historyFilter === 'all' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-700' }}">
                                    All
                                </button>
                                <button wire:click="filterHistory('provisions')" 
                                        class="px-3 py-1 text-sm rounded {{ $historyFilter === 'provisions' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-700' }}">
                                    Provisions
                                </button>
                                <button wire:click="filterHistory('writeoffs')" 
                                        class="px-3 py-1 text-sm rounded {{ $historyFilter === 'writeoffs' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-700' }}">
                                    Write-offs
                                </button>
                                <button wire:click="filterHistory('adjustments')" 
                                        class="px-3 py-1 text-sm rounded {{ $historyFilter === 'adjustments' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-700' }}">
                                    Adjustments
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="mt-4 grid grid-cols-5 gap-4">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-lg font-semibold text-red-600">{{ number_format($summary['total_adjustments'], 2) }}</p>
                        </div>
                        <div class="text-center">
                ...
                <div class="bg-white border border-gray-200 rounded-lg">
                    <div class="px-4 py-3 border-b border-gray-200 flex justify-between items-center">
                        ...
                        <button wire:click="exportProvisionHistory" class="text-sm text-red-600 hover:text-red-800">
                            Export CSV
                        </button>
                    </div>
                    <div class="overflow-x-auto">
                ...
                <div class="bg-white border border-gray-200 rounded-lg">
                    <div class="px-4 py-3 border-b border-gray-200 flex justify-between items-center">
                        ...
                        <button wire:click="exportWriteOffHistory" class="text-sm text-red-600 hover:text-red-800">
                            Export CSV
                        </button>
                    </div>
                    <div class="overflow-x-auto">
