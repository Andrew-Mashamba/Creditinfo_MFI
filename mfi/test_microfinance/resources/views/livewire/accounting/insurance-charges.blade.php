            ...
            <div class="w-full flex gap-4 p-4">
                ...
                <div class="w-1/4 bg-white rounded-md p-4">
                    ...
                    <form wire:submit.prevent="{{ $isEdit ? 'update' : 'store' }}">
                        ...
                        <div class="mb-4">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Type of Insurance</label>
                            <select wire:model="type" class="w-full p-2 border bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full
                        p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                        ...
                        <div class="mb-4">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name of Insurance </label>
                            <input type="text" wire:model="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full
                        p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                        ...
                        <div class="mb-4">
                            ...
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Insurance Type</label>

                            <select wire:model="calculating_type" class="w-full p-2 border bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full
                        p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                                <option value="">Select Type  </option>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" wire:model="value" step="0.01" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full
                        p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                        ...
                        <div class="mb-4">
                            ...
                            <select wire:model="parent_account_code" class="w-full p-2 border bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full
                        p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                                <option value="">Select Account</option>
                                {{-- Get insurance-related accounts from accounts table --}}
                                @foreach(\Illuminate\Support\Facades\DB::table('accounts')
                                    ->where('account_name', 'like', '%insurance%')
                                    ->orWhere('category_code', 5400) {{-- Insurance expense category --}}
              ...
              @if($parent_account_code)
                        ...
                        <div class="mb-4">
                            ...
                            <select wire:model="category_code" class="w-full p-2 border bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full
                        p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                                <option value="">Select Account</option>
                   ...
                   @endif
                        ...
                        <button type="submit" class="bg-red-600 text-white px-4 py-2 justify-end rounded-md">{{ $isEdit ? 'Update' : 'Register' }} Asset</button>
                    </form>
