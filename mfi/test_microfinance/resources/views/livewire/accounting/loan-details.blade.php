            ...
            <div class="bg-white border-b border-gray-200 px-3 sm:px-6 py-3 sm:py-4">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex items-center space-x-3 sm:space-x-4">
                        <div class="w-10 h-10 sm:w-16 sm:h-16 bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center text-white font-bold text-lg sm:text-xl">
            ...
            <div class="p-2 sm:p-4 md:p-6 space-y-4 sm:space-y-6 w-full">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
                    ...
                    <div class="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        <div class="px-3 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-red-50 to-indigo-50 border-b border-gray-200">
                            <h3 class="text-base sm:text-lg font-semibold text-gray-900 flex items-center">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @if($mainApproval)
                            <div class="space-y-4 sm:space-y-6">
                                ...
                                <div class="space-y-2 sm:space-y-4">
                                                        ...
                                                        <div class="mt-1">
                                                            ...
                                                            @if($firstCheckerRoles->count() > 0)
                                                                @foreach($firstCheckerRoles as $role)
                                                                    <span class="inline-block bg-red-100 text-red-800 text-xs px-2 py-1 rounded mr-1 mb-1">{{ $role }}</span>
                                                                @endforeach
                                                            @else
                                    ...
                                    <!-- Overall Status -->
                                    <div class="bg-red-50 rounded-lg p-2 sm:p-4 border-l-4 border-red-400">
                ...
                <div class="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    <div class="px-3 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-indigo-50 to-red-50 border-b border-gray-200">
                        <h3 class="text-base sm:text-lg font-semibold text-gray-900 flex items-center">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-6">
                            ...
                            <div class="space-y-2 sm:space-y-4">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <select wire:model="bank_account" class="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent text-xs sm:text-sm">
                                        ...
                                        <div class="bg-gray-50 rounded-lg p-2 sm:p-4 border border-gray-200">
                                            ...
                                            <div class="space-y-1 sm:space-y-2">
                                                ...
                                                <div class="flex justify-between items-center">
                                                    ...
                                                    <span class="text-base sm:text-lg font-bold text-red-600">{{ number_format($this->approved_loan_value, 2) }} TZS</span>
                                                </div>
