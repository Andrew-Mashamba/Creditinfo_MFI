...
<div>{{-- In work, do what you enjoy. --}}
    <div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div wire:loading.remove wire:target="menuItemClicked">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <p class="font-semibold ml-3 text-slate-600 text-white"> {{App\Models\MembersModel::where('id',Session::get('viewMemberId_details'))->value('first_name').' '.App\Models\MembersModel::where('id',Session::get('viewMemberId_details'))->value('middle_name').' '.App\Models\MembersModel::where('id',Session::get('viewMemberId_details'))->value('last_name')}}</p>

                                </div>
                                <div class="text-red-400 ml-4 mr-5 ">
                                    <div class="ml-12 text-red-900 font-bold">
                                        {{App\Models\MembersModel::where('id',Session::get('viewMemberId_details'))->value('member_status')}}
                                    </div>
                                </div>
        ...
        <div class="w-full h-full grid justify-items-center">
            ...
            <?php        $employees=\App\Models\MembersModel::where('id',session()->get('viewMemberId_details'))->get();                      ?>
                                                    ...
                                                    <table class="w-full">
                                                        ...
                                                        @foreach(DB::table('pending_registrations')->where('phone_number',$employee->phone_number)->get() as $account)
                                                            <tr class="text-right">
                                                                ...
                                                                <td class="text-xs text-slate-400 dark:text-white capitalize  text-left"> {{ number_format($account->amount)}}TZS  </td>
                                                            </tr>
                                                            @endforeach
                                                            </td>
                                                            </tr>
                 ...
                 @if(DB::table('members')->where('id',session()->get('viewMemberId_details'))->value('member_status')=="EXIT MEMBER")
                         @if($this->declineEndMembership)
                             ...
                             <div class="flex justify-end" row="6">
                                 ...
                                 <div class="">
                                     <button wire:click="declineEndMembership({{session()->get('viewMemberId_details')}})" class=" p-2 m-4 mt-n2 bg-red-600 hover:bg-red-800 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                         Confirm
                                     </button>
                                 </div>
                             </div>
                   ...
                   <div class="space-x-4 p-4 flex justify-end items-end">
                       ...
                       <livewire:accounting.exit-member-action id="{{session()->get('viewMemberId_details')}}" />
                        ...
                        <div class="justify-end  text-right  ">
                            ...
                            <button  wire:click="declineEndMembershipModal" class=" mt-n2 bg-red-600 hover:bg-red-800 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                Decline
                            </button>

                            <button wire:click="exitMember({{session()->get('viewMemberId_details')}})" class=" mt-n2 bg-red-600 hover:bg-red-800 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                Confirm
                            </button>
                            @endif
                        </div>
                     ...
                     <div class="flex space-x-4 justify-end">
                         ...
                         <button wire:click="accept" class="bg-red-500 hover:bg-green-600 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                             Accept
                         </button>
                         @endif
