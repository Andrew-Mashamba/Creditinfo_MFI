            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div class="max-w-lg mx-auto mt-8 p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select wire:model="loan_type" id="loan_type" class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring-red-500 focus:border-red-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" wire:model="amount" id="amount" class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring-red-500 focus:border-red-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" wire:model="organization_name" id="organization_name" class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring-red-500 focus:border-red-500">
                        @error('organization_name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="address" class="block text-sm font-medium text-gray-700">Address</label>
                        <input type="text" wire:model="address" id="address" class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring-red-500 focus:border-red-500">
                        @error('address') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="phone" class="block text-sm font-medium text-gray-700">Phone</label>
                        <input type="text" wire:model="phone" id="phone" class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring-red-500 focus:border-red-500">
                        @error('phone') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                        <input type="email" wire:model="email" id="email" class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring-red-500 focus:border-red-500">
                        @error('email') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="description" class="block text-sm font-medium text-gray-700">Description/Reasons</label>
                        <textarea wire:model="description" id="description" class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring-red-500 focus:border-red-500"></textarea>
                        @error('description') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-4">
                        <label for="application_form" class="block text-sm font-medium text-gray-700">Application Form</label>
                        <input type="file" wire:model="application_form" id="application_form" class="mt-1 block w-full border border-gray-300 rounded-md focus:ring-red-500 focus:border-red-500" />
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" wire:model="contract_form" id="contract_form" class="mt-1 block w-full border border-gray-300 rounded-md focus:ring-red-500 focus:border-red-500" />
    ...
    <div class="w-full p-4 bg-white rounded-lg shadow">
        ...
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center space-x-4">
                ...
                {{-- Loan Type Filter --}}
                <select wire:model="filterLoanType" class="border border-gray-300 rounded-lg px-3 py-2 focus:ring-red-500 focus:border-red-500">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    <input type="text" 
                           ...
                           class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500 w-64">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">
                                @if($loan->application_form)
                                    <a href="{{ Storage::url($loan->application_form) }}" target="_blank" class="text-red-600 hover:text-red-900">
                                        View
                                    </a>
                                @else
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">
                                @if($loan->contract_form)
                                    <a href="{{ Storage::url($loan->contract_form) }}" target="_blank" class="text-red-600 hover:text-red-900">
                                        View
                                    </a>
                                @else
                                    <span class="text-gray-400">-</span>
