<div class="bg-white p-4 ">
            ...
            <div class="w-1/2 metric-card   border bg-white  border-gray-200  rounded-lg p-4 ">
                @if (session('message'))
                    <div id="alert-border-1"
                        class="flex items-center p-4 mb-4 text-red-800 border-t-4 border-red-300 bg-red-50 dx:text-red-400 dx:bg-gray-800 dx:border-red-800"
                        role="alert">
                        ...
                        <button type="button"
                            class="ms-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex items-center justify-center h-8 w-8 dx:bg-gray-800 dx:text-red-400 dx:hover:bg-gray-700"
    ...
    <div class="relative">
        ...
        <div
            class="grid grid-cols-1 sm:grid-cols-2 p-4 my-auto border-red-800 border-2 md:grid-cols-2 gap-6 pb-4 bg-gray-50 rounded-xl p-4 mt-4">
...
<hr class="border-2 border-red-900 mt-4 w-full" />
<div class="fon-semibold  mt-4 border-1 border-red-900 mb-4  uppercase">
