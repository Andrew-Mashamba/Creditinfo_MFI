            ...
            <div class="flex-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div>
                        ...
                        <ul class="text-red-900 space-y-1 text-xs">
                        ...
                        @if($example)
                            <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-red-900">Example for {{ $adjustmentTypes[$adjustmentType] }}:</p>
                                        <p class="text-sm text-red-700 mt-1">{{ $example['desc'] }}</p>
