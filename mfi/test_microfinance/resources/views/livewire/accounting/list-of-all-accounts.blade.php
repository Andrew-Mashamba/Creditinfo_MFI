        ...
        <div class="px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <button wire:click="openCreateModal()" 
                    class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-800 text-sm font-medium transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div class="bg-red-50 rounded-lg border border-red-200 p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-red-600">Assets</p>
                            <p class="text-lg font-semibold text-red-900">{{ number_format($accountSummary['ASSET']['balance'] ?? 0, 2) }}</p>
                            <p class="text-xs text-red-500">{{ $accountSummary['ASSET']['count'] ?? 0 }} accounts</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-gray-50 border-b px-6 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div>
                ...
                <select wire:model="selectedType" class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-900 focus:ring-red-900 text-sm">
            ...
            <div>
                ...
                <select wire:model="selectedLevel" class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-900 focus:ring-red-900 text-sm">
            ...
            <div>
                ...
                <select wire:model="selectedStatus" class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-900 focus:ring-red-900 text-sm">
            ...
            <div>
                ...
                <select wire:model="selectedCategory" class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-900 focus:ring-red-900 text-sm">
    ...
    <div class="bg-white" wire:loading.class.delay="opacity-60">
        <div class="flex items-center justify-between px-6 pt-4">
            ...
            <div class="flex items-center space-x-2">
                ...
                <select id="perPage" wire:model="perPage" class="rounded-md border-gray-300 text-sm focus:border-red-900 focus:ring-red-900">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($accounts as $account)
                        <tr class="hover:bg-gray-50 transition-colors" wire:key="acct-{{ $account->account_number }}">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        ...
                                        @endphp
                                        <svg class="w-4 h-4 {{ $account->display_type == 'LIABILITY' || $account->display_type == 'EXPENSE' ? 'text-red-600' : 'text-red-900' }}" 
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div>
                                    <span class="px-2 py-1 text-xs rounded-full {{ $account->account_level == '1' ? 'bg-red-600 text-white' : ($account->account_level == '2' ? 'bg-red-700 text-white' : ($account->account_level == '3' ? 'bg-gray-200 text-gray-700' : 'bg-gray-100 text-gray-600')) }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center space-x-1">
                                    ...
                                    <button wire:click="openDetailsModal('{{ $account->account_number }}')" 
                                        class="text-red-900 hover:text-red-700 transition-colors focus:outline-none" 
                                        title="View Details">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model.defer="editingAccount.account_number" 
                                        class="w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 text-sm bg-gray-50"
                                        readonly>
                                </div>
                            ...
                            <div class="mt-4 space-y-4">
                                ...
                                @if(isset($selectedAccountData['parent']))
                                    <div class="bg-red-50 rounded-lg p-4">
                                        <h4 class="text-sm font-medium text-red-700 mb-3">Parent Account</h4>
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                <label class="block text-xs font-medium text-red-500">Name</label>
                                                <p class="text-sm font-medium text-red-900">{{ $selectedAccountData['parent']['account_name'] }}</p>
                                            </div>
                                            <div>
                                                <label class="block text-xs font-medium text-red-500">Number</label>
                                                <p class="text-sm font-mono text-red-900">{{ $selectedAccountData['parent']['account_number'] }}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
