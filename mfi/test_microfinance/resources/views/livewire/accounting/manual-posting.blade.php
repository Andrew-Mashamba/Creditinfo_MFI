<div class="bg-white rounded-lg shadow-sm">
    ...
    <div class="bg-red-600 text-white px-4 py-2 rounded-t-lg">
        <div class="flex items-center justify-between">
            ...
            <span class="text-xs bg-red-800 px-2 py-1 rounded">Double Entry</span>
        </div>
    </div>
    ...
    <div class="p-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 mb-4">
            ...
            <div class="border border-gray-200 rounded-lg p-3 bg-gray-50">
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        <input type="text" 
                               ...
                               class="w-full bg-white border border-gray-300 text-sm rounded-md px-2 py-1.5 pr-8 focus:border-red-900 focus:ring-1 focus:ring-red-900" />
                    ...
                    @if ($showDropdown && !empty($results))
                        <div class="absolute bg-white border border-gray-200 rounded-md shadow-lg mt-1 w-full z-20 max-h-48 overflow-y-auto">
                            @foreach ($results as $result)
                                <div class="px-2 py-1.5 hover:bg-red-50 cursor-pointer border-b border-gray-100 last:border-0"
                ...
                @if (!empty($selectedAccount))
                    <div class="mt-2 bg-white border border-red-200 rounded-md p-2">
                        <div class="flex items-center justify-between mb-1">
                            <span class="text-xs font-semibold text-red-900">Selected Account</span>
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input wire:model="amount" 
                               ...
                               step="0.01" 
                               min="0.01" 
                               class="w-full pl-6 pr-2 py-1.5 bg-white border @error('amount') border-red-500 @else border-gray-300 @enderror text-sm rounded-md focus:border-red-900 focus:ring-1 focus:ring-red-900" 
                               placeholder="0.00" 
                               required />
                    </div>
                    @error('amount')
                ...
                <div>
                    ...
                    <input wire:model="narration" 
                           type="text" 
                           class="w-full px-2 py-1.5 bg-white border @error('narration') border-red-500 @else border-gray-300 @enderror text-sm rounded-md focus:border-red-900 focus:ring-1 focus:ring-red-900" 
            ...
            @if(!empty($selectedAccount) && !empty($selectedAccountTwo) && $amount)
                <div class="mt-3 bg-red-50 border border-red-200 rounded-md p-2">
                    <h4 class="text-xs font-semibold text-red-900 mb-1">Transaction Preview</h4>
                    <div class="grid grid-cols-2 gap-2 text-xs">
                        <div class="flex items-center">
                        ...
                        <div class="col-span-2 pt-1 border-t border-red-200">
            ...
            <div class="flex justify-between items-center mt-3">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div wire:loading wire:target="post">
                        <button class="px-3 py-1.5 text-xs font-medium text-white bg-red-400 rounded-md cursor-not-allowed" disabled>
                    ...
                    <button wire:loading.remove 
                            ...
                            class="px-4 py-1.5 text-xs font-medium text-white bg-red-600 rounded-md hover:bg-red-800 transition-colors
        ...
        <div class="bg-gray-50 rounded-lg p-2 border border-gray-200">
            ...
            <ul class="text-xs text-gray-600 space-y-0.5">
                <li class="flex items-start">
                    <span class="text-red-900 mr-1">•</span>
