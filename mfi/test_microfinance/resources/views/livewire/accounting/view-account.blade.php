    ...
    <div class="bg-white px-6 py-10">
        ...
        <div class="overflow-auto">
            ...
            {{-- <table class="w-full text-left mb-8 border border-gray-300 rounded-lg shadow-md">
                <thead>
                    <tr class="bg-red-100 text-gray-700 text-sm font-semibold">
                ...
                <tbody>
                    @foreach ($transactions as $transaction)
                        <tr class="border-b text-gray-800 hover:bg-red-50">
                            ...
                            <td class="py-3 px-4">
                                <button wire:click="reverseTransaction({{ $transaction->reference_number }})" class="text-red-500 hover:text-red-700">
