<div>
    <div class="flex gap-4">
        ...
        <button wire:click ="financeAccept({{$id}})" class="hoverable text-white bg-gray-100 hover:bg-red-100 hover:text-red-200 focus:ring-4 focus:outline-none focus:ring-red-100 font-medium rounded-lg text-sm p-1 text-center inline-flex items-center mr-2 dark:bg-red-200 dark:hover:bg-red-200 dark:focus:ring-red-200">
