                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                    {{ $account->account_type === 'main_operations' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800' }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button 
                                        ...
                                        class="inline-flex items-center p-1 text-gray-400 hover:text-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 rounded transition-colors duration-200"
                            ...
                            <form wire:submit.prevent="createBankAccount" class="mt-4 space-y-4">
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" wire:model.defer="newBankAccount.bank_name" id="bank_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model.defer="newBankAccount.account_name" id="account_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                        @error('newBankAccount.account_name') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                                    </div>
                                    {{-- Account Type Selection --}}
                                    <div class="col-span-2">
                                        <label for="account_type" class="block text-sm font-medium text-gray-700">Account Type</label>
                                        <select wire:model="newBankAccount.account_type" id="account_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <select wire:model.defer="newBankAccount.branch_id" id="branch_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model.defer="newBankAccount.account_number" id="account_number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model.defer="newBankAccount.branch_name" id="branch_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model.defer="newBankAccount.swift_code" id="swift_code" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                        @error('newBankAccount.swift_code') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                                    </div>
                                    <div>
                                        <label for="currency" class="block text-sm font-medium text-gray-700">Currency</label>
                                        <input type="text" wire:model.defer="newBankAccount.currency" id="currency" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" wire:model.defer="newBankAccount.opening_balance" id="opening_balance" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model.defer="newBankAccount.internal_mirror_account_number" id="internal_mirror_account_number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                ...
                                <div class="mt-4">
                                    ...
                                    <textarea wire:model.defer="newBankAccount.description" id="description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"></textarea>
                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                            ...
                            <div class="mt-4 space-y-4">
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-gray-900">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                                {{ $selectedBankAccount->account_type === 'main_operations' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800' }}">
                                ...
                                <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                    <button type="button" wire:click="closeViewModal" class="w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:mt-0 sm:w-auto sm:text-sm">
                                        Close
                                    </button>
                                </div>
                            </div>
                            ...
                            <form wire:submit.prevent="updateBankAccount" class="mt-4 space-y-4">
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" wire:model.defer="editing.bank_name" id="edit_bank_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model.defer="editing.account_name" id="edit_account_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <select wire:model="editing.account_type" id="edit_account_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                            <option value="main_operations">Main Operations</option>
                                            <option value="branch">Branch Account</option>
                                        </select>
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <select wire:model.defer="editing.branch_id" id="edit_branch_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                            <option value="">Choose a branch...</option>
                                            @foreach($branches as $branch)
                                                <option value="{{ $branch->id }}">{{ $branch->name }}</option>
                                            @endforeach
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model.defer="editing.account_number" id="edit_account_number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model.defer="editing.branch_name" id="edit_branch_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model.defer="editing.swift_code" id="edit_swift_code" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model.defer="editing.currency" id="edit_currency" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model.defer="editing.internal_mirror_account_number" id="edit_internal_mirror_account_number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm">
                                            <option value="">Select Mirror Account...</option>
                                            @foreach($mirrorAccounts as $account)
                                                <option value="{{ $account->account_number }}">
                                                    {{ $account->account_name }} - {{ $account->account_number }}
                                ...
                                <div class="mt-4">
                                    ...
                                    <textarea wire:model.defer="editing.description" id="edit_description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"></textarea>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="mt-4">
                                    ...
                                    <textarea wire:model.defer="disableReason" id="disable_reason" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"></textarea>
