            ...
            @foreach($asset_accounts as $income_account)
                ...
                <table class="w-full text-sm text-left text-red-50 mb-4">
                    ...
                    @foreach($category_accounts as $category_account)
                        ...
                        <tr class="border-b border-red-200 text-black">
                            <td class="whitespace-nowrap border-r px-4 py-2 dark:border-neutral-500 text-sm w-1/4">
                                <a wire:click="setSubCode2({{ $category_account->sub_category_code }},'{{$category_account->sub_category_name}}')" class="cursor-pointer text-red-600 hover:text-red-800 text-sm">
                ...
                @foreach ($category_accounts as $category_account)
                    ...
                    <table class="w-full text-sm text-left text-red-50 mb-4">
                        ...
                        @foreach(\Illuminate\Support\Facades\DB::table('sub_accounts')->where('sub_category_code',$category_account->sub_category_code)->get() as $account)
                            ...
                            <tr class="border-b border-red-200 text-black">
                                <td class="whitespace-nowrap border-r px-4 py-2 dark:border-neutral-500 text-sm w-1/4">
                                    <a wire:click="setSubCode3({{ $account->sub_category_code }},'{{$account->account_name}}')" class="cursor-pointer text-red-600 hover:text-red-800 text-sm">
