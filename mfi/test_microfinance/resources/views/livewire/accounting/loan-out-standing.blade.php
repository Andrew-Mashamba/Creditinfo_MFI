            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-red-600">{{ number_format($summary['total_outstanding'] ?? 0, 2) }}</p>
                ...
                <div class="space-y-2">
                    ...
                    <div class="border-t border-gray-200 pt-2 mt-2">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm font-bold text-red-600">{{ number_format($summary['total_outstanding'] ?? 0, 2) }} TZS</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm font-semibold text-red-600">{{ number_format($agedOutstanding['watch'] ?? 0, 2) }} TZS</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <div>
                        ...
                        <tr>
                            <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100" wire:click="sortBy('loan_account_number')">
                                ...
                                @if($sortField === 'loan_account_number')
                                    <span class="text-red-600">{{ $sortDirection === 'asc' ? '↑' : '↓' }}</span>
                                @endif
                            </th>
                ...
                <div class="mt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        <div class="bg-red-50 p-4 rounded-lg">
                            <p class="text-sm text-red-600">Principal Outstanding</p>
                            <p class="text-xl font-bold text-red-700">{{ number_format($selectedLoan['principal_outstanding'], 2) }}</p>
                        </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($selectedLoan['schedule_details'] as $schedule)
                                    <tr class="{{ $schedule['is_overdue'] ? 'bg-red-50' : '' }}">
                                        ...
                                        <td class="px-3 py-2 whitespace-nowrap text-right font-bold text-red-600">{{ number_format($schedule['total_outstanding'], 2) }}</td>
