...
<div id="accounts-tab" class="tab-pane">
    <div class="space-y-6">
        <!-- Primary Accounts -->
        <div class="bg-gradient-to-r from-red-50 to-cyan-50 p-6 rounded-xl border border-red-100">
                    ...
                    <div class="space-y-2">
                        ...
                        @if($loanProductLevel2)
                            <select wire:model.lazy="selectedLoanProductLevel2"
                                    class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all duration-200 text-sm">
