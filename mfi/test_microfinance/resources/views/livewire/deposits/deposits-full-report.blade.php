<div class="p-6 bg-white rounded-lg shadow-lg">
    ...
    <div class="mb-6">
        <div class="flex justify-between items-center mb-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Deposits Full Report</h1>
                <p class="text-gray-600 mt-1">Comprehensive deposits analysis and reporting</p>
            </div>
            <div class="flex space-x-3">
                <button wire:click="refreshReport" 
                        class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-600 transition-colors">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            <div class="bg-red-50 p-6 rounded-lg border border-red-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-red-600">Total Members</p>
    ...
    <div class="bg-gray-50 p-6 rounded-lg mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <div>
                ...
                <select wire:model="selectedBranch" class="w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500">
            ...
            <div>
                ...
                <select wire:model="selectedMember" class="w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500">
            ...
            <div>
                ...
                <select wire:model="selectedAccount" class="w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500">
            ...
            <div>
                ...
                <select wire:model="selectedProduct" class="w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <div>
                ...
                <input type="date" wire:model="dateFrom" class="w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Date To</label>
                <input type="date" wire:model="dateTo" class="w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500">
            </div>

            <!-- Report Type -->
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Report Type</label>
                <select wire:model="reportType" class="w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500">
            ...
            <div>
                ...
                <select wire:model="groupBy" class="w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div>
                ...
                <select wire:model="timeFrame" class="w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500">
            ...
            <div>
                ...
                <select wire:model="statusFilter" class="w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500">
            ...
            <div>
                ...
                <select wire:model="perPage" class="w-full border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-8 w-8">
                                            <div class="h-8 w-8 rounded-full bg-red-100 flex items-center justify-center">
                                                <i class="fas fa-piggy-bank text-red-600 text-xs"></i>
                                            </div>
                                        </div>
                                        <div class="ml-3">
...
<div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-10 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-2/3 shadow-lg rounded-md bg-white max-h-[90vh] overflow-y-auto">
        <div class="mt-3">
            ...
            <div class="space-y-6">
                <!-- Account Header -->
                <div class="bg-gradient-to-r from-red-50 to-indigo-50 p-6 rounded-lg border border-red-200">
                ...
                <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                    ...
                    <button class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-600 transition-colors">
