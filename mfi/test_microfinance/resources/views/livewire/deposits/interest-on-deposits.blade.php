<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Interest on Deposits</h2>
                <p class="text-gray-600 mt-1">View accrued interest for all fixed deposit accounts</p>
            </div>
            <button
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-lg shadow p-6 border-l-4 border-indigo-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600">Total Deposit Accounts</p>
        ...
        <div class="bg-white rounded-lg shadow p-6 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600">Total Deposits Balance</p>
        ...
        <div class="bg-white rounded-lg shadow p-6 border-l-4 border-yellow-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-500">Weighted average per annum</p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow p-4 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Deposit Product</label>
                <select
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tfoot class="bg-gray-50">
                    <tr>
                        ...
                        <td class="px-6 py-4 text-right text-sm font-bold text-gray-900">
                            {{ number_format($summaryData['interest_rate'] ?? 0, 2) }}%
                        </td>
                        <td class="px-6 py-4 text-right text-sm font-bold text-gray-900">
