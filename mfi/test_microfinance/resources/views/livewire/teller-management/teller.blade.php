                    ...
                    <div class="p-8">
                        ...
                        <div wire:loading wire:target="menu_sub_button" class="flex items-center justify-center py-12">
                            <div class="flex items-center space-x-2">
                                <svg class="w-6 h-6 animate-spin text-red-600" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                        ...
                        <div wire:loading.remove wire:target="menu_sub_button" class="min-h-[400px]">
                            ...
                            @else
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                                    ...
                                    <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border border-red-200">
                                        <div class="flex items-center justify-between mb-4">
                                            <h3 class="text-lg font-semibold text-red-900">Teller Overview</h3>
                                        ...
                                        <div class="space-y-3">
                                            <div class="flex justify-between">
                                                <span class="text-sm text-red-700">Total Tills:</span>
                                                <span class="font-semibold text-red-900">{{ DB::table('tellers')->count() }}</span>
                                            </div>
                                            <div class="flex justify-between">
                                                <span class="text-sm text-red-700">Assigned:</span>
                                                <span class="font-semibold text-green-600">{{ DB::table('tellers')->where('employee_id', '!=', null)->count() }}</span>
                                            </div>
                                            <div class="flex justify-between">
                                                <span class="text-sm text-red-700">Pending:</span>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                                    <button wire:click="menu_sub_button(1)" class="bg-white p-6 rounded-xl border border-gray-200 hover:border-red-300 hover:shadow-lg transition-all duration-200 group">
