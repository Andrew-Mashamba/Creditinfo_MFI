        ...
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center space-x-2">
                ...
                <div class="relative" x-data="{ open: false }" @click.away="open = false">
                    <button 
                        @click="open = !open"
                        class="flex items-center px-3 py-2 text-sm font-medium text-white bg-red-600 rounded-md hover:bg-red-700"
                    >
        ...
        @if(count($conversationEmails) > 0)
            <div class="mt-8 pt-6 border-t border-gray-200">
                <button 
                    ...
                    class="flex items-center text-sm font-medium text-red-600 hover:text-red-800 mb-4"
                >
