<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            <button wire:click="processAllEmails" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition">
                Process New Emails
            </button>
    ...
    <div class="space-y-4">
        ...
        @empty
            <div class="bg-gray-50 rounded-lg p-8 text-center">
                ...
                <button wire:click="openCreateModal" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition">
                ...
                <div class="mt-3">
                    ...
                    @if($showCreateModal && count($ruleTemplates) > 0)
                        <div class="mb-4 p-3 bg-red-50 rounded-lg">
                            <p class="text-sm text-red-800 mb-2">Quick start with a template:</p>
                            <div class="grid grid-cols-2 gap-2">
                                @foreach($ruleTemplates as $index => $template)
                                    <button 
                                        wire:click="applyTemplate({{ $index }})"
                                        class="text-left p-2 bg-white rounded border border-red-200 hover:border-red-400 transition text-sm"
                                    >
