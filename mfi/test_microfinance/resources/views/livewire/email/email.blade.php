            ...
            <div class="w-80 bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 border-b border-gray-100">
                    ...
                    <button 
                        ...
                        class="w-full bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-6 rounded-xl transition-all duration-200 flex items-center justify-center shadow-sm hover:shadow-md text-sm"
                    >
                                        ...
                                        <div class="border-b border-gray-200">
                                            <nav class="-mb-px flex space-x-8">
                                                <button 
                                                    ...
                                                    class="@if($focusedTab === 'focused') border-red-500 text-red-600 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 @endif whitespace-nowrap py-3 px-1 border-b-2 font-medium text-sm flex items-center"
                                                >
                                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                                                    </svg>
                                                ...
                                                <button 
                                                    ...
                                                    class="@if($focusedTab === 'other') border-red-500 text-red-600 @else border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 @endif whitespace-nowrap py-3 px-1 border-b-2 font-medium text-sm flex items-center"
                                                >
                                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"></path>
                                                    </svg>
                                        ...
                                        @foreach($emails as $email)
                                            @if($conversationView && isset($email['id']) && str_starts_with($email['id'], 'conv_'))
                                                ...
                                                <div 
                                                    ...
                                                    class="cursor-pointer bg-white hover:bg-gray-50 border border-gray-200 rounded-lg p-4 transition-all duration-200 @if($email['is_unread']) bg-red-50 border-red-200 @endif"
                                                >
                                            ...
                                            @else
                                                ...
                                                <div 
                                                    ...
                                                    class="cursor-pointer bg-white hover:bg-gray-50 border border-gray-200 rounded-lg p-4 transition-all duration-200 @if(!$email->is_read && $folder == 'inbox') bg-red-50 border-red-200 @endif @if($email->is_pinned ?? false) ring-2 ring-yellow-400 @endif @if($email->is_focused ?? false) border-l-4 border-l-red-500 @endif"
                                                >
                                                <div class="flex items-start justify-between">
                                                    <div class="flex-1">
                                                        <div class="flex items-center justify-between mb-1">
                                                        ...
                                                        <div class="flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                                            ...
                                                            @if($folder == 'inbox' && $focusedInboxEnabled)
                                                                <button 
                                                                    ...
                                                                    class="p-1 transition-colors @if($email->is_focused ?? false) text-red-500 hover:text-red-600 @else text-gray-400 hover:text-red-500 @endif"
