            ...
            <div class="w-1/4 ">
                <div class="bg-white shadow rounded-lg p-6">
                    <div class="flex flex-col items-center">
                        <img src="{{asset('userImage.png')}} " class="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0">
                        <h1 class="text-xl font-bold">JOHN ODOE  </h1>
                        <p class="text-gray-600">Software Developer</p>
                        <div class="mt-6 flex flex-wrap gap-4 justify-center">
                            <a href="#" class="bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded">Contact</a>
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="w-full flex">
                            <div class="w-1/2">Object_status</div>
                            <div class="w-1/2"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-3/4 ">
                <div class="bg-white shadow rounded-lg p-6">
                    <div class="flex justify-between">
                        ...
                        <button wire:click="hide" type="button" class="w-10 h-10 text-white bg-red-200 focus:ring-4 focus:outline-none focus:ring-red-100 font-medium rounded-full text-sm p-1 text-center inline-flex items-center mr-2 dark:bg-red-200 dark:hover:bg-red-200 dark:focus:ring-red-200">
