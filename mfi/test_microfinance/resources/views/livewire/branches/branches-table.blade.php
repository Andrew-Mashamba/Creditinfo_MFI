        ...
        <table class="max-w-2/3 divide-y divide-gray-200" aria-label="Branches Table">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                @forelse ($branches as $branch)
                    <tr class="hover:bg-red-50 focus-within:bg-red-100 transition-colors duration-150">
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-lg max-w-4xl w-full p-6 max-h-[90vh] overflow-y-auto">
                ...
                <div class="mt-6 flex justify-end space-x-3">
                    ...
                    <button wire:click="updateBranch" class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700">
                        Save Changes
                    </button>
                </div>
            </div>
