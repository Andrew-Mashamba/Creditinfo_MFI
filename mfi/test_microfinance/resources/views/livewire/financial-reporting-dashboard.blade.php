{{-- 
    ...
    Author: MFI Management System Development Team
...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-red-50">
    <div class="p-6">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="text-right">
                    ...
                    <div class="text-2xl font-bold text-red-600">{{ count($availableReports) }}</div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-xl font-semibold text-red-900">General Financial Reports</h2>
                ...
                <div class="space-y-3">
                    @forelse($generalReports as $key => $report)
                        <div class="flex items-center justify-between p-4 border border-red-100 rounded-lg hover:bg-red-50 transition-colors duration-200">
                            <div class="flex items-center space-x-3">
                                <div class="w-10 h-10 bg-red-100 rounded-lg flex items-center justify-center">
                                    <span class="text-red-600 font-bold text-sm">{{ $report['id'] }}</span>
                                </div>
                                <div>
                                    <h3 class="font-medium text-gray-900">{{ $report['name'] }}</h3>
                                    <p class="text-sm text-gray-500">{{ $report['description'] }}</p>
