            ...
            <div class="bg-white rounded-lg shadow-md p-5 border-l-4 border-red-900">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-red-900 mt-1">{{ $totalEmployees }}</p>
            ...
            <div class="bg-white rounded-lg shadow-md p-5 border-l-4 border-red-900">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-red-900 mt-1">{{ $activeEmployees }}</p>
            ...
            <div class="bg-white rounded-lg shadow-md p-5 border-l-4 border-red-900">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-red-900 mt-1">{{ $inactiveEmployees + $suspendedEmployees }}</p>
            ...
            <div class="bg-white rounded-lg shadow-md p-5 border-l-4 border-red-900">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-red-900 mt-1">{{ $totalDepartments }}</p>
                ...
                <div class="p-4">
                    ...
                    <nav class="space-y-1">
                        ...
                        <button wire:click="setMenuNumber(0)" 
                            class="w-full flex items-center px-3 py-2 text-sm font-medium rounded-md {{ $menuNumber === 0 ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                        ...
                        <button wire:click="setMenuNumber(1)" 
                            class="w-full flex items-center px-3 py-2 text-sm font-medium rounded-md {{ $menuNumber === 1 ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button wire:click="setMenuNumber(2)" 
                            class="w-full flex items-center px-3 py-2 text-sm font-medium rounded-md {{ $menuNumber === 2 ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button wire:click="setMenuNumber(3)" 
                            class="w-full flex items-center px-3 py-2 text-sm font-medium rounded-md {{ $menuNumber === 3 ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button wire:click="setMenuNumber(4)" 
                            class="w-full flex items-center px-3 py-2 text-sm font-medium rounded-md {{ $menuNumber === 4 ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button wire:click="setMenuNumber(5)" 
                            class="w-full flex items-center px-3 py-2 text-sm font-medium rounded-md {{ $menuNumber === 5 ? 'bg-red-600 text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                    ...
                                    <div class="lg:col-span-2 space-y-6">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div class="bg-white border border-gray-200 rounded-lg p-5">
                                                ...
                                                <p class="text-2xl font-bold text-red-900">TZS {{ number_format($totalSalaryExpense, 0) }}</p>
                                            ...
                                            <div class="bg-white border border-gray-200 rounded-lg p-5">
                                                ...
                                                <p class="text-2xl font-bold text-red-900">TZS {{ number_format($averageSalary, 0) }}</p>
                                                ...
                                                @forelse($topDepartments as $dept)
                                                    <div>
                                                        <div class="flex items-center justify-between mb-1">
                                                            ...
                                                            <span class="text-sm font-semibold text-red-900">{{ $dept['count'] }}</span>
                                                        </div>
                                                        <div class="w-full bg-gray-200 rounded-full h-2">
                                                            <div class="bg-red-600 h-2 rounded-full" style="width: {{ $dept['percentage'] }}%"></div>
                                                        </div>
                                                    </div>
                                                @empty
                                        ...
                                        <div class="bg-white border border-gray-200 rounded-lg p-5">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                @forelse($employmentTypeStats as $type)
                                                    <div class="bg-gray-50 rounded-lg p-3 border-l-4 border-red-900">
                                                ...
                                                @forelse($genderStats as $gender)
                                                    <div class="flex-1 text-center">
                                                        <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-red-100 mb-2">
                                                            <span class="text-2xl font-bold text-red-900">{{ $gender['percentage'] }}%</span>
                                                        </div>
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="bg-white border border-gray-200 rounded-lg p-5">
                                            ...
                                            <p class="text-2xl font-bold text-red-900">TZS {{ number_format($monthlyPayrollTotal, 0) }}</p>
                                        ...
                                        <div class="bg-white border border-gray-200 rounded-lg p-5">
                                            ...
                                            <div class="space-y-2">
                                                @if($permissions['canEmployees'] ?? false)
                                                <button wire:click="setMenuNumber(1)"
                                                    class="w-full p-3 bg-red-600 text-white rounded-lg hover:bg-red-800 transition text-sm font-medium flex items-center justify-center">
                                                ...
                                                @if($permissions['canPayroll'] ?? false)
                                                <button wire:click="setMenuNumber(2)"
                                                    class="w-full p-3 bg-white border-2 border-red-900 text-red-900 rounded-lg hover:bg-red-50 transition text-sm font-medium flex items-center justify-center">
                                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/>
                                                    </svg>
                                                    Process Payroll
