        ...
        <div class="flex gap-6">
            ...
            <div class="w-80 bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="p-6 border-b border-gray-100">
                    <div class="relative">
                        <input type="text" placeholder="Search HR..." class="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 bg-gray-50 hover:bg-white focus:bg-white" aria-label="Search HR" />
                ...
                <div class="p-4">
                    ...
                    <nav class="space-y-2">
                        <button wire:click="setMenuNumber(0)" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $menuNumber === 0 ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                        ...
                        <button wire:click="setMenuNumber(1)" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $menuNumber === 1 ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                        ...
                        <button wire:click="setMenuNumber(2)" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $menuNumber === 2 ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                        ...
                        <button wire:click="setMenuNumber(3)" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $menuNumber === 3 ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                        ...
                        <button wire:click="setMenuNumber(4)" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $menuNumber === 4 ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                            ...
                            @case(0)
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                                    <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border border-red-200">
                                        <h3 class="text-lg font-semibold text-red-900 mb-2">Total Employees</h3>
                                        <div class="text-3xl font-bold text-red-900">{{ $totalEmployees }}</div>
                                    </div>
