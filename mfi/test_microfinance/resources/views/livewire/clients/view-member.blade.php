    ...
    <div class="min-h-full flex items-start justify-center p-4">
        ...
        <div class="flex flex-col md:flex-row gap-0">
            ...
            <div class="md:w-2/3 p-8">
                ...
                <div class="mb-6">
                    <div class="font-semibold text-gray-700 mb-2">Client Revenue</div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="bg-gradient-to-r from-red-50 to-red-100 rounded-lg p-4 border border-red-200">
                            <div class="flex items-center justify-between mb-2">
                                <div class="text-sm font-medium text-red-800">Interest on Savings</div>
                                <div class="text-xs text-red-600 bg-red-200 px-2 py-1 rounded">Accrued</div>
                            </div>
                            <div class="text-2xl font-bold text-red-900 mb-1">
