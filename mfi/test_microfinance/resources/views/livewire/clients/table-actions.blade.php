<div class="flex space-x-1 justify-around">
    <a wire:click="viewClient({{$id}})" target="_blank" class="p-1 text-teal-600 hover:bg-teal-600 hover:text-red rounded">
    ...
    <button wire:click="editClient({{$id}})" class="p-1 text-red-600 hover:bg-red-600 hover:bg-red-200 rounded">
