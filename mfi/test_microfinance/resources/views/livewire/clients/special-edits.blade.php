<div class="p-2 bg-white rounded-lg shadow-md">
    <!-- Header -->
    <div class="mb-6">        
        <h1 class="text-lg text-gray-600">Edit client phone number, account number, and email with approval workflow</p>
    </div>
            ...
            <div class="flex gap-4">
                <div class="flex-1">
                    <label for="search" class="block text-sm font-medium text-gray-700 mb-2">
                        Search by Client Number, Name, Phone, or Email
                    </label>
                    <input 
                        type="text" 
                        id="search"
                        wire:model.debounce.300ms="searchTerm"
                        placeholder="Enter client number, name, phone, or email..."
    ...
    @if($showEditForm && $selectedClient)
        <div class="mb-6">
            <div class="bg-red-50 p-4 rounded-lg">
                ...
                <div class="mb-4 p-3 bg-white border border-red-200 rounded-md">
                ...
                <form wire:submit.prevent="prepareEditPackage">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent @error('phone_number') border-red-500 @enderror"
                            >
                            @error('phone_number')
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent @error('account_number') border-red-500 @enderror"
                            >
                    ...
                    <div class="mt-6 flex gap-3">
                        <button 
                            type="submit"
                            class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-900 focus:ring-offset-2"
                        >
