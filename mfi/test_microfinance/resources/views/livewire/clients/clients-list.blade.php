    ...
    <div class="flex">
        ...
        <div class="mb-12 shadow-sm w-4/5">
            ...
            <div class="relative">
                ...
                <input wire:model.debounce="term" type="search" id="default-search" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-400 focus:border-red-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-400 dark:focus:border-red-400" placeholder="Search by name, number or phone or branch..." required>
                <button wire:click="resetSearch" class="text-white absolute right-1.5 bottom-1.5 top-1.5 bg-red-400 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-2 dark:bg-red-400 dark:hover:bg-red-400 dark:focus:ring-red-400">
        ...
        <select wire:model.bounce="clientStatus" name="clientStatus" id="clientStatus" class="w-1/5 mb-12 ml-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
            <option selected value="All"><p>All</p></option>
            <option value="Active"><p>Active</p></option>
            <option value="Pending Approval"><p>Pending Approval</p></option>
            <option value="Suspended"><p>Suspended</p></option>
            <option value="Inactive"><p>Inactive</p></option>
            <option value="Rejected"><p>Rejected</p></option>
