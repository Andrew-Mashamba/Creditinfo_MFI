<div>
    <div class="h-16 border flex justify-between items-center w-full px-5 py-2 shadow-sm mb-4">
        ...
        <div wire:loading.remove wire:target="back" >
            <p class="font-semibold ml-3 text-slate-600">Edit user : {{Session::get('clientToEditName')}}</p>
                        ...
                        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                                    ...
                                    <x-slot name="form">
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            <h3 class="text-lg font-medium text-gray-900">
                                                {{ __('Current client image.') }}
                                            </h3>

                                            <div class="mt-3 max-w-xl text-sm text-gray-600">
                                                <p>
                                                    {{ __('This is an official client image for visual identification.') }}
                                                </p>
                                            </div>
                                        </div>
                                        <br>
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateNames">
                                    <x-slot name="title">
                                        {{ __('Names of the client') }}
                                    </x-slot>

                                    <x-slot name="description">
                                        {{ __('Update names of the client') }}
                                    </x-slot>
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateIncorporationNumber">
                                    ...
                                    <x-slot name="description">
                                        {{ __('Edit the incorporation number of the client.') }}
                                    </x-slot>
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updatePhoneNumber">
                                    ...
                                    <x-slot name="description">
                                        {{ __('Edit the office phone number of the client.') }}
                                    </x-slot>
                                    ...
                                    <x-slot name="form">
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <x-jet-input id="phone_number" type="text" class="mt-1 block w-full bg-gray-100 text-gray-500 cursor-not-allowed" wire:model.defer="phone_number" disabled />
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateMobilePhoneNumber">
                                    ...
                                    <x-slot name="description">
                                        {{ __('Edit the mobile phone number of the client.') }}
                                    </x-slot>
                                    ...
                                    <x-slot name="form">
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <div class="mt-3 max-w-xl text-sm text-gray-600">
                                                <p>
                                                    {{ __('The system sends user activity reports, system activity reports, payment and disbursement reports to this client mobile phone number.') }}
                                                </p>
                                            </div>
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <x-jet-input id="mobile_phone_number" type="text" class="mt-1 block w-full bg-gray-100 text-gray-500 cursor-not-allowed" wire:model.defer="mobile_phone_number" disabled />
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateEmail">
                                    ...
                                    <x-slot name="description">
                                        {{ __('Update client default email.') }}
                                    </x-slot>
                                    ...
                                    <x-slot name="form">
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <div class="mt-3 max-w-xl text-sm text-gray-600">
                                                <p>
                                                    {{ __('The system sends user activity reports, system activity reports, payment and disbursement reports to this client default email.') }}
                                                </p>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <x-jet-input id="email" type="email" class="mt-1 block w-full bg-gray-100 text-gray-500 cursor-not-allowed" wire:model.defer="email" disabled />
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateDateOfBirth">
                                    ...
                                    <x-slot name="description">
                                        {{ __('Edit the date of birth of the client.') }}
                                    </x-slot>
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateGender">
                                    ...
                                    <x-slot name="description">
                                        {{ __('Edit the gender of the client.') }}
                                    </x-slot>
                                    ...
                                    <x-slot name="form">
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <select wire:model.defer="gender" name="gender" id="gender" class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateMaritalStatus">
                                    ...
                                    <x-slot name="description">
                                        {{ __('Edit marital status of the client.') }}
                                    </x-slot>
                                    ...
                                    <x-slot name="form">
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <select wire:model.defer="marital_status" name="marital_status" id="marital_status" class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateBranch">
                                    ...
                                    <x-slot name="description">
                                        {{ __('Change the branch of the client.') }}
                                    </x-slot>
                                    ...
                                    <x-slot name="form">
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <div class="mt-3 max-w-xl text-sm text-gray-600">
                                                <p>
                                                    {{ __('By changing the branch of the client, you are transferring the client from the previous branch to newly selected branch. A new Account will be created for this client .') }}
                                                </p>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <select wire:model.bounce="branch" name="branch" id="branch" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateClientshipType">
                                    ...
                                    <x-slot name="description">
                                        {{ __('Change the membership type of the client.') }}
                                    </x-slot>
                                    ...
                                    <x-slot name="form">
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <div class="mt-3 max-w-xl text-sm text-gray-600">
                                                <p>
                                                    {{ __('By changing membership type, the system will prompt you add or remove items from the client record when required.') }}
                                                </p>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <select wire:model.bounce="membership_type" name="membership_type" id="membership_type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateStreet">
                                    ...
                                    <x-slot name="description">
                                        {{ __('Edit the residential street of the client.') }}
                                    </x-slot>
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateAddress">
                                    ...
                                    <x-slot name="description">
                                        {{ __('Edit the residential address of the client.') }}
                                    </x-slot>
                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateNotes">
                                    ...
                                    <x-slot name="description">
                                        {{ __('Add/Edit notes for this client.') }}
                                    </x-slot>
                                ...
                                <x-jet-action-section>
                                    ...
                                    <x-slot name="content">
                                        <div class="max-w-xl text-sm text-gray-600">
                                            {{ __('Once this client is suspended, all of his/her/its resources and data will continue to available upon request. Automatic payments and manual payments services, will not be available for this client') }}
                                        </div>
                                        ...
                                        <x-jet-dialog-modal wire:model="confirmingUserDeletion">
                                            ...
                                            <x-slot name="content">
                                                {{ __('Are you sure you want to suspend this client? Please enter your password to confirm.') }}
