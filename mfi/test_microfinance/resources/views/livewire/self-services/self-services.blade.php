        ...
        <div class="flex gap-6">
            ...
            <div class="w-80 bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="p-6 border-b border-gray-100">
                    <div class="relative">
                        <input type="text" placeholder="Search services..." class="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 bg-gray-50 hover:bg-white focus:bg-white" aria-label="Search services" />
                ...
                <div class="p-4">
                    ...
                    <nav class="space-y-2">
                        ...
                        <button wire:click="$set('selectedMenu', 'dashboard')" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $selectedMenu === 'dashboard' ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                        ...
                        <button wire:click="$set('selectedMenu', 'leave')" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $selectedMenu === 'leave' ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                        ...
                        <button wire:click="$set('selectedMenu', 'materials')" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $selectedMenu === 'materials' ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                        ...
                        <button wire:click="$set('selectedMenu', 'resignation')" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $selectedMenu === 'resignation' ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                        ...
                        <button wire:click="$set('selectedMenu', 'travel')" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $selectedMenu === 'travel' ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                        ...
                        <button wire:click="$set('selectedMenu', 'training')" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $selectedMenu === 'training' ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                        ...
                        <button wire:click="$set('selectedMenu', 'overtime')" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $selectedMenu === 'overtime' ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                        ...
                        <button wire:click="$set('selectedMenu', 'payslip')" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $selectedMenu === 'payslip' ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                        ...
                        <button wire:click="$set('selectedMenu', 'general')" class="relative w-full group transition-all duration-200">
                            <div class="flex items-center p-3 rounded-xl transition-all duration-200 {{ $selectedMenu === 'general' ? 'bg-red-600 text-white shadow-lg' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}">
                    ...
                    <div class="p-8 min-h-[400px]">
                        @switch($selectedMenu)
                            @case('dashboard')
                                ...
                                @if($employee)
                                <div class="mb-6 bg-gradient-to-r from-red-50 to-indigo-50 rounded-xl p-6 border border-red-200">
                                    <h3 class="text-lg font-semibold text-red-900 mb-2">Employee Information</h3>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                                    <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border border-red-200">
                                        <h3 class="text-lg font-semibold text-red-900 mb-2">Leave Balance</h3>
                                        <div class="text-3xl font-bold text-red-900">{{ $remainingLeaveDays }} days</div>
                                    </div>
                                    ...
                                    <form wire:submit.prevent="submitLeaveRequest">
                                        <div class="space-y-6">
                                            <div>
                                                ...
                                                <select wire:model="leaveType" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <input type="date" wire:model="leaveStartDate" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500">
                                                    @error('leaveStartDate') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 mb-2">End Date</label>
                                                    <input type="date" wire:model="leaveEndDate" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500">
                                            ...
                                            <div>
                                                ...
                                                <textarea wire:model="leaveReason" rows="4" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="Please provide details..."></textarea>
                                                @error('leaveReason') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                            </div>
                                            
                                            <div class="bg-red-50 rounded-lg p-4">
                                                <p class="text-sm text-red-800">Your current leave balance: <strong>{{ $remainingLeaveDays }} days</strong></p>
                                            </div>
                                            ...
                                            <div class="flex justify-end space-x-3">
                                                ...
                                                <button type="submit" class="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-800">
                                                    Submit Request
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <form wire:submit.prevent="submitMaterialsRequest">
                                        <div class="space-y-6">
                                            <div>
                                                ...
                                                <textarea wire:model="materialItems" rows="3" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="List the materials or equipment you need..."></textarea>
                                            ...
                                            <div>
                                                ...
                                                <textarea wire:model="materialPurpose" rows="4" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="Explain why you need these materials..."></textarea>
                                    ...
                                    <form wire:submit.prevent="submitResignationRequest">
                                        <div class="space-y-6">
                                            <div>
                                                ...
                                                <input type="date" wire:model="resignationDate" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500">
                                            ...
                                            <div>
                                                ...
                                                <textarea wire:model="resignationReason" rows="6" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="Please provide your reason for resignation..."></textarea>
                                ...
                                <div class="max-w-2xl">
                                    <div class="mb-6">
                                        <div class="flex space-x-4">
                                            <button wire:click="$set('requestType', 'travel')" class="px-4 py-2 rounded-lg {{ $requestType == 'travel' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-700' }}">
                                                Travel Request
                                            </button>
                                            <button wire:click="$set('requestType', 'advance')" class="px-4 py-2 rounded-lg {{ $requestType == 'advance' ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-700' }}">
                                                Salary Advance
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <form wire:submit.prevent="submitTravelRequest">
                                        <div class="space-y-6">
                                            <div>
                                                ...
                                                <input type="text" wire:model="travelDestination" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="City, Country">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 mb-2">Start Date</label>
                                                    <input type="date" wire:model="travelStartDate" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500">
                                                    @error('travelStartDate') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 mb-2">End Date</label>
                                                    <input type="date" wire:model="travelEndDate" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500">
                                            ...
                                            <div>
                                                ...
                                                <textarea wire:model="travelPurpose" rows="4" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="Business meeting, conference, training..."></textarea>
                                    ...
                                    <form wire:submit.prevent="submitAdvanceRequest">
                                        <div class="space-y-6">
                                            <div>
                                                ...
                                                <input type="number" wire:model="advanceAmount" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="Enter amount">
                                            ...
                                            <div>
                                                ...
                                                <textarea wire:model="advanceReason" rows="4" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="Explain why you need the advance..."></textarea>
                                    ...
                                    <form wire:submit.prevent="submitTrainingRequest">
                                        <div class="space-y-6">
                                            <div>
                                                ...
                                                <input type="text" wire:model="trainingTitle" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="Name of the training or workshop">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 mb-2">Start Date</label>
                                                    <input type="date" wire:model="trainingStartDate" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500">
                                                    @error('trainingStartDate') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 mb-2">End Date</label>
                                                    <input type="date" wire:model="trainingEndDate" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" wire:model="trainingLocation" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="Venue or online">
                                    ...
                                    <form wire:submit.prevent="submitOvertimeRequest">
                                        <div class="space-y-6">
                                            <div>
                                                ...
                                                <input type="date" wire:model="overtimeDate" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500">
                                            ...
                                            <div>
                                                ...
                                                <input type="number" wire:model="overtimeHours" step="0.5" min="1" max="12" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="Enter overtime hours">
                                            ...
                                            <div>
                                                ...
                                                <textarea wire:model="overtimeReason" rows="4" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="Explain the work done during overtime..."></textarea>
                                                @error('overtimeReason') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                            </div>
                                            
                                            <div class="bg-red-50 rounded-lg p-4">
                                                <p class="text-sm text-red-800">Overtime rates are calculated based on company policy.</p>
                                            </div>
                                ...
                                <div class="max-w-4xl">
                                    <div class="mb-6">
                                        ...
                                        <form wire:submit.prevent="submitPayslipRequest" class="mb-8">
                                            <div class="flex space-x-4">
                                                <select wire:model="documentType" class="flex-1 rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <span class="px-2 py-1 text-xs font-medium rounded-full
                                                                ...
                                                                @elseif($payroll->status == 'approved') bg-red-100 text-red-800
                                                                @else bg-yellow-100 text-yellow-800 @endif">
                                                                {{ ucfirst($payroll->status) }}
                                                            </span>
                                                        </td>
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <button wire:click="viewPayslip({{ $payroll->id }})" class="text-red-600 hover:underline text-sm">View Payslip</button>
                                                        </td>
                                                    </tr>
                                                @empty
                                                    <tr>
                                    ...
                                    <form wire:submit.prevent="submitGeneralRequest">
                                        <div class="space-y-6">
                                            <div>
                                                ...
                                                <select wire:model="requestDepartment" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" wire:model="requestSubject" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="Brief description of your request">
                                            ...
                                            <div>
                                                ...
                                                <textarea wire:model="requestDetails" rows="6" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500" placeholder="Provide full details of your request..."></textarea>
