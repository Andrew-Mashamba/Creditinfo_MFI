            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    @if($currentStatus['submitted_date'])
                        <p class="text-sm text-red-700 mt-1">Submitted on: {{ \Carbon\Carbon::parse($currentStatus['submitted_date'])->format('M d, Y') }}</p>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
            <nav class="flex space-x-8 px-6" aria-label="Tabs">
                ...
                <button wire:click="$set('selectedTab', 'status')" 
                        class="py-4 px-1 border-b-2 font-medium text-sm {{ $selectedTab == 'status' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                    Exit Status
                </button>
                <button wire:click="$set('selectedTab', 'guidelines')" 
                        class="py-4 px-1 border-b-2 font-medium text-sm {{ $selectedTab == 'guidelines' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                    Guidelines
                </button>
            </nav>
        </div>
