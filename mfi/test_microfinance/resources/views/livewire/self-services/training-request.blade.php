        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
            <nav class="flex space-x-8 px-6" aria-label="Tabs">
                ...
                <button wire:click="$set('selectedTab', 'catalog')" 
                        class="py-4 px-1 border-b-2 font-medium text-sm {{ $selectedTab == 'catalog' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                    Training Catalog
                </button>
            </nav>
        </div>
            ...
            @switch($selectedTab)
                ...
                @case('history')
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6 bg-red-50 rounded-lg p-4">
                            <h4 class="text-sm font-medium text-red-900 mb-2">Active Certifications</h4>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200 hover:border-red-300 transition-colors">
                                        ...
                                        <p class="mt-1 text-sm font-medium text-red-600">TSH {{ number_format($course['cost']) }}</p>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
