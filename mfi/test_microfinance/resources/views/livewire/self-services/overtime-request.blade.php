        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
            <nav class="flex space-x-8 px-6" aria-label="Tabs">
                ...
                <button wire:click="$set('selectedTab', 'summary')" 
                        class="py-4 px-1 border-b-2 font-medium text-sm {{ $selectedTab == 'summary' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                    Summary & Rates
                </button>
            </nav>
        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="bg-red-50 rounded-lg p-4">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <p class="text-sm text-red-600 font-medium">Total Hours</p>
                                            <p class="text-2xl font-bold text-red-900">{{ $overtimeSummary['hours_worked'] }}</p>
                                        </div>
