        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
            <nav class="flex space-x-8 px-6" aria-label="Tabs">
                <button wire:click="$set('selectedTab', 'request')" 
                        class="py-4 px-1 border-b-2 font-medium text-sm {{ $selectedTab == 'request' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                    New Request
                </button>
                ...
                <button wire:click="$set('selectedTab', 'faqs')" 
                        class="py-4 px-1 border-b-2 font-medium text-sm {{ $selectedTab == 'faqs' ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                    FAQs
                </button>
            </nav>
        </div>
            ...
            @switch($selectedTab)
                    ...
                    <div class="p-6">
                        ...
                        <form wire:submit.prevent="submitRequest" class="space-y-6">
                            ...
                            <div class="flex justify-end">
                                <button type="submit" 
                                        class="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-6 rounded-lg transition duration-150 ease-in-out">
                                    Submit Request
                                </button>
                            </div>
                        </form>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                            ...
                            <div class="bg-red-50 rounded-lg p-3 text-center">
                                ...
                                <p class="text-sm text-red-700">In Progress</p>
                            </div>
                ...
                @case('faqs')
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6">
                            <div class="relative">
                                <input type="text" wire:model.debounce.300ms="searchFaq" 
                                       class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring-red-500 pl-10"
                        ...
                        <!-- Still Need Help -->
                        <div class="mt-8 bg-red-50 border border-red-200 rounded-lg p-6 text-center">
                            <h4 class="text-lg font-semibold text-red-900 mb-2">Still have questions?</h4>
                            <p class="text-sm text-red-700 mb-4">If you couldn't find the answer you're looking for, submit a new request.</p>
                            <button wire:click="$set('selectedTab', 'request')" 
