                    ...
                    <nav class="space-y-2">
                        @foreach ($sections as $section)
                            <button wire:click="$set('selectedSection', {{ $section['id'] }})" class="relative w-full group transition-all duration-200">
                                <div class="flex items-center p-3 rounded-xl transition-all duration-200 @if ($selectedSection == $section['id']) bg-red-600 text-white shadow-lg @else bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900 @endif">
                                    <div class="mr-3">
                ...
                @switch($selectedSection)
                    @case(1)
                        ...
                        <div class="p-6 space-y-6">
                                                    ...
                                                    <div class="flex items-center justify-between">
                                                        <div class="flex items-center space-x-3">
                                                            <div class="w-8 h-8 bg-red-100 rounded-full flex items-center justify-center">
                                                                <span class="text-xs font-medium text-red-600">{{ substr($approver->approver->name ?? 'U', 0, 1) }}</span>
                                                            </div>
                                                            <span class="text-sm text-gray-900">{{ $approver->approver->name ?? 'Unknown' }}</span>
                                                        </div>
                                                        <span class="text-sm font-semibold text-red-600">{{ $approver->approval_count }}</span>
                                                    </div>
                                                @endforeach
                                            </div>
                                        @else
                            ...
                            <!-- Quick Actions -->
                            <div class="bg-gradient-to-r from-gray-50 to-red-50 rounded-xl p-6 border border-gray-200">
                                <h3 class="text-lg font-semibold text-gray-900 mb-4">Quick Actions</h3>
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    <button wire:click="create" class="flex items-center justify-center p-4 bg-white rounded-lg border border-gray-200 hover:border-red-300 hover:bg-red-50 transition-all duration-200 group">
                                        <div class="text-center">
                                            <svg class="w-6 h-6 text-red-600 mx-auto mb-2 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                                            </svg>
                                            <span class="text-sm font-medium text-gray-700 group-hover:text-red-600">Add Flow</span>
                                        </div>
                                    </button>
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="relative">
                                        <input type="text" 
                                               ...
                                               class="w-64 rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 pl-10">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                                            </svg>
                                    ...
                                    <button wire:click="create" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-800 transition-colors">
                                        Add Flow
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="mb-6 bg-gray-50 rounded-lg p-4">
                                <div class="flex flex-wrap items-center gap-4">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <select wire:model="selectedCategory" class="border border-gray-300 rounded-md text-sm px-3 py-1 focus:ring-red-500 focus:border-red-500">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <select wire:model="filterStatus" class="border border-gray-300 rounded-md text-sm px-3 py-1 focus:ring-red-500 focus:border-red-500">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <select wire:model="filterRole" class="border border-gray-300 rounded-md text-sm px-3 py-1 focus:ring-red-500 focus:border-red-500">
                                        ...
                                        @forelse($configs as $config)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <button wire:click="edit({{ $config->id }})" class="text-red-600 hover:text-red-900 mr-3">Edit</button>
                            ...
                            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
                                <div class="flex items-center space-x-4">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <select wire:model="perPage" class="border border-gray-300 rounded-md text-sm px-2 py-1 focus:ring-red-500 focus:border-red-500">
