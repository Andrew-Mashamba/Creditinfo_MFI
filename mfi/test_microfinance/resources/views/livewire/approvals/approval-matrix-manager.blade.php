            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <button wire:click="create" class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded">
                            ...
                            <form wire:submit.prevent="save">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <select wire:model="processType" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model="processName" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model="processCode" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                                        @error('processCode') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                    </div>

                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Level</label>
                                        <input type="number" wire:model="level" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="approverRole" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="approverSubRole" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" wire:model="minAmount" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" wire:model="maxAmount" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                                        @error('maxAmount') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                    </div>

                                    <div class="col-span-2">
                                        <label class="flex items-center">
                                            <input type="checkbox" wire:model="isActive" class="rounded border-gray-300 text-red-600 shadow-sm focus:border-red-500 focus:ring-red-500">
