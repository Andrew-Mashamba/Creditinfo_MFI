    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <button type="button" 
                    ...
                    class="p-2 text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 rounded-full transition-colors"
        ...
        <form wire:submit.prevent="save" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 py-2.5 px-3.5 transition-colors text-gray-900 placeholder-gray-400" 
                               required 
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" 
                                  ...
                                  class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 py-2.5 px-3.5 transition-colors text-gray-900 placeholder-gray-400 resize-y" 
                                  required 
                    ...
                    <div class="flex flex-wrap gap-6">
                        <label class="inline-flex items-center">
                            <input type="checkbox" 
                                   ...
                                   class="h-5 w-5 rounded border-gray-300 text-red-600 focus:ring-red-500 shadow-sm transition-colors" 
                    ...
                    @if($requiresFirstChecker)
                        <div>
                            ...
                            <select id="firstCheckerRoles" 
                                    ...
                                    multiple 
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 py-2.5 px-3.5 transition-colors text-gray-900" 
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-200">
                <button type="button" 
                        wire:click="$set('showForm', false)" 
                        class="px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-colors font-medium text-sm">
                    Cancel
                </button>
                <button type="submit" 
                        class="px-4 py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-800 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-colors font-medium text-sm">
