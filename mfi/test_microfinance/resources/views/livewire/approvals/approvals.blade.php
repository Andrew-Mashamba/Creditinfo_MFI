                    ...
                    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                @endphp
                                <p class="text-lg font-semibold text-red-600">{{ number_format($avgTime, 1) }}d</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mb-6 bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                @php
                    ...
                    $categoryColors = [
                        'LOAN_APP' => ['bg' => 'bg-red-50', 'border' => 'border-red-200', 'text' => 'text-red-700', 'icon' => 'text-red-600'],
                        'LOAN_DISB' => ['bg' => 'bg-indigo-50', 'border' => 'border-indigo-200', 'text' => 'text-red-900', 'icon' => 'text-indigo-600'],
                ...
                <div class="p-4 border-b border-gray-100">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select wire:model.live="filterStatus" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 text-sm">
                        ...
                        <div>
                            ...
                            <select wire:model.live="filterProcess" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 text-sm">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                                ...
                                <input type="date" wire:model.live="filterDateFrom" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">To</label>
                                <input type="date" wire:model.live="filterDateTo" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 text-sm">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="px-8 py-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-4">
                                <select wire:model.live="perPage" class="rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 text-sm">
                    ...
                    <div class="bg-white px-6 py-4 flex items-center justify-between border-t border-gray-200">
                        <div class="flex-1 flex justify-between sm:hidden">
                            <button wire:click.stop="previousPage" 
                                class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors duration-200 {{ $approvals->onFirstPage() ? 'opacity-50 cursor-not-allowed' : '' }}"
                            ...
                            <button wire:click.stop="nextPage" 
                                class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors duration-200 {{ $approvals->hasMorePages() ? '' : 'opacity-50 cursor-not-allowed' }}"
                    ...
                    <div class="bg-gradient-to-r from-red-600 to-red-700 px-6 py-4">
                        <div class="flex items-center justify-between">
                            ...
                            <button wire:click.stop="closeLoanAssessmentModal" type="button"
                                class="text-white hover:text-red-600 focus:outline-none focus:ring-2 focus:ring-red-300 rounded-md p-1">
    ...
    <div class="fixed bottom-0 right-0 m-6 z-50 w-96"> <!-- Increased width to 384px (w-96) -->
        <div class="bg-white shadow-xl rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden transition-all duration-300
            {{ session('notification.type') === 'success' ? 'bg-green-50 border-l-4 border-green-400' : 
               ...
               (session('notification.type') === 'warning' ? 'bg-yellow-50 border-l-4 border-yellow-400' : 'bg-red-50 border-l-4 border-red-400')) }}">
            <div class="p-4">
            ...
            (session('notification.type') === 'error' ? 'text-red-800' :
                (session('notification.type') === 'warning' ? 'text-yellow-800' : 'text-red-800')) }}">
