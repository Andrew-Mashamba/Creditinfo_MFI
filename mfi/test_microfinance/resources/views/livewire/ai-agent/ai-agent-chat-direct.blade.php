    ...
    <div class="bg-white border-b px-4 py-3 flex items-center justify-between">
        <div class="flex items-center space-x-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500">MFI Intelligence System (Direct Mode)</p>
            </div>
        </div>
        
        <div class="flex items-center space-x-2">
            <button wire:click="newConversation" class="px-3 py-1.5 text-sm bg-red-600 text-white rounded-lg hover:bg-red-800">
                New Chat
            </button>
    ...
    <div class="flex-1 overflow-y-auto p-4" id="messages-container">
        ...
        <div class="max-w-2xl mx-auto text-center py-12">
            ...
            <div class="grid grid-cols-2 gap-3 max-w-lg mx-auto">
                <button wire:click="sendQuickMessage('Show me account summary')" class="p-3 text-left bg-white rounded-lg border border-gray-200 hover:border-red-300 hover:shadow">
                ...
                <button wire:click="sendQuickMessage('Generate monthly report')" class="p-3 text-left bg-white rounded-lg border border-gray-200 hover:border-red-300 hover:shadow">
                ...
                <button wire:click="sendQuickMessage('Show members list')" class="p-3 text-left bg-white rounded-lg border border-gray-200 hover:border-red-300 hover:shadow">
                    <div class="text-sm font-medium text-gray-900">Members</div>
                    <div class="text-xs text-gray-500 mt-1">View member list</div>
                </button>
                
                <button wire:click="sendQuickMessage('Show loan portfolio')" class="p-3 text-left bg-white rounded-lg border border-gray-200 hover:border-red-300 hover:shadow">
        ...
        <div class="space-y-4 max-w-4xl mx-auto">
                ...
                <div class="flex justify-end">
                    <div class="max-w-2xl">
                        <div class="bg-red-600 text-white rounded-lg px-4 py-2">
                            {{-- SECURITY: User messages are escaped to prevent XSS --}}
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div class="flex-1">
                                <div class="bg-white rounded-lg px-4 py-2 shadow-sm border {{ $message['isError'] ?? false ? 'border-red-300' : 'border-gray-200' }}">
                                    {{-- SECURITY: AI responses are escaped to prevent XSS attacks --}}
                                    {{-- If formatted content is needed, implement a proper HTML sanitizer --}}
                                    <div class="text-sm whitespace-pre-wrap {{ $message['isError'] ?? false ? 'text-red-600' : 'text-gray-800' }}">
            ...
            <div class="flex justify-start">
                <div class="max-w-2xl">
                    <div class="flex items-start space-x-3">
                        <div class="w-8 h-8 bg-red-100 rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg class="w-5 h-5 text-red-900 animate-spin" fill="none" viewBox="0 0 24 24">
    ...
    <div class="bg-white border-t px-4 py-4">
        <form wire:submit.prevent="processDirectMessage" class="max-w-4xl mx-auto">
            <div class="flex space-x-3">
                ...
                <button type="submit" 
                        class="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-800 disabled:opacity-50 disabled:cursor-not-allowed"
