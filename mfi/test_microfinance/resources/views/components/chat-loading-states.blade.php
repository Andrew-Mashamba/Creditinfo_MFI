...
<div class="flex items-start space-x-3" 
    ...
    <div class="flex-shrink-0 relative">
        <div class="absolute inset-0 bg-red-400 rounded-xl blur-xl opacity-50 animate-pulse"></div>
        <div class="relative w-10 h-10 bg-red-800 rounded-xl flex items-center justify-center shadow-lg">
            <!-- Spinning Brain Icon -->
    ...
    <div class="flex-1 max-w-3xl">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="h-1 bg-gray-100 relative overflow-hidden">
                <div class="absolute inset-0 bg-red-500 animate-shimmer"></div>
            </div>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1 max-w-xs">
                                <div class="h-1.5 bg-gray-200 rounded-full overflow-hidden">
                                    <div class="h-full bg-red-500 rounded-full animate-progress"></div>
                                </div>
                            </div>
                        </div>
