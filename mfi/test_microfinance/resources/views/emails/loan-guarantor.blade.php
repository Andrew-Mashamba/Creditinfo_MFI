...
<head>
    <meta charset="UTF-8">
    <title>Loan Disbursement Notification - MFI Management System</title>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="font-size: 16px; line-height: 1.7; color: #555;">
                ...
                at MFI Management System. The loan has been successfully disbursed and is now active.
            </p>
            ...
            <p style="font-size: 16px; line-height: 1.7; color: #555; margin-top: 30px;">
                Thank you for your support and trust in MFI Management System. Your role as a guarantor is crucial in helping 
            ...
            <p style="margin-top: 30px; font-weight: 600; color: #003366;">
                Best regards,<br>
                <strong>MFI Management System Team</strong>
            </p>
        </div>
