...
<head>
    ...
    <title>Your System Account Credentials - {{ config('app.name', 'MFI Management System') }}</title>
...
<body>
    <div class="header">
        ...
        <p>Welcome to {{ config('app.name', 'MFI Management System') }}</p>
    </div>
    
    <div class="content">
        <h2>Hello {{ $user->name }},</h2>
        
        <p>Your account has been successfully created in the {{ config('app.name', 'MFI Management System') }}. You now have access to the system and can begin using all available features.</p>
        ...
        <div class="instructions">
            ...
            <ol>
                <li><strong>Visit the system:</strong> <a href="http://saccos-uat.intra.nbc.co.tz/">http://saccos-uat.intra.nbc.co.tz/</a></li>
        ...
        <div style="text-align: center;">
            <a href="http://saccos-uat.intra.nbc.co.tz/" class="button">🚀 Login to System</a>
        </div>
        ...
        <p>Best regards,<br>
        <strong>{{ config('app.name', 'MFI Management System') }} Team</strong></p>
    </div>
    ...
    <div class="footer">
        ...
        <p>&copy; {{ date('Y') }} {{ config('app.name', 'MFI Management System') }}. All rights reserved.</p>
    </div>
</body>
</html>
