...
The MFI Management System system now includes comprehensive SMS notifications for loan disbursement and other member services. This integration uses the NBC SMS Notification Engine API v2.0.0 to send professional SMS messages to both members and guarantors.
...
Contact: +255 22 219 7000. MFI Management System
```
...
### Member Registration
```
Dear [Member Name], welcome to MFI Management System! 
...
Control No: [Control Number], Amount: TZS [Amount]. 
Due: [Due Date]. 
Pay via NBC Kiganjani, Wakala or branches. MFI Management System
```
