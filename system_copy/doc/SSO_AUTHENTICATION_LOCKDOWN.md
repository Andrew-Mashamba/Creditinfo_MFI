...
The NBC SACCOS system has been secured to use **centralized Single Sign-On (SSO) authentication ONLY**. All self-service authentication features have been disabled and redirect to the central authentication portal.
...
1. **Access Application**: Navigate to NBC SACCOS URL
   ```
...
4. **Select System**: Choose NBC SACCOS from available systems
