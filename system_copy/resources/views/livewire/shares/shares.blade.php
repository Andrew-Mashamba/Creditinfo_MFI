        ...
        <div class="w-full max-w-xs shrink-0">
         <div class="bg-white p-6 rounded-2xl shadow-md border border-gray-100 bg-indigo-50 p-6 rounded-2xl shadow-md border border-gray-100">
            ...
            <button wire:click="showRedeemSharesModal" class="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium
             @if($this->sidebar_view == 'redeem_shares') text-white bg-blue-800 hover:bg-blue-50 @else text-gray-700 bg-gray-50 hover:bg-gray-100 hover:text-blue-900 @endif rounded-lg transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
            ...
            <button wire:click="showShareStatementView" class="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium
             @if($this->sidebar_view == 'share_statement') text-white bg-blue-800 hover:bg-blue-50 @else text-gray-700 bg-gray-50 hover:bg-gray-100 hover:text-blue-900 @endif rounded-lg transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
