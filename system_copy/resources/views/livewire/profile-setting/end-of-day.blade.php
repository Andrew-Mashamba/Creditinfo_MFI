            ...
            <header class="flex items-center justify-between mb-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <button wire:click="toggleAutoRefresh" class="relative inline-flex h-6 w-11 items-center rounded-full {{ $autoRefresh ? 'bg-blue-900' : 'bg-gray-200' }} transition-colors">
            ...
            <div class="mt-3">
                ...
                <div class="flex gap-4 mt-4 mb-4">
                    ...
                    <button wire:click="loadLogs" 
                            class="px-4 py-1 bg-blue-500 text-white text-sm rounded-md hover:bg-blue-900">
                        Refresh
                    </button>
