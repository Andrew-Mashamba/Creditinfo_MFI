<div>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="inline-flex rounded-lg border border-gray-200 bg-white p-1">
                    <button wire:click="setViewMode('table')" class="px-3 py-1.5 text-sm font-medium rounded-md transition-colors {{ $viewMode === 'table' ? 'bg-blue-900 text-white' : 'text-gray-600 hover:text-gray-900' }}">
                        <svg class="w-4 h-4 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
                        </svg>
                        Table
                    </button>
                    <button wire:click="setViewMode('calendar')" class="px-3 py-1.5 text-sm font-medium rounded-md transition-colors {{ $viewMode === 'calendar' ? 'bg-blue-900 text-white' : 'text-gray-600 hover:text-gray-900' }}">
                        <svg class="w-4 h-4 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button wire:click="loadTasks" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
        ...
        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-2xl font-bold text-blue-900">{{ $totalTaskCount }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4 mb-6">
        <div class="flex flex-wrap items-center gap-4">
            <div class="flex-1 min-w-[200px]">
                ...
                <input type="text" wire:model.debounce.300ms="searchTerm" placeholder="Search tasks..." class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="w-48">
                <label class="block text-xs font-medium text-gray-500 mb-1">Category</label>
                <select wire:model="categoryFilter" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="w-40">
                ...
                <select wire:model="frequencyFilter" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="w-36">
                ...
                <select wire:model="enabledFilter" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150 {{ !($task['is_enabled'] ?? true) ? 'opacity-60 bg-gray-50' : '' }}" wire:key="task-{{ $task['id'] ?? $index }}">
                        <td class="px-4 py-3 text-center">
                            ...
                            <button
                                ...
                                class="relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 {{ ($task['is_enabled'] ?? true) ? 'bg-emerald-500' : 'bg-gray-300' }}"
                                role="switch"
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <button
                                    ...
                                    class="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
                                >
                                ...
                                <button
                                    ...
                                    class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
                                >
                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div class="grid grid-cols-7 gap-1">
                @foreach($calendarDays as $dayData)
                    ...
                    <div
                        ...
                        class="h-24 p-2 rounded-lg border cursor-pointer transition-all duration-200 hover:border-blue-300 hover:shadow-sm {{ $dayData['isToday'] ? 'border-blue-500 bg-blue-50' : 'border-gray-200 bg-white' }}"
                    >
                        <div class="flex justify-between items-start">
                            <span class="text-sm font-medium {{ $dayData['isToday'] ? 'text-blue-600' : 'text-gray-900' }}">{{ $dayData['day'] }}</span>
                            @if($dayData['data'])
        ...
        <div class="px-6 py-3 border-t border-gray-200 bg-gray-50 flex items-center space-x-6 text-xs">
            ...
            <div class="flex items-center">
                <span class="w-3 h-3 rounded border-2 border-blue-500 mr-2"></span>
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button wire:click="closeOutput" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
                        Close
                    </button>
                </div>
            </div>
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                            Execution History: <span class="font-mono text-blue-600">{{ $selectedTask }}</span>
                        </h3>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2">
                                        ...
                                        @else
                                        <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800">Running</span>
                                        @endif
                                    </td>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button wire:click="closeHistory" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
                        Close
                    </button>
                </div>
            </div>
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="max-h-96 overflow-y-auto">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="p-3 rounded-lg border {{ $task['status'] === 'success' ? 'border-green-200 bg-green-50' : ($task['status'] === 'failed' ? 'border-red-200 bg-red-50' : 'border-blue-200 bg-blue-50') }}">
                                <div class="flex items-center justify-between">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button wire:click="closeDateModal" type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
                        Close
                    </button>
                </div>
            </div>
    ...
    <div class="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4">
        <div class="flex">
            ...
            <div class="ml-3">
                <h3 class="text-sm font-medium text-blue-800">About Scheduled Tasks</h3>
                <div class="mt-2 text-sm text-blue-700">
                    <ul class="list-disc list-inside space-y-1">
                        <li>Tasks are executed automatically by the Laravel scheduler via <code class="bg-blue-100 px-1 rounded">saccos-scheduler.service</code></li>
