    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
                ...
                <input type="date" wire:model="dateFrom" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">To Date</label>
                <input type="date" wire:model="dateTo" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Log Level</label>
                <select wire:model="logLevel" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
            ...
            <div>
                ...
                <input type="text" wire:model="selectedUser" placeholder="Filter by user ID" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Search</label>
                <input type="text" wire:model.debounce.500ms="searchTerm" placeholder="Search logs..." class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
            </div>
        </div>
                    ...
                    @forelse($logs as $index => $log)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button wire:click="showDetails({{ $index }})" class="text-blue-600 hover:text-blue-900">
                                    View Details
                                </button>
                            </td>
                        </tr>
                ...
                <div class="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1">
                                <span class="px-2 py-1 bg-{{ $selectedLog['level'] === 'ERROR' ? 'red' : ($selectedLog['level'] === 'WARNING' ? 'yellow' : 'blue') }}-100 text-{{ $selectedLog['level'] === 'ERROR' ? 'red' : ($selectedLog['level'] === 'WARNING' ? 'yellow' : 'blue') }}-800 rounded text-sm font-medium">
