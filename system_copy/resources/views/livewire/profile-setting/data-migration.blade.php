                    ...
                    <div class="text-center">
                        ...
                        <div wire:loading wire:target="migrationFile" class="mt-4">
                            <div class="bg-gray-200 rounded-full h-2 overflow-hidden">
                                <div class="bg-blue-900 h-full rounded-full animate-pulse" style="width: 50%"></div>
                            </div>
    ...
    @if($migrationFile && !$isProcessing)
        <div class="flex justify-between items-center">
            ...
            <button 
                ...
                class="inline-flex items-center px-6 py-3 bg-blue-900 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
            >
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="ml-3 flex-1">
                    ...
                    <div class="mt-3">
                        <div class="bg-blue-100 rounded-full h-2 overflow-hidden">
                            <div class="bg-blue-900 h-full rounded-full transition-all duration-500" style="width: {{ $processingProgress }}%"></div>
                        </div>
