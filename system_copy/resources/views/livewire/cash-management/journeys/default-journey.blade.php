            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <button class="w-full bg-blue-900 text-white rounded-lg px-4 py-2 hover:bg-blue-700">
                            Apply Filters
                        </button>
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    @forelse($recentReports ?? [] as $report)
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            ...
                            <button class="px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-700 text-sm font-semibold">
                                Download
                            </button>
                        </div>
                    @empty
