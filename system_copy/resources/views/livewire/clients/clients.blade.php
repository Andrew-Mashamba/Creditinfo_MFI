                            ...
                            <div wire:loading.remove wire:target="$set('activeTab')" class="min-h-[400px]">
                                ...
                                @if ($activeTab === 'member-exit')
                                    <div class="space-y-6">
                                        ...
                                        @if (session()->has('info'))
                                        <div class="rounded-lg border-l-4 border-blue-500 bg-blue-50 p-4" x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)">
                                            <div class="flex items-start">
                                                <svg class="mr-3 h-6 w-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                </svg>
                                                <div class="flex-1">
                                                    <h4 class="text-sm font-semibold text-blue-800">Information</h4>
                                            ...
                                            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                                ...
                                                <div class="flex items-end">
                                                    <button wire:click="searchMemberForExit"
                                                        class="rounded-lg bg-blue-900 px-6 py-2 text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                                                        Search Member
                                                    </button>
                                                </div>
                                            </div>
