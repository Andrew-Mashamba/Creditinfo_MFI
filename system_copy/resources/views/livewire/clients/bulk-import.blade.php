<div class="container mx-auto p-6">
    ...
    <div class="mb-6 flex items-center space-x-4">
        <div class="flex items-center">
            <div class="rounded-full h-8 w-8 flex items-center justify-center {{ $currentStep >= 1 ? 'bg-blue-900 text-white' : 'bg-gray-300 text-gray-600' }}">1</div>
            <span class="ml-2 {{ $currentStep >= 1 ? 'font-bold text-blue-700' : 'text-gray-500' }}">Upload</span>
        </div>
        <div class="h-1 w-8 bg-gray-300"></div>
        <div class="flex items-center">
            <div class="rounded-full h-8 w-8 flex items-center justify-center {{ $currentStep >= 2 ? 'bg-blue-900 text-white' : 'bg-gray-300 text-gray-600' }}">2</div>
            <span class="ml-2 {{ $currentStep >= 2 ? 'font-bold text-blue-700' : 'text-gray-500' }}">Preview</span>
        </div>
        <div class="h-1 w-8 bg-gray-300"></div>
        <div class="flex items-center">
            <div class="rounded-full h-8 w-8 flex items-center justify-center {{ $currentStep >= 3 ? 'bg-blue-900 text-white' : 'bg-gray-300 text-gray-600' }}">3</div>
            <span class="ml-2 {{ $currentStep >= 3 ? 'font-bold text-blue-700' : 'text-gray-500' }}">Process</span>
        </div>
        <div class="h-1 w-8 bg-gray-300"></div>
        <div class="flex items-center">
            <div class="rounded-full h-8 w-8 flex items-center justify-center {{ $currentStep == 4 ? 'bg-blue-900 text-white' : 'bg-gray-300 text-gray-600' }}">4</div>
    ...
    @if($currentStep === 1)
        <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            @if($uploadFile)
                <div class="mt-4">
                    <button wire:click="processFilePreview" class="bg-blue-900 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors" @if($isUploading) disabled @endif>
    ...
    @if($currentStep === 2)
        <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div class="flex justify-between mt-6">
                ...
                <button wire:click="processBulkUpload" class="bg-blue-900 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors" @if($errorCount > 0) disabled @endif>
                    <svg class="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    @if($currentStep === 3)
        <div class="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center">
            ...
            <div class="w-full max-w-md bg-gray-200 rounded-full h-4 mb-4">
                <div class="bg-blue-900 h-4 rounded-full transition-all duration-300" style="width: {{ $uploadProgress }}%"></div>
            </div>
