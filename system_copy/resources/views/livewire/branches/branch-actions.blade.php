...
<div class="flex space-x-2 items-center">
    ...
    <button type="button" wire:click="viewBranch({{ $id }})" 
        class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-white bg-blue-900 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
