            ...
            <div class="flex flex-col w-full">
                @foreach($this->columns as $index => $column)
                    @if ($column['hideable'] !== false)
                        <div>
                            <div class="@unless($column['hidden']) hidden @endif cursor-pointer w-full border-gray-800 border-b bg-gray-700 text-gray-500 hover:bg-blue-900 hover:text-white" wire:click="toggle({{$index}})">
