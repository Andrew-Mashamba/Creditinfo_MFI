...
<div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="p-6">
                @if($budgetCheckResult)
                    ...
                    <button wire:click="viewBudgetDetails" class="mt-4 w-full px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-800 transition">
            ...
            <div class="p-6">
                @if($approvalStatus && isset($approvalStatus['status']))
                    @if($approvalStatus['status'] === 'NOT_SUBMITTED')
                        <div class="text-center py-8">
                            ...
                            <button wire:click="submitForApproval"
                                class="px-6 py-3 bg-blue-900 text-white rounded-lg hover:bg-blue-800 transition flex items-center mx-auto"
                    ...
                    @elseif($approvalStatus['status'] === 'APPROVED')
                        ...
                        @else
                            <button wire:click="processMonthlyPayments"
                                class="w-full px-4 py-3 bg-blue-900 text-white rounded-lg hover:bg-blue-800 transition flex items-center justify-center">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @elseif($approvalStatus['status'] === 'REJECTED')
                        ...
                        <button wire:click="submitForApproval"
                            class="w-full px-4 py-3 bg-blue-900 text-white rounded-lg hover:bg-blue-800 transition">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-blue-900 rounded-lg shadow-md p-6 text-white">
        ...
        <div class="bg-blue-900 rounded-lg shadow-md p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-blue-100 text-sm font-medium">Total Gross</p>
        ...
        <div class="bg-blue-900 rounded-lg shadow-md p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-blue-100 text-sm font-medium">Total Deductions</p>
        ...
        <div class="bg-blue-900 rounded-lg shadow-md p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-blue-100 text-sm font-medium">Total Net Pay</p>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10 bg-blue-900 rounded-full flex items-center justify-center text-white font-semibold">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                <button wire:click="viewPayslip({{ $payroll->id }})"
                                    class="text-blue-900 hover:text-blue-700 inline-flex items-center">
            ...
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full">
                    ...
                    <div class="bg-white px-6 py-6">
                        ...
                        {{-- Net Pay --}}
                        <div class="bg-blue-900 rounded-lg p-6 text-white">
                            <div class="flex justify-between items-center">
                                <div>
                                    <p class="text-blue-100 text-sm mb-1">NET PAY</p>
                    ...
                    <div class="bg-gray-50 px-6 py-4 flex justify-end space-x-3">
                        ...
                        <button type="button" class="px-5 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-800 transition flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
