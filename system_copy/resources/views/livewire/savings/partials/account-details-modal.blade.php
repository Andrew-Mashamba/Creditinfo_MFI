<div class="fixed inset-0 bg-gray-600 bg-opacity-75 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
    <div class="relative bg-white rounded-lg shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <!-- Modal Header -->
        <div class="sticky top-0 bg-gradient-to-r from-blue-900 to-blue-700 px-6 py-4 rounded-t-lg z-10">
        ...
        <div class="p-6">
            <!-- Account Header Card -->
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-lg border-l-4 border-blue-600 shadow-md mb-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <div class="flex-shrink-0">
                            <div class="h-16 w-16 rounded-full bg-blue-900 flex items-center justify-center shadow-lg">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-3xl font-bold text-blue-900">{{ number_format($selectedAccountData->balance, 2) }}</p>
