<div class="space-y-4">
    ...
    @else
        <div class="mb-4 space-x-2">
            <button type="button" wire:click="toggleDebugInfo" class="px-3 py-1 bg-blue-900 text-white text-xs rounded hover:bg-blue-700">
                Show Debug Info
            </button>
        ...
        @if($originalLoan)
            <div class="bg-blue-50 border-2 border-blue-300 rounded-lg p-4 mb-4">
                <div class="flex items-center mb-3">
                    ...
                    <h3 class="text-sm font-bold text-blue-900">Restructured Loan Information</h3>
                </div>
                ...
                <div class="bg-white rounded-lg p-3 space-y-2 text-xs">
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <span class="text-blue-900 font-bold ml-1">{{ $originalLoan->loan_id ?? 'N/A' }}</span>
                        </div>
