<div>
    ...
    @else
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="{{ $entry['type'] === 'topup' ? 'bg-blue-100 border-l-4 border-blue-500' : ($entry['type'] === 'income' ? 'bg-green-50' : ($entry['type'] === 'disbursement' ? 'bg-gray-50' : '')) }}">
                            <td class="px-3 py-2 text-sm text-gray-900">
                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                                    ...
                                    @elseif($entry['step'] === '6') bg-blue-100 text-blue-800
            ...
            <div class="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <div class="grid grid-cols-{{ isset($deductionEntries['top_up']) && $deductionEntries['top_up']['total'] > 0 ? '4' : '3' }} gap-4 text-sm">
                    ...
                    <div class="bg-blue-100 rounded px-2 py-1">
                        <p class="text-blue-800 font-semibold">Top-up Payment:</p>
                        <p class="font-bold text-blue-900">{{ number_format($deductionEntries['top_up']['total'], 2) }}</p>
                        <p class="text-xs text-blue-700">Paid to original loan</p>
                    </div>
                    @endif
                    <div>
                        <p class="text-blue-700">New Loan Balance:</p>
        ...
        <div class="flex justify-end">
            ...
            @else
                <button wire:click="editParameters" class="px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-700 transition flex items-center">
