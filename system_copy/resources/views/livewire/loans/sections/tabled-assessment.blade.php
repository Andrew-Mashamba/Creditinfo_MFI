<div class="w-full bg-white rounded-lg shadow-lg p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center mb-3">
            <div class="bg-blue-900 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold mr-3">1</div>
    ...
    <div class="mb-6">
        <div class="flex items-center mb-3">
            <div class="bg-blue-900 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold mr-3">2</div>
    ...
    <div class="mb-6">
        <div class="flex items-center mb-3">
            <div class="bg-blue-900 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold mr-3">4</div>
        ...
        <div class="flex items-center mb-3">
            <div class="bg-blue-900 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold mr-3">5</div>
    ...
    <div class="mb-6">
        ...
        <div class="flex items-center mt-4">
            <div class="bg-blue-900 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold mr-3">6</div>
