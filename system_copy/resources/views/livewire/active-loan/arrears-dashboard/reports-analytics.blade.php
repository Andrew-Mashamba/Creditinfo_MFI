            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg {{ $schedule['active'] ? '' : 'bg-gray-50 opacity-60' }}">
                    ...
                    <div class="flex items-center space-x-2">
                        <button wire:click="toggleSchedule({{ $schedule['id'] }})" class="relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 {{ $schedule['active'] ? 'bg-blue-900' : 'bg-gray-200' }}">
