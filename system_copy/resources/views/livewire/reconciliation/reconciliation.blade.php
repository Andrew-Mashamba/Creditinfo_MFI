                                    ...
                                    <nav class="-mb-px flex space-x-2 overflow-x-auto" aria-label="Tabs">
                                        ...
                                        <button
                                            ...
                                            class="whitespace-nowrap py-3 px-4 border-b-2 font-medium text-sm transition-colors duration-200
                                                {{ $activeTab === 'matched' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}"
                                        >
                                            <div class="flex items-center space-x-2">
                                        ...
                                        <button
                                            ...
                                            class="whitespace-nowrap py-3 px-4 border-b-2 font-medium text-sm transition-colors duration-200
                                                {{ $activeTab === 'cashbook' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}"
                                        >
                                            <div class="flex items-center space-x-2">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        @foreach($bankAccounts as $bankAccount)
                                            <button
                                                ...
                                                class="whitespace-nowrap py-3 px-4 border-b-2 font-medium text-sm transition-colors duration-200
                                                    {{ $activeTab === 'bank_account_' . $bankAccount->id ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}"
                                            >
                                                <div class="flex items-center space-x-2">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <div class="overflow-x-auto">
                                                    <table class="w-full text-sm">
                                                        <thead class="bg-gray-50">
                                                            <tr>
                                                                <!-- Cashbook Section -->
                                                                <th colspan="4" class="px-4 py-2 text-center text-xs font-bold text-blue-700 uppercase tracking-wider bg-blue-50 border-r-2 border-blue-200">
                                                                    Cashbook (System)
                                                                </th>
                                                                <!-- Match Info Section -->
                                                            ...
                                                            <tr class="bg-gray-100">
                                                                ...
                                                                <th class="px-3 py-2 text-right text-xs font-medium text-gray-600 uppercase border-r-2 border-blue-200">Amount</th>
                                                                <!-- Match Info Columns -->
                                                        ...
                                                        <tbody class="bg-white divide-y divide-gray-200">
                                                            @foreach($tabData as $match)
                                                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                                                    ...
                                                                    <td class="px-3 py-3 whitespace-nowrap text-xs text-right border-r-2 border-blue-200">
                                                                        <span class="font-semibold text-blue-700">{{ number_format($match->cashbook_amount, 2) }}</span>
                                                                    </td>
