                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <button wire:click="verifyMembership" 
                                    class="px-4 py-3 bg-blue-900 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                Verify
                            </button>
                        </div>
            ...
            <form wire:submit.prevent="submitTransfer">
                ...
                <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" wire:loading.attr="disabled"
                            class="px-6 py-3 bg-blue-900 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed">
