                        ...
                        <form class="space-y-6">
                            ...
                            <div class="flex flex-wrap gap-4 mt-4">
                                <button wire:click.prevent="downloadExcelFile" type="button" 
                                        class="inline-flex items-center px-5 py-3 text-sm font-medium text-white bg-blue-900 border border-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-700 transition-colors">
    ...
    <nav class="p-4 space-y-4 h-full overflow-y-auto">
         ...
         <button 
             ...
             class="w-full flex items-center p-3 rounded-2xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 
                    {{ $item === 'loan-application' ? 'bg-blue-900 text-white shadow-md' : 'bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900' }}"
         >         
