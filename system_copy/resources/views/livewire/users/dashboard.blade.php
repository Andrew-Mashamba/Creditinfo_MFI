                            ...
                            @foreach ($setupSteps as $section)
                                @php
                                    ...
                                    $colorClasses = [
                                        ...
                                        'blue' => $isActive ? 'bg-blue-900 text-white' : 'bg-blue-50 text-blue-700 hover:bg-blue-100',
                ...
                @elseif($this->section === 'audit-logs')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                            ...
                            <button wire:click="$set('section', 'departments')" class="w-full bg-blue-900 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors">
                                View Departments
                            </button>
                        </div>
                    </div>
