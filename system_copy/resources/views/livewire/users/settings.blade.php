            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6 flex justify-end">
                            <button wire:click="updateProfile" class="px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-700 transition-colors">
                                Update Profile
                            </button>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6 flex justify-end">
                            <button wire:click="updateDepartmentRole" class="px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-700 transition-colors">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6">
                            <button wire:click="updateNotificationPreferences" class="w-full px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-700 transition-colors">
                                Save Preferences
                            </button>
                        </div>
                    </div>
