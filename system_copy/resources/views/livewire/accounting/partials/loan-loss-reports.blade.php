        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="border rounded-lg p-4">
                ...
                <button wire:click="generateProvisionReport('pdf')" 
                        class="w-full px-4 py-2 bg-blue-900 text-white text-sm font-medium rounded-md hover:bg-blue-700">
                    Generate PDF Report
                </button>
            </div>
        ...
        <div class="bg-white rounded-lg max-w-2xl w-full p-6">
            ...
            <div class="mt-6 flex justify-end space-x-3">
                ...
                <button wire:click="generateCustomReport" 
                        class="px-4 py-2 bg-blue-900 text-white text-sm font-medium rounded-md hover:bg-blue-700">
                    Generate Report
                </button>
            </div>
        </div>
