                        ...
                        <form wire:submit.prevent="{{ $importMode ? 'processImport' : ($isEditMode ? 'update' : 'store') }}" class="space-y-6">
                            ...
                            <div class="flex justify-end space-x-3">
                                ...
                                <button type="submit" 
                                    wire:loading.attr="disabled"
                                    wire:loading.class="opacity-50 cursor-not-allowed"
                                    class="px-6 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                        ...
                        <div class="bg-white rounded-lg border border-gray-200 p-6">
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <button wire:click="selectMenu(2)" 
                                        class="px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-700 transition-colors">
                                        Add New PPE
                                    </button>
                                </div>
                            </div>
                ...
                @case(7)
                    ...
                    <div class="space-y-6">
                        <div class="flex justify-between items-center">
                            ...
                            <button wire:click="openMaintenanceForm" class="px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-700">
                ...
                @case(8)
                    ...
                    <div class="space-y-6">
                        <div class="flex justify-between items-center">
                            ...
                            <button wire:click="openTransferForm" class="px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-700">
                                Initiate Transfer
                            </button>
                        </div>
                ...
                @case(9)
                    ...
                    <div class="space-y-6">
                        <div class="flex justify-between items-center">
                            ...
                            <button wire:click="openInsuranceForm" class="px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-700">
                ...
                @case(10)
                    ...
                    <div class="space-y-6">
                        <div class="flex justify-between items-center">
                            ...
                            <button wire:click="openRevaluationForm" class="px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-700">
                                New Revaluation
                            </button>
                        </div>
                ...
                <form wire:submit.prevent="saveInsurance">
                    ...
                    <div class="mt-6 flex justify-end space-x-3">
                        ...
                        <button type="submit" 
                            ...
                            wire:loading.attr="disabled"
                            class="px-4 py-2 bg-blue-900 text-white rounded-md hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed">
