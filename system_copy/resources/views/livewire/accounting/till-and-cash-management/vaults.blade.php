    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center space-x-3">
                ...
                <button wire:click="refreshVaultData" class="inline-flex items-center px-4 py-2 bg-blue-900 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200 shadow-sm">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center space-x-2">
                            <button wire:click="viewVaultDetails({{ $vault->id }})" 
                                    class="flex-1 bg-blue-900 hover:bg-blue-700 text-white px-3 py-2 rounded-lg text-sm font-medium transition-colors">
                                View Details
                            </button>
