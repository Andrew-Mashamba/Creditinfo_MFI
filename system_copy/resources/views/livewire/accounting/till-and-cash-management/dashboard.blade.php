                        ...
                        <div class="bg-white rounded-lg p-4 border-2 border-dashed border-blue-300">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <button wire:click="openTill" 
                                        class="bg-blue-900 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition-all duration-200 flex items-center space-x-2">
            ...
            @else
                <div class="text-center py-8">
                    <div class="p-4 bg-white rounded-lg inline-block shadow-sm">
                        ...
                        @if($isSupervisor)
                            <button class="px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-700 transition-colors">
                                Assign Till
                            </button>
                        @endif
                    </div>
        ...
        <div class="space-y-3">
            ...
            @empty
                <div class="text-center py-8">
                    ...
                    @if($tillStatus === 'open')
                        <button wire:click="showTransactionModal" 
                                class="mt-4 px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-700 transition-colors">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        ...
                        <div class="mt-3 pt-3 border-t border-gray-200">
                            <div class="flex space-x-2">
                                <button class="flex-1 px-3 py-1 bg-blue-900 text-white rounded text-xs hover:bg-blue-700 transition-colors">
                                    View Details
                                </button>
                                @if($till->status === 'open')
