        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center space-x-3">
                @if($isAdmin || $isSupervisor)
                    <button wire:click="showCreateTillModal" class="inline-flex items-center px-4 py-2 bg-blue-900 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200 shadow-sm">
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    @if($isAdmin || $isSupervisor)
                                        <button wire:click="showCreateTillModal" class="inline-flex items-center px-4 py-2 bg-blue-900 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                            </svg>
                                            Create First Till
