    ...
    <div class="border-b border-gray-200 mb-6">
        <nav class="-mb-px flex space-x-8">
            ...
            <button wire:click="$set('activeTab', 'accruals')"
                    class="py-2 px-1 border-b-2 font-medium text-sm {{ $activeTab === 'accruals' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                Daily Accruals
            </button>
            <button wire:click="$set('activeTab', 'income-report')"
                    class="py-2 px-1 border-b-2 font-medium text-sm {{ $activeTab === 'income-report' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                Income Report
            </button>
            <button wire:click="$set('activeTab', 'audit-trail')"
                    class="py-2 px-1 border-b-2 font-medium text-sm {{ $activeTab === 'audit-trail' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                Income Audit Trail
            </button>
        </nav>
    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-blue-600">{{ number_format($collectionRate, 1) }}%</p>
                    </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($interestReceivables as $loan)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-blue-600 font-bold">{{ number_format($loan->total_interest_receivable, 2) }}</td>
    ...
    @if($activeTab === 'accruals')
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <p class="text-2xl font-bold text-blue-600">{{ number_format($totalAccruedInterest, 2) }}</p>
            </div>
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <input type="date" wire:model="accrualDate" class="border border-gray-300 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="flex items-center space-x-4">
                    <button wire:click="runDailyAccrual" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
                        <svg class="w-4 h-4 me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($dailyAccruals as $accrual)
                            <tr class="hover:bg-gray-50 {{ $accrual->is_suspended ? 'bg-red-50' : '' }}">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-blue-600">{{ number_format($accrual->cumulative_accrued, 2) }}</td>
                                <td class="px-4 py-3 whitespace-nowrap text-center">
    ...
    @if($activeTab === 'income-report')
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <p class="text-2xl font-bold text-blue-600">{{ number_format($interestIncome, 2) }}</p>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <select wire:model="incomeReportPeriod" class="border border-gray-300 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @forelse($incomeBreakdown as $item)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-blue-600">{{ number_format($item['ytd_balance'], 2) }}</td>
                    ...
                    <tfoot class="bg-gray-100">
                        <tr>
                            ...
                            <td class="px-4 py-3 text-sm text-right font-bold text-blue-700">{{ number_format(collect($incomeBreakdown)->sum('ytd_balance'), 2) }}</td>
            ...
            <div class="flex items-center space-x-8">
                ...
                <div class="flex-1">
                    <div class="h-8 bg-gray-200 rounded-full overflow-hidden flex">
                        @if($totalIncome > 0)
                            <div class="h-full bg-blue-500" style="width: {{ ($interestIncome / $totalIncome) * 100 }}%" title="Interest Income"></div>
    ...
    @if($activeTab === 'audit-trail')
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                ...
                <p class="text-2xl font-bold text-blue-600">{{ number_format($auditStats->updates ?? 0) }}</p>
            </div>
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
            <div class="flex flex-wrap items-center gap-4">
                <div class="flex items-center space-x-2">
                    ...
                    <input type="date" wire:model="auditTrailDateFrom" class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="flex items-center space-x-2">
                    <label class="text-sm font-medium text-gray-700">To:</label>
                    <input type="date" wire:model="auditTrailDateTo" class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="flex items-center space-x-2">
                    <label class="text-sm font-medium text-gray-700">Action:</label>
                    <select wire:model="auditTrailAction" class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-base font-bold text-blue-600">{{ number_format($selectedLoan['total_interest_receivable'], 2) }}</p>
                            </div>
                        </div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($selectedLoan['schedule_details'] as $schedule)
                                        <tr>
                                            ...
                                            <td class="px-3 py-2 text-sm text-right text-blue-600 font-medium">{{ number_format($schedule['interest_receivable'], 2) }}</td>
                        ...
                        <div class="mb-4">
                            <span class="px-3 py-1 text-sm font-semibold rounded-full
                                {{ $selectedAuditDetail->action === 'CREATE' ? 'bg-green-100 text-green-800' :
                                   ($selectedAuditDetail->action === 'UPDATE' ? 'bg-blue-100 text-blue-800' :
