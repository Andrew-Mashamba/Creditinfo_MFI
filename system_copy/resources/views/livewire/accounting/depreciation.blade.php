                ...
                @if(count($journalEntries) > 0)
                    <div class="flex justify-end mt-4">
                        <button wire:click="runDepreciation" 
                                ...
                                class="px-6 py-3 bg-blue-900 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors flex items-center disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            <div class="space-y-6">
                ...
                @else
                    <div class="text-center py-12 bg-gray-50 rounded-lg">
                        ...
                        <div class="mt-6">
                            <button wire:click="changeViewMode('journal')" 
                                    class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-900 hover:bg-blue-700">
