            ...
            <div class="relative top-10 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
                ...
                <form wire:submit.prevent="save">
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t">
                        ...
                        <button type="submit"
                            class="px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-900 transition">
            ...
            <div class="relative top-10 mx-auto p-5 border w-full max-w-3xl shadow-lg rounded-md bg-white">
                ...
                @if($verificationData)
                    ...
                    <div class="mb-4">
                        ...
                        <div class="grid grid-cols-3 gap-4 bg-blue-50 p-4 rounded-lg">
                            <div>
                                <p class="text-xs text-gray-600">Total Debits</p>
                                <p class="font-medium text-blue-800">{{ number_format($verificationData['total_debits'] ?? 0, 2) }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-600">Total Credits</p>
                                <p class="font-medium text-blue-800">{{ number_format($verificationData['total_credits'] ?? 0, 2) }}</p>
                            </div>
                            <div>
