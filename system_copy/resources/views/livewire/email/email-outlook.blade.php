    ...
    <div class="flex items-center justify-between px-4 py-2 border-b border-gray-200 bg-white">
        <div class="flex items-center space-x-4">
            ...
            <button 
                ...
                class="flex items-center px-4 py-2 bg-blue-900 text-white rounded-md hover:bg-blue-700 transition-colors"
                ...
                <nav class="space-y-1">
                    @foreach([
                        ...
                        >
                            ...
                            @if($folder['count'] > 0)
                                <span class="bg-blue-900 text-white text-xs px-2 py-0.5 rounded-full">{{ $folder['count'] }}</span>
                            @endif
                        </button>
                    @endforeach
                </nav>
